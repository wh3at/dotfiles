---
title: "Overview | Feature-Sliced Design"
...
## Concepts[​](https://feature-sliced.design/docs/get-started/overview.html#concepts "Direct link to heading")

Layers, slices, and segments form a hierarchy like this:

![Hierarchy of FSD concepts, described below](https://feature-sliced.design/assets/images/visual_schema-e826067f573946613dcdc76e3f585082.jpg)
...
### Layers[​](https://feature-sliced.design/docs/get-started/overview.html#layers "Direct link to heading")
...
### Slices[​](https://feature-sliced.design/docs/get-started/overview.html#slices "Direct link to heading")
...
### Segments[​](https://feature-sliced.design/docs/get-started/overview.html#segments "Direct link to heading")
...
## Advantages[​](https://feature-sliced.design/docs/get-started/overview.html#advantages "Direct link to heading")
...
## Incremental adoption[​](https://feature-sliced.design/docs/get-started/overview.html#incremental-adoption "Direct link to heading")
...
## Next steps[​](https://feature-sliced.design/docs/get-started/overview.html#next-steps "Direct link to heading")

* **Want to get a good grasp of how to think in FSD?** Check out the [Tutorial](https://feature-sliced.design/docs/get-started/tutorial.html).
* **Prefer to learn from examples?** We have a lot in the [Examples](https://feature-sliced.design/examples) section.
* **Have questions?** Drop by our [Telegram chat](https://t.me/feature_sliced) and get help from the community.

[Next

Tutorial](https://feature-sliced.design/docs/get-started/tutorial.html)

* [Is it right for me?](https://feature-sliced.design/docs/get-started/overview.html#is-it-right-for-me)* [Basic example](https://feature-sliced.design/docs/get-started/overview.html#basic-example)* [Concepts](https://feature-sliced.design/docs/get-started/overview.html#concepts)
      + [Layers](https://feature-sliced.design/docs/get-started/overview.html#layers)+ [Slices](https://feature-sliced.design/docs/get-started/overview.html#slices)+ [Segments](https://feature-sliced.design/docs/get-started/overview.html#segments)* [Advantages](https://feature-sliced.design/docs/get-started/overview.html#advantages)* [Incremental adoption](https://feature-sliced.design/docs/get-started/overview.html#incremental-adoption)* [Next steps](https://feature-sliced.design/docs/get-started/overview.html#next-steps)
