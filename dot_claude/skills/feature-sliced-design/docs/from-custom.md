---
title: "Migration from a custom architecture | Feature-Sliced Design"
source_url: "https://feature-sliced.design/docs/guides/migration/from-custom"
fetched_at: "2025-12-24T01:58:57.414309+00:00"
---



* * 🎯 Guides* Migration* From a custom architecture
...
* 📁 actions
  ...
  * 📁 api* 📁 components* 📁 containers* 📁 constants* 📁 i18n* 📁 modules* 📁 helpers* 📁 routes

                  + 📁 products.jsx+ 📄 products.[id].jsx

                  * 📁 utils* 📁 reducers* 📁 selectors* 📁 styles* 📄 App.jsx* 📄 index.js

## Before you start[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#before-you-start "Direct link to heading")
...
## Step 1. Divide the code by pages[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#divide-code-by-pages "Direct link to heading")
...
## Step 2. Separate everything else from the pages[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#separate-everything-else-from-pages "Direct link to heading")
...
* 📁 app
  ...
  * 📁 pages
    ...
    * 📁 shared
      ...
      + 📁 actions+ 📁 api+ 📁 components+ 📁 containers+ 📁 constants+ 📁 i18n+ 📁 modules+ 📁 helpers+ 📁 utils+ 📁 reducers+ 📁 selectors+ 📁 styles

## Step 3. Tackle cross-imports between pages[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#tackle-cross-imports-between-pages "Direct link to heading")
...
## Step 4. Unpack the Shared layer[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#unpack-shared-layer "Direct link to heading")
...
* 📁 app (unchanged)* 📁 pages
    ...
    + 📁 product
      ...
      - 📁 actions- 📁 reducers- 📁 selectors- 📁 ui

              * 📄 Component.jsx* 📄 Container.jsx* 📄 ProductPage.jsx
...
## Step 5. Organize code by technical purpose[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#organize-by-technical-purpose "Direct link to heading")
...
## Optional steps[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#optional-steps "Direct link to heading")

### Step 6. Form entities/features from Redux slices that are used on several pages[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#form-entities-features-from-redux "Direct link to heading")
...
Entities and features are meant to be independent from each other. If your business domain contains inherent connections between entities, refer to the [guide on business entities](https://feature-sliced.design/docs/guides/examples/types#business-entities-and-their-cross-references) for advice on how to organize these connections.

The API functions related to these slices can stay in `📁 shared/api`.

### Step 7. Refactor your modules[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#refactor-your-modules "Direct link to heading")
...
### Step 8. Form a clean UI foundation in `shared/ui`[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#form-clean-ui-foundation "Direct link to heading")
...
## See also[​](https://feature-sliced.design/docs/guides/migration/from-custom.html#see-also "Direct link to heading")
...
Handling API Requests](https://feature-sliced.design/docs/guides/examples/api-requests)[Next

Migration from v1 to v2](https://feature-sliced.design/docs/guides/migration/from-v1.html)

* [Before you start](https://feature-sliced.design/docs/guides/migration/from-custom.html#before-you-start)* [Step 1. Divide the code by pages](https://feature-sliced.design/docs/guides/migration/from-custom.html#divide-code-by-pages)* [Step 2. Separate everything else from the pages](https://feature-sliced.design/docs/guides/migration/from-custom.html#separate-everything-else-from-pages)* [Step 3. Tackle cross-imports between pages](https://feature-sliced.design/docs/guides/migration/from-custom.html#tackle-cross-imports-between-pages)* [Step 4. Unpack the Shared layer](https://feature-sliced.design/docs/guides/migration/from-custom.html#unpack-shared-layer)* [Step 5. Organize code by technical purpose](https://feature-sliced.design/docs/guides/migration/from-custom.html#organize-by-technical-purpose)* [Optional steps](https://feature-sliced.design/docs/guides/migration/from-custom.html#optional-steps)
              + [Step 6. Form entities/features from Redux slices that are used on several pages](https://feature-sliced.design/docs/guides/migration/from-custom.html#form-entities-features-from-redux)+ [Step 7. Refactor your modules](https://feature-sliced.design/docs/guides/migration/from-custom.html#refactor-your-modules)+ [Step 8. Form a clean UI foundation in `shared/ui`](https://feature-sliced.design/docs/guides/migration/from-custom.html#form-clean-ui-foundation)* [See also](https://feature-sliced.design/docs/guides/migration/from-custom.html#see-also)
