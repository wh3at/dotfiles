---
title: "Handling API Requests | Feature-Sliced Design"
source_url: "https://feature-sliced.design/docs/guides/examples/api-requests"
fetched_at: "2025-12-24T01:57:42.449458+00:00"
---



* * 🎯 Guides* Examples* Handling API Requests

On this page

## Shared API Requests[​](https://feature-sliced.design/docs/guides/examples/api-requests.html#shared-api-requests "Direct link to heading")
...
To keep examples focused, we omit form interaction and validation. For details on libraries like Zod or Valibot, refer to the [Type Validation and Schemas](https://feature-sliced.design/docs/guides/examples/types.html#type-validation-schemas-and-zod) article.
...
## Slice-Specific API Requests[​](https://feature-sliced.design/docs/guides/examples/api-requests.html#slice-specific-api-requests "Direct link to heading")
...
## Using Client Generators[​](https://feature-sliced.design/docs/guides/examples/api-requests.html#client-generators "Direct link to heading")
...
## Integrating with Server State Libraries[​](https://feature-sliced.design/docs/guides/examples/api-requests.html#server-state-libraries "Direct link to heading")
...
For more details on how to work with server state libraries, refer to [React Query article](https://feature-sliced.design/docs/guides/tech/with-react-query)

[Previous

Page layouts](https://feature-sliced.design/docs/guides/examples/page-layout.html)[Next

From a custom architecture](https://feature-sliced.design/docs/guides/migration/from-custom)

* [Shared API Requests](https://feature-sliced.design/docs/guides/examples/api-requests.html#shared-api-requests)* [Slice-Specific API Requests](https://feature-sliced.design/docs/guides/examples/api-requests.html#slice-specific-api-requests)* [Using Client Generators](https://feature-sliced.design/docs/guides/examples/api-requests.html#client-generators)* [Integrating with Server State Libraries](https://feature-sliced.design/docs/guides/examples/api-requests.html#server-state-libraries)
