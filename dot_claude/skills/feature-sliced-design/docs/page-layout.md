---
title: "Page layouts | Feature-Sliced Design"
source_url: "https://feature-sliced.design/docs/guides/examples/page-layout"
fetched_at: "2025-12-24T01:57:42.449458+00:00"
---



* * 🎯 Guides* Examples* Page layouts
...
## Simple layout[​](https://feature-sliced.design/docs/guides/examples/page-layout.html#simple-layout "Direct link to heading")
...
## Using widgets in the layout[​](https://feature-sliced.design/docs/guides/examples/page-layout.html#using-widgets-in-the-layout "Direct link to heading")

Sometimes you want to include certain business logic in the layout, especially if you're using deeply nested routes with a router like [React Router](https://reactrouter.com/). Then you can't store the layout in Shared or in Widgets due to [the import rule on layers](https://feature-sliced.design/docs/reference/layers#import-rule-on-layers):
...
## Further reading[​](https://feature-sliced.design/docs/guides/examples/page-layout.html#further-reading "Direct link to heading")

* There's an example of how to build a layout with authentication with React and Remix (equivalent to React Router) in the [tutorial](https://feature-sliced.design/docs/get-started/tutorial).

[Previous

Types](https://feature-sliced.design/docs/guides/examples/types.html)[Next

Handling API Requests](https://feature-sliced.design/docs/guides/examples/api-requests.html)

* [Simple layout](https://feature-sliced.design/docs/guides/examples/page-layout.html#simple-layout)* [Using widgets in the layout](https://feature-sliced.design/docs/guides/examples/page-layout.html#using-widgets-in-the-layout)* [Further reading](https://feature-sliced.design/docs/guides/examples/page-layout.html#further-reading)
