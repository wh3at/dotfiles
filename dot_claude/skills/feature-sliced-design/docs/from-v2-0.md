---
title: "Migration from v2.0 to v2.1 | Feature-Sliced Design"
source_url: "https://feature-sliced.design/docs/guides/migration/from-v2-0"
fetched_at: "2025-12-24T01:58:57.414309+00:00"
---



* * 🎯 Guides* Migration* Migration from v2.0 to v2.1
...
## How to migrate[​](https://feature-sliced.design/docs/guides/migration/from-v2-0.html#how-to-migrate "Direct link to heading")
...
### Merge slices[​](https://feature-sliced.design/docs/guides/migration/from-v2-0.html#merge-slices "Direct link to heading")
...
### Standardize cross-imports[​](https://feature-sliced.design/docs/guides/migration/from-v2-0.html#standardize-cross-imports "Direct link to heading")
...
For more details, check out the [Public API for cross-imports](https://feature-sliced.design/docs/reference/public-api#public-api-for-cross-imports) section in the reference.

[Previous

Migration from v1 to v2](https://feature-sliced.design/docs/guides/migration/from-v1.html)[Next

Usage with Next.js](https://feature-sliced.design/docs/guides/tech/with-nextjs)

* [How to migrate](https://feature-sliced.design/docs/guides/migration/from-v2-0.html#how-to-migrate)
  + [Merge slices](https://feature-sliced.design/docs/guides/migration/from-v2-0.html#merge-slices)+ [Standardize cross-imports](https://feature-sliced.design/docs/guides/migration/from-v2-0.html#standardize-cross-imports)
