---
title: "Authentication | Feature-Sliced Design"
source_url: "https://feature-sliced.design/docs/guides/examples/auth"
fetched_at: "2025-12-24T01:57:42.449458+00:00"
---



* * 🎯 Guides* Examples* Authentication
...
## How to get credentials from the user[​](https://feature-sliced.design/docs/guides/examples/auth.html#how-to-get-credentials-from-the-user "Direct link to heading")

We are assuming that your app is responsible for getting credentials. If you have authentication via OAuth, you can simply create a login page with a link to the OAuth provider's login page and skip to [step 3](https://feature-sliced.design/docs/guides/examples/auth.html#how-to-store-the-token-for-authenticated-requests).

### Dedicated page for login[​](https://feature-sliced.design/docs/guides/examples/auth.html#dedicated-page-for-login "Direct link to heading")
...
### Dialog for login[​](https://feature-sliced.design/docs/guides/examples/auth.html#dialog-for-login "Direct link to heading")
...
### Client-side validation[​](https://feature-sliced.design/docs/guides/examples/auth.html#client-side-validation "Direct link to heading")
...
## How to send credentials to the backend[​](https://feature-sliced.design/docs/guides/examples/auth.html#how-to-send-credentials-to-the-backend "Direct link to heading")

Create a function that makes a request to your backend's login endpoint. This function can either be called directly in the component code using a mutation library (e.g. TanStack Query), or it can be called as a side effect in a state manager. As explained in the [guide for API requests](https://feature-sliced.design/docs/guides/examples/api-requests.html), you can put your request either in `shared/api` or in the `api` segment of your login page.

### Two-factor authentication[​](https://feature-sliced.design/docs/guides/examples/auth.html#two-factor-authentication "Direct link to heading")
...
## How to store the token for authenticated requests[​](https://feature-sliced.design/docs/guides/examples/auth.html#how-to-store-the-token-for-authenticated-requests "Direct link to heading")
...
### In Shared[​](https://feature-sliced.design/docs/guides/examples/auth.html#in-shared "Direct link to heading")
...
### In Entities[​](https://feature-sliced.design/docs/guides/examples/auth.html#in-entities "Direct link to heading")
...
Since the API client is usually defined in `shared/api` or spreaded across the entities, the main challenge to this approach is making the token available to other requests that need it without breaking [the import rule on layers](https://feature-sliced.design/docs/reference/layers#import-rule-on-layers):
...
### In Pages/Widgets (not recommended)[​](https://feature-sliced.design/docs/guides/examples/auth.html#in-pageswidgets-not-recommended "Direct link to heading")
...
## Logout and token invalidation[​](https://feature-sliced.design/docs/guides/examples/auth.html#logout-and-token-invalidation "Direct link to heading")
...
### Automatic logout[​](https://feature-sliced.design/docs/guides/examples/auth.html#automatic-logout "Direct link to heading")
...
FAQ](https://feature-sliced.design/docs/get-started/faq)[Next

Types](https://feature-sliced.design/docs/guides/examples/types.html)

* [How to get credentials from the user](https://feature-sliced.design/docs/guides/examples/auth.html#how-to-get-credentials-from-the-user)
  + [Dedicated page for login](https://feature-sliced.design/docs/guides/examples/auth.html#dedicated-page-for-login)+ [Dialog for login](https://feature-sliced.design/docs/guides/examples/auth.html#dialog-for-login)+ [Client-side validation](https://feature-sliced.design/docs/guides/examples/auth.html#client-side-validation)* [How to send credentials to the backend](https://feature-sliced.design/docs/guides/examples/auth.html#how-to-send-credentials-to-the-backend)
    + [Two-factor authentication](https://feature-sliced.design/docs/guides/examples/auth.html#two-factor-authentication)* [How to store the token for authenticated requests](https://feature-sliced.design/docs/guides/examples/auth.html#how-to-store-the-token-for-authenticated-requests)
      + [In Shared](https://feature-sliced.design/docs/guides/examples/auth.html#in-shared)+ [In Entities](https://feature-sliced.design/docs/guides/examples/auth.html#in-entities)+ [In Pages/Widgets (not recommended)](https://feature-sliced.design/docs/guides/examples/auth.html#in-pageswidgets-not-recommended)* [Logout and token invalidation](https://feature-sliced.design/docs/guides/examples/auth.html#logout-and-token-invalidation)
        + [Automatic logout](https://feature-sliced.design/docs/guides/examples/auth.html#automatic-logout)
