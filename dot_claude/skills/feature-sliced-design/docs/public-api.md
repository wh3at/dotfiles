---
title: "Public API | Feature-Sliced Design"
source_url: "https://feature-sliced.design/docs/reference/public-api"
...
## What makes a good public API?[​](https://feature-sliced.design/docs/reference/public-api.html#what-makes-a-good-public-api "Direct link to heading")
...
## Public API for cross-imports[​](https://feature-sliced.design/docs/reference/public-api.html#public-api-for-cross-imports "Direct link to heading")

Cross-imports are a situation when one slice imports from another slice on the same layer. Usually that is prohibited by the [import rule on layers](https://feature-sliced.design/docs/reference/layers.html#import-rule-on-layers), but often there are legitimate reasons to cross-import. For example, business entities often reference each other in the real world, and it's best to reflect these relationships in the code instead of working around them.
...
## Issues with index files[​](https://feature-sliced.design/docs/reference/public-api.html#issues-with-index-files "Direct link to heading")
...
### Circular imports[​](https://feature-sliced.design/docs/reference/public-api.html#circular-imports "Direct link to heading")

Circular import is when two or more files import each other in a circle.

![Three files importing each other in a circle](https://feature-sliced.design/img/circular-import-light.svg#light-mode-only)![Three files importing each other in a circle](https://feature-sliced.design/img/circular-import-dark.svg#dark-mode-only)
...
### Large bundles and broken tree-shaking in Shared[​](https://feature-sliced.design/docs/reference/public-api.html#large-bundles "Direct link to heading")
...
### No real protection against side-stepping the public API[​](https://feature-sliced.design/docs/reference/public-api.html#no-real-protection-against-side-stepping-the-public-api "Direct link to heading")
...
### Worse performance of bundlers on large projects[​](https://feature-sliced.design/docs/reference/public-api.html#worse-performance-of-bundlers-on-large-projects "Direct link to heading")
...
1. The same advice as in ["Large bundles and broken tree-shaking in Shared" issue](https://feature-sliced.design/docs/reference/public-api.html#large-bundles) — have separate index files for each component/library in `shared/ui` and `shared/lib` instead of one big one
...
Slices and segments](https://feature-sliced.design/docs/reference/slices-segments.html)[Next

Mission](https://feature-sliced.design/docs/about/mission)

* [What makes a good public API?](https://feature-sliced.design/docs/reference/public-api.html#what-makes-a-good-public-api)* [Public API for cross-imports](https://feature-sliced.design/docs/reference/public-api.html#public-api-for-cross-imports)* [Issues with index files](https://feature-sliced.design/docs/reference/public-api.html#issues-with-index-files)
      + [Circular imports](https://feature-sliced.design/docs/reference/public-api.html#circular-imports)+ [Large bundles and broken tree-shaking in Shared](https://feature-sliced.design/docs/reference/public-api.html#large-bundles)+ [No real protection against side-stepping the public API](https://feature-sliced.design/docs/reference/public-api.html#no-real-protection-against-side-stepping-the-public-api)+ [Worse performance of bundlers on large projects](https://feature-sliced.design/docs/reference/public-api.html#worse-performance-of-bundlers-on-large-projects)
