---
title: "Layers | Feature-Sliced Design"
source_url: "https://feature-sliced.design/docs/reference/layers"
...
![A file system tree, with a single root folder called src and then seven subfolders: app, processes, pages, widgets, features, entities, shared. The processes folder is slightly faded out.](https://feature-sliced.design/img/layers/folders-graphic-dark.svg#dark-mode-only)
...
## Import rule on layers[​](https://feature-sliced.design/docs/reference/layers.html#import-rule-on-layers "Direct link to heading")
...
## Layer definitions[​](https://feature-sliced.design/docs/reference/layers.html#layer-definitions "Direct link to heading")

This section describes the semantic meaning of each layer to create an intuition for what kind of code belongs there.

### Shared[​](https://feature-sliced.design/docs/reference/layers.html#shared "Direct link to heading")
...
### Entities[​](https://feature-sliced.design/docs/reference/layers.html#entities "Direct link to heading")
...
#### Entity relationships[​](https://feature-sliced.design/docs/reference/layers.html#entity-relationships "Direct link to heading")
...
Learn more about the `@x` notation in the [Public API for cross-imports](https://feature-sliced.design/docs/reference/public-api.html#public-api-for-cross-imports) section.

### Features[​](https://feature-sliced.design/docs/reference/layers.html#features "Direct link to heading")
...
### Widgets[​](https://feature-sliced.design/docs/reference/layers.html#widgets "Direct link to heading")
...
### Pages[​](https://feature-sliced.design/docs/reference/layers.html#pages "Direct link to heading")
...
### Processes[​](https://feature-sliced.design/docs/reference/layers.html#processes "Direct link to heading")
...
### App[​](https://feature-sliced.design/docs/reference/layers.html#app "Direct link to heading")
...
Cross-imports](https://feature-sliced.design/docs/guides/issues/cross-imports)[Next

Slices and segments](https://feature-sliced.design/docs/reference/slices-segments.html)

* [Import rule on layers](https://feature-sliced.design/docs/reference/layers.html#import-rule-on-layers)* [Layer definitions](https://feature-sliced.design/docs/reference/layers.html#layer-definitions)
    + [Shared](https://feature-sliced.design/docs/reference/layers.html#shared)+ [Entities](https://feature-sliced.design/docs/reference/layers.html#entities)+ [Features](https://feature-sliced.design/docs/reference/layers.html#features)+ [Widgets](https://feature-sliced.design/docs/reference/layers.html#widgets)+ [Pages](https://feature-sliced.design/docs/reference/layers.html#pages)+ [Processes](https://feature-sliced.design/docs/reference/layers.html#processes)+ [App](https://feature-sliced.design/docs/reference/layers.html#app)
