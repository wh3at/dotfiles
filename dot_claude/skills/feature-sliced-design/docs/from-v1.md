---
title: "Migration from v1 to v2 | Feature-Sliced Design"
source_url: "https://feature-sliced.design/docs/guides/migration/from-v1"
fetched_at: "2025-12-24T01:58:57.414309+00:00"
---



* * 🎯 Guides* Migration* Migration from v1 to v2

On this page

## Why v2?[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#why-v2 "Direct link to heading")
...
## Why does it make sense to migrate the project to v2?[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#why-does-it-make-sense-to-migrate-the-project-to-v2 "Direct link to heading")

> `WIP:` The current version of the methodology is under development and some details *may change*

#### 🔍 More transparent and simple architecture[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#-more-transparent-and-simple-architecture "Direct link to heading")
...
#### 📦 More flexible and honest modularity[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#-more-flexible-and-honest-modularity "Direct link to heading")
...
#### 🚀 More specifications, plans, community[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#-more-specifications-plans-community "Direct link to heading")
...
## Changelog[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#changelog "Direct link to heading")

### `BREAKING` Layers[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#breaking-layers "Direct link to heading")
...
### `BREAKING` Shared[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#breaking-shared "Direct link to heading")
...
### `NEW` Entities, Processes[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#new-entities-processes "Direct link to heading")
...
### `BREAKING` Abstractions & Naming[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#breaking-abstractions--naming "Direct link to heading")

Now specific abstractions and [clear recommendations for naming them](https://feature-sliced.design/docs/about/understanding/naming)are defined

#### Layers[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#layers "Direct link to heading")
...
#### Segments[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#segments "Direct link to heading")
...
### `REFINED` Low coupling[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#refined-low-coupling "Direct link to heading")

Now it is much easier to [observe the principle of low coupling](https://feature-sliced.design/docs/reference/slices-segments#zero-coupling-high-cohesion) between modules, thanks to the new layers.
...
## See also[​](https://feature-sliced.design/docs/guides/migration/from-v1.html#see-also "Direct link to heading")
...
From a custom architecture](https://feature-sliced.design/docs/guides/migration/from-custom.html)[Next

Migration from v2.0 to v2.1](https://feature-sliced.design/docs/guides/migration/from-v2-0.html)

* [Why v2?](https://feature-sliced.design/docs/guides/migration/from-v1.html#why-v2)* [Why does it make sense to migrate the project to v2?](https://feature-sliced.design/docs/guides/migration/from-v1.html#why-does-it-make-sense-to-migrate-the-project-to-v2)* [Changelog](https://feature-sliced.design/docs/guides/migration/from-v1.html#changelog)
      + [`BREAKING` Layers](https://feature-sliced.design/docs/guides/migration/from-v1.html#breaking-layers)+ [`BREAKING` Shared](https://feature-sliced.design/docs/guides/migration/from-v1.html#breaking-shared)+ [`NEW` Entities, Processes](https://feature-sliced.design/docs/guides/migration/from-v1.html#new-entities-processes)+ [`BREAKING` Abstractions & Naming](https://feature-sliced.design/docs/guides/migration/from-v1.html#breaking-abstractions--naming)+ [`REFINED` Low coupling](https://feature-sliced.design/docs/guides/migration/from-v1.html#refined-low-coupling)* [See also](https://feature-sliced.design/docs/guides/migration/from-v1.html#see-also)
