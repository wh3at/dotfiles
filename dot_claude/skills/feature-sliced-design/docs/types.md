---
title: "Types | Feature-Sliced Design"
source_url: "https://feature-sliced.design/docs/guides/examples/types"
fetched_at: "2025-12-24T01:57:42.449458+00:00"
---



* * 🎯 Guides* Examples* Types
...
## Utility types[​](https://feature-sliced.design/docs/guides/examples/types.html#utility-types "Direct link to heading")
...
## Business entities and their cross-references[​](https://feature-sliced.design/docs/guides/examples/types.html#business-entities-and-their-cross-references "Direct link to heading")
...
You might notice that the `Song` type references a different entity, `Artist`. This is a benefit of storing your requests in Shared — real-world types are often intertwined. If we kept this function in `entities/song/api`, we wouldn't be able to simply import `Artist` from `entities/artist`, because FSD restricts cross-imports between slices with [the import rule on layers](https://feature-sliced.design/docs/reference/layers#import-rule-on-layers):
...
## Data transfer objects and mappers[​](https://feature-sliced.design/docs/guides/examples/types.html#data-transfer-objects-and-mappers "Direct link to heading")
...
### Where to put DTOs[​](https://feature-sliced.design/docs/guides/examples/types.html#where-to-put-dtos "Direct link to heading")
...
### Where to put mappers[​](https://feature-sliced.design/docs/guides/examples/types.html#where-to-put-mappers "Direct link to heading")
...
### How to deal with nested DTOs[​](https://feature-sliced.design/docs/guides/examples/types.html#how-to-deal-with-nested-dtos "Direct link to heading")
...
## Global types and Redux[​](https://feature-sliced.design/docs/guides/examples/types.html#global-types-and-redux "Direct link to heading")
...
It would be nice to have typed Redux hooks `useAppDispatch` and `useAppSelector` in `shared/store`, but they cannot import `RootState` and `AppDispatch` from the App layer due to the [import rule on layers](https://feature-sliced.design/docs/reference/layers#import-rule-on-layers):
...
## Enums[​](https://feature-sliced.design/docs/guides/examples/types.html#enums "Direct link to heading")
...
## Type validation schemas and Zod[​](https://feature-sliced.design/docs/guides/examples/types.html#type-validation-schemas-and-zod "Direct link to heading")
...
Validation schemas are similar to mappers (as discussed in the [Data transfer objects and mappers](https://feature-sliced.design/docs/guides/examples/types.html#data-transfer-objects-and-mappers) section) in the sense that they take a data transfer object and parse it, producing an error if the parsing fails.
...
## Typings of component props and context[​](https://feature-sliced.design/docs/guides/examples/types.html#typings-of-component-props-and-context "Direct link to heading")
...
## Ambient declaration files (`*.d.ts`)[​](https://feature-sliced.design/docs/guides/examples/types.html#ambient-declaration-files-dts "Direct link to heading")
...
## Auto-generation of types[​](https://feature-sliced.design/docs/guides/examples/types.html#auto-generation-of-types "Direct link to heading")
...
Authentication](https://feature-sliced.design/docs/guides/examples/auth.html)[Next

Page layouts](https://feature-sliced.design/docs/guides/examples/page-layout.html)

* [Utility types](https://feature-sliced.design/docs/guides/examples/types.html#utility-types)* [Business entities and their cross-references](https://feature-sliced.design/docs/guides/examples/types.html#business-entities-and-their-cross-references)* [Data transfer objects and mappers](https://feature-sliced.design/docs/guides/examples/types.html#data-transfer-objects-and-mappers)
      + [Where to put DTOs](https://feature-sliced.design/docs/guides/examples/types.html#where-to-put-dtos)+ [Where to put mappers](https://feature-sliced.design/docs/guides/examples/types.html#where-to-put-mappers)+ [How to deal with nested DTOs](https://feature-sliced.design/docs/guides/examples/types.html#how-to-deal-with-nested-dtos)* [Global types and Redux](https://feature-sliced.design/docs/guides/examples/types.html#global-types-and-redux)* [Enums](https://feature-sliced.design/docs/guides/examples/types.html#enums)* [Type validation schemas and Zod](https://feature-sliced.design/docs/guides/examples/types.html#type-validation-schemas-and-zod)* [Typings of component props and context](https://feature-sliced.design/docs/guides/examples/types.html#typings-of-component-props-and-context)* [Ambient declaration files (`*.d.ts`)](https://feature-sliced.design/docs/guides/examples/types.html#ambient-declaration-files-dts)* [Auto-generation of types](https://feature-sliced.design/docs/guides/examples/types.html#auto-generation-of-types)
