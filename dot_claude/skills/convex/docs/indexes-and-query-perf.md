...
source_url: "https://docs.convex.dev/database/reading-data/indexes/indexes-and-query-perf"
...
[database queries](https://docs.convex.dev/database/reading-data/index.html) are fast and
efficient? When should I define an
[index](https://docs.convex.dev/database/reading-data/indexes/index.html)? What is an index?
...
## A Library of Documents[​](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#a-library-of-documents "Direct link to A Library of Documents")
...
[`db.insert("books", {...})`](https://docs.convex.dev/api/interfaces/server.GenericDatabaseWriter.html#insert)
...
## Full Table Scans[​](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#full-table-scans "Direct link to Full Table Scans")
...
## Card Catalogs[​](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#card-catalogs "Direct link to Card Catalogs")
...
![Card Catalog](https://docs.convex.dev/assets/images/card-catalog-7ca883b19c630085876ee5d2f59b672a.jpg)
...
## Indexes[​](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#indexes "Direct link to Indexes")
...
## Backfilling and Maintaining Indexes[​](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#backfilling-and-maintaining-indexes "Direct link to Backfilling and Maintaining Indexes")
...
using a [staged index](https://docs.convex.dev/using/indexes.html#staged-indexes) to
...
## Indexing Multiple Fields[​](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#indexing-multiple-fields "Direct link to Indexing Multiple Fields")
...
[`.unique`](https://docs.convex.dev/api/interfaces/server.Query.html#unique) because we expect there to be
at most one result.

This query demonstrates the difference between filtering using
[`withIndex`](https://docs.convex.dev/api/interfaces/server.QueryInitializer.html#withindex) and
[`filter`](https://docs.convex.dev/api/interfaces/server.Query.html#filter). `withIndex` only allows you to
...
## Conclusions[​](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#conclusions "Direct link to Conclusions")

Congrats! You now understand how queries and indexes work within Convex!

Here are the main points we've covered:

1. By default Convex queries are *full table scans*. This is appropriate for
   prototyping and querying small tables.
2. As your tables grow larger, you can improve your query performance by adding
   *indexes*. Indexes are separate data structures that order your documents for
   fast querying.
3. In Convex, queries use the *`withIndex`* method to express the portion of the
...
Indexes](https://docs.convex.dev/database/reading-data/indexes/index.html)[Next

Filters](https://docs.convex.dev/database/reading-data/filters.html)

* [A Library of Documents](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#a-library-of-documents)
* [Full Table Scans](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#full-table-scans)
* [Card Catalogs](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#card-catalogs)
* [Indexes](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#indexes)
* [Backfilling and Maintaining Indexes](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#backfilling-and-maintaining-indexes)
* [Indexing Multiple Fields](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#indexing-multiple-fields)
* [Conclusions](https://docs.convex.dev/database/indexes/indexes-and-query-perf.html#conclusions)
