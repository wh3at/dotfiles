---
title: "Files and Images in Agent messages | Convex Developer Hub"
source_url: "https://docs.convex.dev/agents/files"
...
## Running the example[​](https://docs.convex.dev/agents/files.html#running-the-example "Direct link to Running the example")
...
## Sending an image by uploading first and generating asynchronously[​](https://docs.convex.dev/agents/files.html#sending-an-image-by-uploading-first-and-generating-asynchronously "Direct link to Sending an image by uploading first and generating asynchronously")
...
### 1: Saving the file[​](https://docs.convex.dev/agents/files.html#1-saving-the-file "Direct link to 1: Saving the file")
...
### 2: Sending the message[​](https://docs.convex.dev/agents/files.html#2-sending-the-message "Direct link to 2: Sending the message")
...
### 3: Generating the response & querying the responses[​](https://docs.convex.dev/agents/files.html#3-generating-the-response--querying-the-responses "Direct link to 3: Generating the response & querying the responses")
...
## Inline saving approach[​](https://docs.convex.dev/agents/files.html#inline-saving-approach "Direct link to Inline saving approach")
...
## Under the hood[​](https://docs.convex.dev/agents/files.html#under-the-hood "Direct link to Under the hood")
...
### Can I just store the file myself and pass in a URL?[​](https://docs.convex.dev/agents/files.html#can-i-just-store-the-file-myself-and-pass-in-a-url "Direct link to Can I just store the file myself and pass in a URL?")
...
## Generating images[​](https://docs.convex.dev/agents/files.html#generating-images "Direct link to Generating images")
...
Human Agents](https://docs.convex.dev/agents/human-agents.html)[Next

Debugging](https://docs.convex.dev/agents/debugging.html)

* [Running the example](https://docs.convex.dev/agents/files.html#running-the-example)
* [Sending an image by uploading first and generating asynchronously](https://docs.convex.dev/agents/files.html#sending-an-image-by-uploading-first-and-generating-asynchronously)
  + [1: Saving the file](https://docs.convex.dev/agents/files.html#1-saving-the-file)
  + [2: Sending the message](https://docs.convex.dev/agents/files.html#2-sending-the-message)
  + [3: Generating the response & querying the responses](https://docs.convex.dev/agents/files.html#3-generating-the-response--querying-the-responses)
* [Inline saving approach](https://docs.convex.dev/agents/files.html#inline-saving-approach)
* [Under the hood](https://docs.convex.dev/agents/files.html#under-the-hood)
  + [Can I just store the file myself and pass in a URL?](https://docs.convex.dev/agents/files.html#can-i-just-store-the-file-myself-and-pass-in-a-url)
* [Generating images](https://docs.convex.dev/agents/files.html#generating-images)
