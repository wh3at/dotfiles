---
title: "Authoring Components | Convex Developer Hub"
source_url: "https://docs.convex.dev/components/authoring"
...
## Anatomy of a component[​](https://docs.convex.dev/components/authoring.html#anatomy-of-a-component "Direct link to Anatomy of a component")
...
## Getting started[​](https://docs.convex.dev/components/authoring.html#getting-started "Direct link to Getting started")

The source code for components can be a local folder or bundled into an NPM
package.

### Local components[​](https://docs.convex.dev/components/authoring.html#local-components "Direct link to Local components")
...
### Packaged components[​](https://docs.convex.dev/components/authoring.html#packaged-components "Direct link to Packaged components")
...
code up-to-date.
[See below for more information on building and publishing NPM package components.](https://docs.convex.dev/components/authoring.html#building-and-publishing-npm-package-components)

### Hybrid components[​](https://docs.convex.dev/components/authoring.html#hybrid-components "Direct link to Hybrid components")
...
## Hello world[​](https://docs.convex.dev/components/authoring.html#hello-world "Direct link to Hello world")
...
## Key differences from regular Convex development[​](https://docs.convex.dev/components/authoring.html#key-differences-from-regular-convex-development "Direct link to Key differences from regular Convex development")
...
### The Component API[​](https://docs.convex.dev/components/authoring.html#the-component-api "Direct link to The Component API")
...
### `Id` types and validation[​](https://docs.convex.dev/components/authoring.html#id-types-and-validation "Direct link to id-types-and-validation")
...
### Generated code[​](https://docs.convex.dev/components/authoring.html#generated-code "Direct link to Generated code")
...
### Environment variables[​](https://docs.convex.dev/components/authoring.html#environment-variables "Direct link to Environment variables")
...
### HTTP Actions[​](https://docs.convex.dev/components/authoring.html#http-actions "Direct link to HTTP Actions")
...
### Authentication via ctx.auth[​](https://docs.convex.dev/components/authoring.html#authentication-via-ctxauth "Direct link to Authentication via ctx.auth")
...
### Function Handles[​](https://docs.convex.dev/components/authoring.html#function-handles "Direct link to Function Handles")
...
### Pagination[​](https://docs.convex.dev/components/authoring.html#pagination "Direct link to Pagination")
...
## Tips and best practices[​](https://docs.convex.dev/components/authoring.html#tips-and-best-practices "Direct link to Tips and best practices")

### Validation[​](https://docs.convex.dev/components/authoring.html#validation "Direct link to Validation")
...
[here](https://docs.convex.dev/functions/validation.html).

### Static configuration[​](https://docs.convex.dev/components/authoring.html#static-configuration "Direct link to Static configuration")
...
## Wrapping the component with client code[​](https://docs.convex.dev/components/authoring.html#wrapping-the-component-with-client-code "Direct link to Wrapping the component with client code")
...
### Simple Function Wrappers[​](https://docs.convex.dev/components/authoring.html#simple-function-wrappers "Direct link to Simple Function Wrappers")
...
### Re-exporting component functions[​](https://docs.convex.dev/components/authoring.html#re-exporting-component-functions "Direct link to Re-exporting component functions")
...
#### Re-mounting an API[​](https://docs.convex.dev/components/authoring.html#re-mounting-an-api "Direct link to Re-mounting an API")
...
### Class-Based Clients[​](https://docs.convex.dev/components/authoring.html#class-based-clients "Direct link to Class-Based Clients")
...
## Building and publishing NPM package components[​](https://docs.convex.dev/components/authoring.html#building-and-publishing-npm-package-components "Direct link to Building and publishing NPM package components")

### Build process[​](https://docs.convex.dev/components/authoring.html#build-process "Direct link to Build process")
...
### Entry points[​](https://docs.convex.dev/components/authoring.html#entry-points "Direct link to Entry points")
...
### Local package resolution for development[​](https://docs.convex.dev/components/authoring.html#local-package-resolution-for-development "Direct link to Local package resolution for development")
...
3. Have a single package.json file and node\_modules directory in the root of the
...
### Publishing to NPM[​](https://docs.convex.dev/components/authoring.html#publishing-to-npm "Direct link to Publishing to NPM")
...
## Testing[​](https://docs.convex.dev/components/authoring.html#testing "Direct link to Testing")

### Testing implementations[​](https://docs.convex.dev/components/authoring.html#testing-implementations "Direct link to Testing implementations")

To test components, you can use the
[`convex-test` library](https://docs.convex.dev/testing/convex-test.html). The main difference is that
...
[Testing components](https://docs.convex.dev/components/using.html#testing-components) section in the
Using Components documentation.

### Testing the API and client code[​](https://docs.convex.dev/components/authoring.html#testing-the-api-and-client-code "Direct link to Testing the API and client code")
...
[Using Components](https://docs.convex.dev/components/using.html#testing-components) and test it from an
...
### Exporting test helpers[​](https://docs.convex.dev/components/authoring.html#exporting-test-helpers "Direct link to Exporting test helpers")
...
Using Components](https://docs.convex.dev/components/using.html)[Next

AI Code Generation](https://docs.convex.dev/ai.html)

* [Anatomy of a component](https://docs.convex.dev/components/authoring.html#anatomy-of-a-component)
* [Getting started](https://docs.convex.dev/components/authoring.html#getting-started)
  + [Local components](https://docs.convex.dev/components/authoring.html#local-components)
  + [Packaged components](https://docs.convex.dev/components/authoring.html#packaged-components)
  + [Hybrid components](https://docs.convex.dev/components/authoring.html#hybrid-components)
* [Hello world](https://docs.convex.dev/components/authoring.html#hello-world)
* [Key differences from regular Convex development](https://docs.convex.dev/components/authoring.html#key-differences-from-regular-convex-development)
  + [The Component API](https://docs.convex.dev/components/authoring.html#the-component-api)
  + [`Id` types and validation](https://docs.convex.dev/components/authoring.html#id-types-and-validation)
  + [Generated code](https://docs.convex.dev/components/authoring.html#generated-code)
  + [Environment variables](https://docs.convex.dev/components/authoring.html#environment-variables)
  + [HTTP Actions](https://docs.convex.dev/components/authoring.html#http-actions)
  + [Authentication via ctx.auth](https://docs.convex.dev/components/authoring.html#authentication-via-ctxauth)
  + [Function Handles](https://docs.convex.dev/components/authoring.html#function-handles)
  + [Pagination](https://docs.convex.dev/components/authoring.html#pagination)
* [Tips and best practices](https://docs.convex.dev/components/authoring.html#tips-and-best-practices)
  + [Validation](https://docs.convex.dev/components/authoring.html#validation)
  + [Static configuration](https://docs.convex.dev/components/authoring.html#static-configuration)
* [Wrapping the component with client code](https://docs.convex.dev/components/authoring.html#wrapping-the-component-with-client-code)
  + [Simple Function Wrappers](https://docs.convex.dev/components/authoring.html#simple-function-wrappers)
  + [Re-exporting component functions](https://docs.convex.dev/components/authoring.html#re-exporting-component-functions)
  + [Class-Based Clients](https://docs.convex.dev/components/authoring.html#class-based-clients)
* [Building and publishing NPM package components](https://docs.convex.dev/components/authoring.html#building-and-publishing-npm-package-components)
  + [Build process](https://docs.convex.dev/components/authoring.html#build-process)
  + [Entry points](https://docs.convex.dev/components/authoring.html#entry-points)
  + [Local package resolution for development](https://docs.convex.dev/components/authoring.html#local-package-resolution-for-development)
  + [Publishing to NPM](https://docs.convex.dev/components/authoring.html#publishing-to-npm)
* [Testing](https://docs.convex.dev/components/authoring.html#testing)
  + [Testing implementations](https://docs.convex.dev/components/authoring.html#testing-implementations)
  + [Testing the API and client code](https://docs.convex.dev/components/authoring.html#testing-the-api-and-client-code)
  + [Exporting test helpers](https://docs.convex.dev/components/authoring.html#exporting-test-helpers)
