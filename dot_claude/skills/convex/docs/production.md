...
source_url: "https://docs.convex.dev/production"
...
## Project management[​](https://docs.convex.dev/production.html#project-management "Direct link to Project management")

When you sign up for Convex, a Convex team is created for you. You can
[create more teams from the dashboard](https://docs.convex.dev/dashboard/teams.html) and add other people
...
projects, see [staging](https://docs.convex.dev/production.html#staging-environment) below.

## Deploying to production[​](https://docs.convex.dev/production.html#deploying-to-production "Direct link to Deploying to production")
...
[Hosting and Deployment](https://docs.convex.dev/production/hosting/index.html) guide, to learn how to
deploy your client and your Convex backend together.

You can also deploy your backend on its own. Check out the
[Project Configuration](https://docs.convex.dev/production/project-configuration.html) page to learn
more.

## Staging environment[​](https://docs.convex.dev/production.html#staging-environment "Direct link to Staging environment")

With Convex [preview deployments](https://docs.convex.dev/production/hosting/preview-deployments.html)
...
running [`npx convex deploy`](https://docs.convex.dev/using/cli.html#deploy-convex-functions-to-production).

## Typical team development workflow[​](https://docs.convex.dev/production.html#typical-team-development-workflow "Direct link to Typical team development workflow")
...
2. One team member creates a project by running `npx convex dev`, perhaps
   starting with a [quickstart](https://docs.convex.dev/quickstarts.html) or a
...
5. All team members can make backend changes and test them out with their
   ...
   * [Backup / Restore](https://docs.convex.dev/database/backup-restore.html) can be used to populate a dev
     deployment with data from a prod deployment.
   * [Data import](https://docs.convex.dev/database/import-export/import.html) can be used to populate a
     dev deployment with synthetic seed data.
   * Members of a team with the [Pro plan](https://www.convex.dev/pricing) can
     get separate
     [preview deployments](https://docs.convex.dev/production/hosting/preview-deployments.html) to test
     each other's pull-requests.
6. Deployment to production can happen
   [automatically](https://docs.convex.dev/production/hosting/index.html) when changes get merged to
...
### Making safe changes[​](https://docs.convex.dev/production.html#making-safe-changes "Direct link to Making safe changes")
