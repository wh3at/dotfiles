---
title: "Convex & Auth0 | Convex Developer Hub"
source_url: "https://docs.convex.dev/auth/auth0"
...
## Get started[​](https://docs.convex.dev/auth/auth0.html#get-started "Direct link to Get started")
...
## Login and logout flows[​](https://docs.convex.dev/auth/auth0.html#login-and-logout-flows "Direct link to Login and logout flows")
...
## Logged-in and logged-out views[​](https://docs.convex.dev/auth/auth0.html#logged-in-and-logged-out-views "Direct link to Logged-in and logged-out views")

Use the [`useConvexAuth()`](https://docs.convex.dev/api/modules/react.html#useconvexauth) hook instead of
...
## User information in React[​](https://docs.convex.dev/auth/auth0.html#user-information-in-react "Direct link to User information in React")
...
## User information in functions[​](https://docs.convex.dev/auth/auth0.html#user-information-in-functions "Direct link to User information in functions")

See [Auth in Functions](https://docs.convex.dev/auth/functions-auth.html) to learn about how to access
information about the authenticated user in your queries, mutations and actions.

See [Storing Users in the Convex Database](https://docs.convex.dev/auth/database-auth.html) to learn
about how to store user information in the Convex database.

## Configuring dev and prod tenants[​](https://docs.convex.dev/auth/auth0.html#configuring-dev-and-prod-tenants "Direct link to Configuring dev and prod tenants")
...
### Configuring the backend[​](https://docs.convex.dev/auth/auth0.html#configuring-the-backend "Direct link to Configuring the backend")
...
### Configuring a React client[​](https://docs.convex.dev/auth/auth0.html#configuring-a-react-client "Direct link to Configuring a React client")
...
[Quickstart](https://docs.convex.dev/quickstarts.html) or the relevant documentation for the platform
you're using.
...
hosting platform. See [Hosting](https://docs.convex.dev/production/hosting/index.html).

## Debugging authentication[​](https://docs.convex.dev/auth/auth0.html#debugging-authentication "Direct link to Debugging authentication")
...
[Debugging Authentication](https://docs.convex.dev/auth/debug.html).

## Under the hood[​](https://docs.convex.dev/auth/auth0.html#under-the-hood "Direct link to Under the hood")
...
Automatic Config](https://docs.convex.dev/auth/authkit/auto-provision.html)[Next

Functions](https://docs.convex.dev/auth/functions-auth.html)

* [Get started](https://docs.convex.dev/auth/auth0.html#get-started)
* [Login and logout flows](https://docs.convex.dev/auth/auth0.html#login-and-logout-flows)
* [Logged-in and logged-out views](https://docs.convex.dev/auth/auth0.html#logged-in-and-logged-out-views)
* [User information in React](https://docs.convex.dev/auth/auth0.html#user-information-in-react)
* [User information in functions](https://docs.convex.dev/auth/auth0.html#user-information-in-functions)
* [Configuring dev and prod tenants](https://docs.convex.dev/auth/auth0.html#configuring-dev-and-prod-tenants)
  + [Configuring the backend](https://docs.convex.dev/auth/auth0.html#configuring-the-backend)
  + [Configuring a React client](https://docs.convex.dev/auth/auth0.html#configuring-a-react-client)
* [Debugging authentication](https://docs.convex.dev/auth/auth0.html#debugging-authentication)
* [Under the hood](https://docs.convex.dev/auth/auth0.html#under-the-hood)
