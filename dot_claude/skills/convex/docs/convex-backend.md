---
title: "Testing Local Backend | Convex Developer Hub"
source_url: "https://docs.convex.dev/testing/convex-backend"
...
Alternatively to [`convex-test`](https://docs.convex.dev/testing/convex-test.html) you can test your
functions using the
[open-source version of the Convex backend](https://github.com/get-convex/convex-backend).

## Getting Started[​](https://docs.convex.dev/testing/convex-backend.html#getting-started "Direct link to Getting Started")
...
## Limitations[​](https://docs.convex.dev/testing/convex-backend.html#limitations "Direct link to Limitations")
...
[convex-test](https://docs.convex.dev/testing/convex-test.html).

## CI[​](https://docs.convex.dev/testing/convex-backend.html#ci "Direct link to CI")
...
convex-test](https://docs.convex.dev/testing/convex-test.html)[Next

CI](https://docs.convex.dev/testing/ci.html)

* [Getting Started](https://docs.convex.dev/testing/convex-backend.html#getting-started)
* [Limitations](https://docs.convex.dev/testing/convex-backend.html#limitations)
* [CI](https://docs.convex.dev/testing/convex-backend.html#ci)
