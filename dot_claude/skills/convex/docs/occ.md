---
title: "OCC and Atomicity | Convex Developer Hub"
source_url: "https://docs.convex.dev/database/advanced/occ"
...
In [Queries](https://docs.convex.dev/understanding/convex-fundamentals/functions.html), we mentioned that determinism was
...
## Convex Financial, Inc.[​](https://docs.convex.dev/database/advanced/occ.html#convex-financial-inc "Direct link to Convex Financial, Inc.")
...
## When OCC loses, determinism wins[​](https://docs.convex.dev/database/advanced/occ.html#when-occ-loses-determinism-wins "Direct link to When OCC loses, determinism wins")
...
## Snapshot Isolation vs Serializability[​](https://docs.convex.dev/database/advanced/occ.html#snapshot-isolation-vs-serializability "Direct link to Snapshot Isolation vs Serializability")
...
## No need to think about this[​](https://docs.convex.dev/database/advanced/occ.html#no-need-to-think-about-this "Direct link to No need to think about this")
...
Schema Philosophy](https://docs.convex.dev/database/advanced/schema-philosophy.html)[Next

Realtime](https://docs.convex.dev/realtime.html)

* [Convex Financial, Inc.](https://docs.convex.dev/database/advanced/occ.html#convex-financial-inc)
* [When OCC loses, determinism wins](https://docs.convex.dev/database/advanced/occ.html#when-occ-loses-determinism-wins)
* [Snapshot Isolation vs Serializability](https://docs.convex.dev/database/advanced/occ.html#snapshot-isolation-vs-serializability)
* [No need to think about this](https://docs.convex.dev/database/advanced/occ.html#no-need-to-think-about-this)
