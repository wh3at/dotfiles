---
title: "Streaming | Convex Developer Hub"
source_url: "https://docs.convex.dev/agents/streaming"
...
[below](https://docs.convex.dev/agents/streaming.html#consuming-the-stream-yourself-with-the-agent) if that is all you're
looking for.
...
[below](https://docs.convex.dev/agents/streaming.html#advanced-streaming-deltas-asynchronously-without-using-an-agent)).
...
## Streaming message deltas[​](https://docs.convex.dev/agents/streaming.html#streaming-message-deltas "Direct link to Streaming message deltas")
...
## Retrieving streamed deltas[​](https://docs.convex.dev/agents/streaming.html#retrieving-streamed-deltas "Direct link to Retrieving streamed deltas")

For clients to stream messages, you need to expose a query that returns the
stream deltas. This is very similar to
[retrieving messages](https://docs.convex.dev/agents/messages.html#retrieving-messages), with a few changes:
...
Similar to with [non-streaming messages](https://docs.convex.dev/agents/messages.html#useuimessages-hook), you
...
### Text smoothing with `SmoothText` and `useSmoothText`[​](https://docs.convex.dev/agents/streaming.html#text-smoothing-with-smoothtext-and-usesmoothtext "Direct link to text-smoothing-with-smoothtext-and-usesmoothtext")
...
## Consuming the stream yourself with the Agent[​](https://docs.convex.dev/agents/streaming.html#consuming-the-stream-yourself-with-the-agent "Direct link to Consuming the stream yourself with the Agent")
...
## Advanced: Streaming deltas asynchronously without using an Agent[​](https://docs.convex.dev/agents/streaming.html#advanced-streaming-deltas-asynchronously-without-using-an-agent "Direct link to Advanced: Streaming deltas asynchronously without using an Agent")
...
Messages](https://docs.convex.dev/agents/messages.html)[Next

Playground](https://docs.convex.dev/agents/playground.html)

* [Streaming message deltas](https://docs.convex.dev/agents/streaming.html#streaming-message-deltas)
* [Retrieving streamed deltas](https://docs.convex.dev/agents/streaming.html#retrieving-streamed-deltas)
  + [Text smoothing with `SmoothText` and `useSmoothText`](https://docs.convex.dev/agents/streaming.html#text-smoothing-with-smoothtext-and-usesmoothtext)
* [Consuming the stream yourself with the Agent](https://docs.convex.dev/agents/streaming.html#consuming-the-stream-yourself-with-the-agent)
* [Advanced: Streaming deltas asynchronously without using an Agent](https://docs.convex.dev/agents/streaming.html#advanced-streaming-deltas-asynchronously-without-using-an-agent)
