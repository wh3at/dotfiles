---
title: "Runtimes | Convex Developer Hub"
source_url: "https://docs.convex.dev/functions/runtimes"
...
* Default [Convex runtime](https://docs.convex.dev/functions/runtimes.html#default-convex-runtime)
* Opt-in [Node.js runtime](https://docs.convex.dev/functions/runtimes.html#nodejs-runtime)

## Default Convex runtime[​](https://docs.convex.dev/functions/runtimes.html#default-convex-runtime "Direct link to Default Convex runtime")
...
* **Low overhead access to your data**. The runtime is designed to have low
  ...
  [JavaScript interface](https://docs.convex.dev/database/reading-data/index.html).

### Supported APIs[​](https://docs.convex.dev/functions/runtimes.html#supported-apis "Direct link to Supported APIs")
...
[Node.js runtime](https://docs.convex.dev/functions/runtimes.html#nodejs-runtime), or reach out in
[Discord](https://convex.dev/community). We are improving support all the time.

#### Network APIs[​](https://docs.convex.dev/functions/runtimes.html#network-apis "Direct link to Network APIs")

* [Blob](https://developer.mozilla.org/en-US/docs/Web/API/Blob)
* [Event](https://developer.mozilla.org/en-US/docs/Web/API/Event)
* [EventTarget](https://developer.mozilla.org/en-US/docs/Web/API/EventTarget)
* [fetch](https://developer.mozilla.org/en-US/docs/Web/API/fetch) — in
  [Actions](https://docs.convex.dev/functions/runtimes.html#actions) only
...
#### Encoding APIs[​](https://docs.convex.dev/functions/runtimes.html#encoding-apis "Direct link to Encoding APIs")
...
#### Web Stream APIs[​](https://docs.convex.dev/functions/runtimes.html#web-stream-apis "Direct link to Web Stream APIs")
...
#### Web Crypto APIs[​](https://docs.convex.dev/functions/runtimes.html#web-crypto-apis "Direct link to Web Crypto APIs")

* [crypto](https://developer.mozilla.org/en-US/docs/Web/API/Web_Crypto_API)
* [CryptoKey](https://developer.mozilla.org/en-US/docs/Web/API/CryptoKey)
* [SubtleCrypto](https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto)

### Restrictions on queries and mutations[​](https://docs.convex.dev/functions/runtimes.html#restrictions-on-queries-and-mutations "Direct link to Restrictions on queries and mutations")
...
#### Using randomness and time in queries and mutations[​](https://docs.convex.dev/functions/runtimes.html#using-randomness-and-time-in-queries-and-mutations "Direct link to Using randomness and time in queries and mutations")
...
### Actions[​](https://docs.convex.dev/functions/runtimes.html#actions "Direct link to Actions")
...
## Node.js runtime[​](https://docs.convex.dev/functions/runtimes.html#nodejs-runtime "Direct link to Node.js runtime")
...
[Learn more](https://docs.convex.dev/functions/actions.html#choosing-the-runtime-use-node).
...
[`runQuery`](https://docs.convex.dev/functions/actions.html#action-context) or
[`runMutation`](https://docs.convex.dev/functions/actions.html#action-context) helper to call a query or
mutation.

Every `.ts` and `.js` file in the convex directory
[is bundled](https://docs.convex.dev/functions/bundling.html) either for the default Convex JavaScript
...
### Node.js version configuration[​](https://docs.convex.dev/functions/runtimes.html#nodejs-version-configuration "Direct link to Node.js version configuration")

By default, all actions ran in the Node.js environment are executed in
Node.js 20. This version is configurable in the
[convex.json](https://docs.convex.dev/production/project-configuration.html#configuring-the-nodejs-version)
...
Application Errors](https://docs.convex.dev/functions/error-handling/application-errors.html)[Next

Bundling](https://docs.convex.dev/functions/bundling.html)

* [Default Convex runtime](https://docs.convex.dev/functions/runtimes.html#default-convex-runtime)
  + [Supported APIs](https://docs.convex.dev/functions/runtimes.html#supported-apis)
  + [Restrictions on queries and mutations](https://docs.convex.dev/functions/runtimes.html#restrictions-on-queries-and-mutations)
  + [Actions](https://docs.convex.dev/functions/runtimes.html#actions)
* [Node.js runtime](https://docs.convex.dev/functions/runtimes.html#nodejs-runtime)
  + [Node.js version configuration](https://docs.convex.dev/functions/runtimes.html#nodejs-version-configuration)
