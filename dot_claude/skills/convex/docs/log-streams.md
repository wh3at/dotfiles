---
title: "Log Streams | Convex Developer Hub"
source_url: "https://docs.convex.dev/production/integrations/log-streams"
...
Dashboard [Logs page](https://docs.convex.dev/dashboard/deployments/logs.html), the
[Convex CLI](https://docs.convex.dev/using/cli.html), or in the browser console, providing a quick and easy way
to view recent logs.
...
Log streams require a Convex Pro plan. [Learn
more](https://convex.dev/pricing) about our plans or
[upgrade](https://dashboard.convex.dev/team/settings/billing).

## Configuring log streams[​](https://docs.convex.dev/production/integrations/log-streams.html#configuring-log-streams "Direct link to Configuring log streams")
...
[configuring an integration](https://docs.convex.dev/production/integrations/index.html#configuring-an-integration).
The specific information needed for each log stream is covered below.

### Axiom[​](https://docs.convex.dev/production/integrations/log-streams.html#axiom "Direct link to Axiom")
...
created in Axiom. You can find it in the *Integrations* section of the
*Dashboards* tab. To customize the layout of the dashboard, you can
[fork it](https://axiom.co/docs/dashboards/create#fork-dashboards).

![A dashboard in Axiom](https://docs.convex.dev/assets/images/axiom_dashboard-a989f50d9d1fe5d65e33ecafb7facea1.png)

### Datadog[​](https://docs.convex.dev/production/integrations/log-streams.html#datadog "Direct link to Datadog")
...
### Webhook[​](https://docs.convex.dev/production/integrations/log-streams.html#webhook "Direct link to Webhook")
...
## Securing webhook log streams[​](https://docs.convex.dev/production/integrations/log-streams.html#securing-webhook-log-streams "Direct link to Securing webhook log streams")
...
## Log event schema[​](https://docs.convex.dev/production/integrations/log-streams.html#log-event-schema "Direct link to Log event schema")

info

Log streams configured before May 23, 2024 will use the legacy format
documented on [this
page](https://docs.convex.dev/production/integrations/log-streams/legacy-event-schema.html). We
...
### `verification` events[​](https://docs.convex.dev/production/integrations/log-streams.html#verification-events "Direct link to verification-events")
...
### `console` events[​](https://docs.convex.dev/production/integrations/log-streams.html#console-events "Direct link to console-events")

Convex function logs via the [`console` API](https://docs.convex.dev/functions/debugging.html).
...
* `timestamp`: Unix epoch timestamp in milliseconds
* `function`: object, see
  [function fields](https://docs.convex.dev/production/integrations/log-streams/index.html#function-fields)
...
* `system_code`: optional string, present for automatically added warnings when
  functions are approaching [limits](https://docs.convex.dev/production/state/limits.html#functions)
...
### `function_execution` events[​](https://docs.convex.dev/production/integrations/log-streams.html#function_execution-events "Direct link to function_execution-events")
...
* `occ_info`: object, if the function call resulted in an OCC (write conflict
  ...
  relating to the OCC.
  [Learn more about write conflicts](https://docs.convex.dev/error/index.html#1).
...
* `scheduler_info`: object, if set, indicates that the function was originally
  invoked by the [scheduler](https://docs.convex.dev/scheduling/scheduled-functions.html).
  + `job_id`: the job within the
    [`_scheduled_functions`](https://docs.convex.dev/scheduling/scheduled-functions.html#retrieving-scheduled-function-status)
    table
* `usage`:
...
### Function fields[​](https://docs.convex.dev/production/integrations/log-streams.html#function-fields "Direct link to Function fields")
...
### `scheduler_stats` events[​](https://docs.convex.dev/production/integrations/log-streams.html#scheduler_stats-events "Direct link to scheduler_stats-events")
...
### `current_storage_usage` events[​](https://docs.convex.dev/production/integrations/log-streams.html#current_storage_usage-events "Direct link to current_storage_usage-events")
...
### `audit_log` events[​](https://docs.convex.dev/production/integrations/log-streams.html#audit_log-events "Direct link to audit_log-events")
...
## Guarantees[​](https://docs.convex.dev/production/integrations/log-streams.html#guarantees "Direct link to Guarantees")
...
[please let us know](https://docs.convex.dev/production/contact.html)!
...
Integrations](https://docs.convex.dev/production/integrations/index.html)[Next

(Legacy) Event schema](https://docs.convex.dev/production/integrations/log-streams/legacy-event-schema.html)

* [Configuring log streams](https://docs.convex.dev/production/integrations/log-streams.html#configuring-log-streams)
  + [Axiom](https://docs.convex.dev/production/integrations/log-streams.html#axiom)
  + [Datadog](https://docs.convex.dev/production/integrations/log-streams.html#datadog)
  + [Webhook](https://docs.convex.dev/production/integrations/log-streams.html#webhook)
* [Securing webhook log streams](https://docs.convex.dev/production/integrations/log-streams.html#securing-webhook-log-streams)
* [Log event schema](https://docs.convex.dev/production/integrations/log-streams.html#log-event-schema)
  + [`verification` events](https://docs.convex.dev/production/integrations/log-streams.html#verification-events)
  + [`console` events](https://docs.convex.dev/production/integrations/log-streams.html#console-events)
  + [`function_execution` events](https://docs.convex.dev/production/integrations/log-streams.html#function_execution-events)
  + [Function fields](https://docs.convex.dev/production/integrations/log-streams.html#function-fields)
  + [`scheduler_stats` events](https://docs.convex.dev/production/integrations/log-streams.html#scheduler_stats-events)
  + [`current_storage_usage` events](https://docs.convex.dev/production/integrations/log-streams.html#current_storage_usage-events)
  + [`audit_log` events](https://docs.convex.dev/production/integrations/log-streams.html#audit_log-events)
* [Guarantees](https://docs.convex.dev/production/integrations/log-streams.html#guarantees)
