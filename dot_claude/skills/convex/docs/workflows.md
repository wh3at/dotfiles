---
title: "Workflows | Convex Developer Hub"
source_url: "https://docs.convex.dev/agents/workflows"
...
## Building reliable workflows[​](https://docs.convex.dev/agents/workflows.html#building-reliable-workflows "Direct link to Building reliable workflows")
...
### Retries[​](https://docs.convex.dev/agents/workflows.html#retries "Direct link to Retries")
...
### Load balancing[​](https://docs.convex.dev/agents/workflows.html#load-balancing "Direct link to Load balancing")
...
### Durability and idempotency for multi-step workflows[​](https://docs.convex.dev/agents/workflows.html#durability-and-idempotency-for-multi-step-workflows "Direct link to Durability and idempotency for multi-step workflows")
...
## Using the Workflow component for long-lived durable workflows[​](https://docs.convex.dev/agents/workflows.html#using-the-workflow-component-for-long-lived-durable-workflows "Direct link to Using the Workflow component for long-lived durable workflows")
...
### Exposing the agent as Convex actions[​](https://docs.convex.dev/agents/workflows.html#exposing-the-agent-as-convex-actions "Direct link to Exposing the agent as Convex actions")
...
### Using the agent actions within a workflow[​](https://docs.convex.dev/agents/workflows.html#using-the-agent-actions-within-a-workflow "Direct link to Using the agent actions within a workflow")
...
## Complex workflow patterns[​](https://docs.convex.dev/agents/workflows.html#complex-workflow-patterns "Direct link to Complex workflow patterns")
...
Add reliability to unreliable external service calls. Retry idempotent calls with exponential backoff until success.](https://www.convex.dev/components/retrier)[Convex Component

### Workpool

Builds on the Action Retrier to provide parallelism limits and retries to manage large numbers of external requests efficiently.](https://www.convex.dev/components/workpool)[Convex Component
...
RAG](https://docs.convex.dev/agents/rag.html)[Next

Human Agents](https://docs.convex.dev/agents/human-agents.html)

* [Building reliable workflows](https://docs.convex.dev/agents/workflows.html#building-reliable-workflows)
  + [Retries](https://docs.convex.dev/agents/workflows.html#retries)
  + [Load balancing](https://docs.convex.dev/agents/workflows.html#load-balancing)
  + [Durability and idempotency for multi-step workflows](https://docs.convex.dev/agents/workflows.html#durability-and-idempotency-for-multi-step-workflows)
* [Using the Workflow component for long-lived durable workflows](https://docs.convex.dev/agents/workflows.html#using-the-workflow-component-for-long-lived-durable-workflows)
  + [Exposing the agent as Convex actions](https://docs.convex.dev/agents/workflows.html#exposing-the-agent-as-convex-actions)
  + [Using the agent actions within a workflow](https://docs.convex.dev/agents/workflows.html#using-the-agent-actions-within-a-workflow)
* [Complex workflow patterns](https://docs.convex.dev/agents/workflows.html#complex-workflow-patterns)
