...
source_url: "https://docs.convex.dev/agents/threads"
...
## Creating a thread[​](https://docs.convex.dev/agents/threads.html#creating-a-thread "Direct link to Creating a thread")
...
[Playground](https://docs.convex.dev/agents/playground.html).

## Generating a message in a thread[​](https://docs.convex.dev/agents/threads.html#generating-a-message-in-a-thread "Direct link to Generating a message in a thread")
...
See [Messages](https://docs.convex.dev/agents/messages.html) for more details on creating and saving messages.

## Continuing a thread using the `thread` object from `agent.continueThread`[​](https://docs.convex.dev/agents/threads.html#continuing-a-thread-using-the-thread-object-from-agentcontinuethread "Direct link to continuing-a-thread-using-the-thread-object-from-agentcontinuethread")
...
See [Messages docs](https://docs.convex.dev/agents/messages.html) for more details on generating messages.

## Deleting threads[​](https://docs.convex.dev/agents/threads.html#deleting-threads "Direct link to Deleting threads")
...
## Getting all threads owned by a user[​](https://docs.convex.dev/agents/threads.html#getting-all-threads-owned-by-a-user "Direct link to Getting all threads owned by a user")
...
## Deleting all threads and messages associated with a user[​](https://docs.convex.dev/agents/threads.html#deleting-all-threads-and-messages-associated-with-a-user "Direct link to Deleting all threads and messages associated with a user")
...
## Getting messages in a thread[​](https://docs.convex.dev/agents/threads.html#getting-messages-in-a-thread "Direct link to Getting messages in a thread")

See [messages.mdx](https://docs.convex.dev/agents/messages.html) for more details.
...
Agent Usage](https://docs.convex.dev/agents/agent-usage.html)[Next

Messages](https://docs.convex.dev/agents/messages.html)

* [Creating a thread](https://docs.convex.dev/agents/threads.html#creating-a-thread)
* [Generating a message in a thread](https://docs.convex.dev/agents/threads.html#generating-a-message-in-a-thread)
* [Continuing a thread using the `thread` object from `agent.continueThread`](https://docs.convex.dev/agents/threads.html#continuing-a-thread-using-the-thread-object-from-agentcontinuethread)
* [Deleting threads](https://docs.convex.dev/agents/threads.html#deleting-threads)
* [Getting all threads owned by a user](https://docs.convex.dev/agents/threads.html#getting-all-threads-owned-by-a-user)
* [Deleting all threads and messages associated with a user](https://docs.convex.dev/agents/threads.html#deleting-all-threads-and-messages-associated-with-a-user)
* [Getting messages in a thread](https://docs.convex.dev/agents/threads.html#getting-messages-in-a-thread)
