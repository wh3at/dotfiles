---
title: "Configuring Deployment URL | Convex Developer Hub"
source_url: "https://docs.convex.dev/client/react/deployment-urls"
...
When [connecting to your backend](https://docs.convex.dev/client/react.html#connecting-to-a-backend)
it's important to correctly configure the deployment URL.

### Create a Convex project[​](https://docs.convex.dev/client/react/deployment-urls.html#create-a-convex-project "Direct link to Create a Convex project")
...
[deployment settings](https://docs.convex.dev/dashboard/deployments/deployment-settings.html) on your Convex
[dashboard](https://dashboard.convex.dev).

### Configure the client[​](https://docs.convex.dev/client/react/deployment-urls.html#configure-the-client "Direct link to Configure the client")
...
### Choosing environment variable names[​](https://docs.convex.dev/client/react/deployment-urls.html#choosing-environment-variable-names "Direct link to Choosing environment variable names")
...
[environment variables](https://docs.convex.dev/production/environment-variables.html) configured on
your dashboard. They do not source values from `.env` files.

[Previous

React](https://docs.convex.dev/client/react.html)[Next

Optimistic Updates](https://docs.convex.dev/using/optimistic-updates.html)

* [Create a Convex project](https://docs.convex.dev/client/react/deployment-urls.html#create-a-convex-project)
* [Configure the client](https://docs.convex.dev/client/react/deployment-urls.html#configure-the-client)
* [Choosing environment variable names](https://docs.convex.dev/client/react/deployment-urls.html#choosing-environment-variable-names)
