...
source_url: "https://docs.convex.dev/agents/rag"
...
## What is RAG?[​](https://docs.convex.dev/agents/rag.html#what-is-rag "Direct link to What is RAG?")
...
## RAG Component[​](https://docs.convex.dev/agents/rag.html#rag-component "Direct link to RAG Component")
...
## RAG Approaches[​](https://docs.convex.dev/agents/rag.html#rag-approaches "Direct link to RAG Approaches")

This directory contains two different approaches to implementing RAG:

### 1. Prompt-based RAG[​](https://docs.convex.dev/agents/rag.html#1-prompt-based-rag "Direct link to 1. Prompt-based RAG")
...
* Works well if you know the user's question will *always* benefit from extra
  context.
...
### 2. Tool-based RAG[​](https://docs.convex.dev/agents/rag.html#2-tool-based-rag "Direct link to 2. Tool-based RAG")
...
## Key Differences[​](https://docs.convex.dev/agents/rag.html#key-differences "Direct link to Key Differences")
...
## Ingesting content[​](https://docs.convex.dev/agents/rag.html#ingesting-content "Direct link to Ingesting content")
...
### Parsing images[​](https://docs.convex.dev/agents/rag.html#parsing-images "Direct link to Parsing images")
...
### Parsing PDFs[​](https://docs.convex.dev/agents/rag.html#parsing-pdfs "Direct link to Parsing PDFs")
...
### Parsing text files[​](https://docs.convex.dev/agents/rag.html#parsing-text-files "Direct link to Parsing text files")
...
## Examples in Action[​](https://docs.convex.dev/agents/rag.html#examples-in-action "Direct link to Examples in Action")
...
LLM Context](https://docs.convex.dev/agents/context.html)[Next

Workflows](https://docs.convex.dev/agents/workflows.html)

* [What is RAG?](https://docs.convex.dev/agents/rag.html#what-is-rag)
* [RAG Component](https://docs.convex.dev/agents/rag.html#rag-component)
* [RAG Approaches](https://docs.convex.dev/agents/rag.html#rag-approaches)
  + [1. Prompt-based RAG](https://docs.convex.dev/agents/rag.html#1-prompt-based-rag)
  + [2. Tool-based RAG](https://docs.convex.dev/agents/rag.html#2-tool-based-rag)
* [Key Differences](https://docs.convex.dev/agents/rag.html#key-differences)
* [Ingesting content](https://docs.convex.dev/agents/rag.html#ingesting-content)
  + [Parsing images](https://docs.convex.dev/agents/rag.html#parsing-images)
  + [Parsing PDFs](https://docs.convex.dev/agents/rag.html#parsing-pdfs)
  + [Parsing text files](https://docs.convex.dev/agents/rag.html#parsing-text-files)
* [Examples in Action](https://docs.convex.dev/agents/rag.html#examples-in-action)
