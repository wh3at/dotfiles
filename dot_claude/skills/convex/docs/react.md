...
source_url: "https://docs.convex.dev/client/react"
...
## Installation[​](https://docs.convex.dev/client/react.html#installation "Direct link to Installation")
...
## Connecting to a backend[​](https://docs.convex.dev/client/react.html#connecting-to-a-backend "Direct link to Connecting to a backend")
...
## Fetching data[​](https://docs.convex.dev/client/react.html#fetching-data "Direct link to Fetching data")
...
### Query arguments[​](https://docs.convex.dev/client/react.html#query-arguments "Direct link to Query arguments")
...
### Reactivity[​](https://docs.convex.dev/client/react.html#reactivity "Direct link to Reactivity")
...
### Consistency[​](https://docs.convex.dev/client/react.html#consistency "Direct link to Consistency")
...
### Paginating queries[​](https://docs.convex.dev/client/react.html#paginating-queries "Direct link to Paginating queries")

See
[Paginating within React Components](https://docs.convex.dev/database/pagination.html#paginating-within-react-components).

### Skipping queries[​](https://docs.convex.dev/client/react.html#skipping-queries "Direct link to Skipping queries")
...
### One-off queries[​](https://docs.convex.dev/client/react.html#one-off-queries "Direct link to One-off queries")
...
## Editing data[​](https://docs.convex.dev/client/react.html#editing-data "Direct link to Editing data")
...
### Mutation arguments[​](https://docs.convex.dev/client/react.html#mutation-arguments "Direct link to Mutation arguments")
...
### Mutation response and error handling[​](https://docs.convex.dev/client/react.html#mutation-response-and-error-handling "Direct link to Mutation response and error handling")
...
### Retries[​](https://docs.convex.dev/client/react.html#retries "Direct link to Retries")
...
### Optimistic updates[​](https://docs.convex.dev/client/react.html#optimistic-updates "Direct link to Optimistic updates")
...
## Calling third-party APIs[​](https://docs.convex.dev/client/react.html#calling-third-party-apis "Direct link to Calling third-party APIs")
...
### Action arguments[​](https://docs.convex.dev/client/react.html#action-arguments "Direct link to Action arguments")

Action arguments work exactly the same as
[mutation arguments](https://docs.convex.dev/client/react.html#mutation-arguments).

### Action response and error handling[​](https://docs.convex.dev/client/react.html#action-response-and-error-handling "Direct link to Action response and error handling")

Action response and error handling work exactly the same as
[mutation response and error handling](https://docs.convex.dev/client/react.html#mutation-response-and-error-handling).

Actions do not support automatic retries or optimistic updates.

## Under the hood[​](https://docs.convex.dev/client/react.html#under-the-hood "Direct link to Under the hood")
...
* [Installation](https://docs.convex.dev/client/react.html#installation)
* [Connecting to a backend](https://docs.convex.dev/client/react.html#connecting-to-a-backend)
* [Fetching data](https://docs.convex.dev/client/react.html#fetching-data)
  + [Query arguments](https://docs.convex.dev/client/react.html#query-arguments)
  + [Reactivity](https://docs.convex.dev/client/react.html#reactivity)
  + [Consistency](https://docs.convex.dev/client/react.html#consistency)
  + [Paginating queries](https://docs.convex.dev/client/react.html#paginating-queries)
  + [Skipping queries](https://docs.convex.dev/client/react.html#skipping-queries)
  + [One-off queries](https://docs.convex.dev/client/react.html#one-off-queries)
* [Editing data](https://docs.convex.dev/client/react.html#editing-data)
  + [Mutation arguments](https://docs.convex.dev/client/react.html#mutation-arguments)
  + [Mutation response and error handling](https://docs.convex.dev/client/react.html#mutation-response-and-error-handling)
  + [Retries](https://docs.convex.dev/client/react.html#retries)
  + [Optimistic updates](https://docs.convex.dev/client/react.html#optimistic-updates)
* [Calling third-party APIs](https://docs.convex.dev/client/react.html#calling-third-party-apis)
  + [Action arguments](https://docs.convex.dev/client/react.html#action-arguments)
  + [Action response and error handling](https://docs.convex.dev/client/react.html#action-response-and-error-handling)
* [Under the hood](https://docs.convex.dev/client/react.html#under-the-hood)
