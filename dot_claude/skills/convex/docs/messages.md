---
title: "Messages | Convex Developer Hub"
source_url: "https://docs.convex.dev/agents/messages"
...
The Agent component stores message and [thread](https://docs.convex.dev/agents/threads.html) history to enable
conversations between humans and agents.

To see how humans can act as agents, see [Human Agents](https://docs.convex.dev/agents/human-agents.html).

## Retrieving messages[​](https://docs.convex.dev/agents/messages.html#retrieving-messages "Direct link to Retrieving messages")

For clients to show messages, you need to expose a query that returns the
messages. For streaming, see
[retrieving streamed deltas](https://docs.convex.dev/agents/streaming.html#retrieving-streamed-deltas) for a
...
## Showing messages in React[​](https://docs.convex.dev/agents/messages.html#showing-messages-in-react "Direct link to Showing messages in React")
...
### `useUIMessages` hook[​](https://docs.convex.dev/agents/messages.html#useuimessages-hook "Direct link to useuimessages-hook")
...
### UIMessage type[​](https://docs.convex.dev/agents/messages.html#uimessage-type "Direct link to UIMessage type")
...
#### `toUIMessages` helper[​](https://docs.convex.dev/agents/messages.html#touimessages-helper "Direct link to touimessages-helper")
...
### Optimistic updates for sending messages[​](https://docs.convex.dev/agents/messages.html#optimistic-updates-for-sending-messages "Direct link to Optimistic updates for sending messages")
...
## Saving messages[​](https://docs.convex.dev/agents/messages.html#saving-messages "Direct link to Saving messages")
...
[Agent Usage](https://docs.convex.dev/agents/agent-usage.html) for more details.
...
### Without the Agent class:[​](https://docs.convex.dev/agents/messages.html#without-the-agent-class "Direct link to Without the Agent class:")
...
### Using the Agent class:[​](https://docs.convex.dev/agents/messages.html#using-the-agent-class "Direct link to Using the Agent class:")
...
## Configuring the storage of messages[​](https://docs.convex.dev/agents/messages.html#configuring-the-storage-of-messages "Direct link to Configuring the storage of messages")
...
## Message ordering[​](https://docs.convex.dev/agents/messages.html#message-ordering "Direct link to Message ordering")
...
## Deleting messages[​](https://docs.convex.dev/agents/messages.html#deleting-messages "Direct link to Deleting messages")
...
## Other utilities:[​](https://docs.convex.dev/agents/messages.html#other-utilities "Direct link to Other utilities:")
...
### Validators and types[​](https://docs.convex.dev/agents/messages.html#validators-and-types "Direct link to Validators and types")
...
Threads](https://docs.convex.dev/agents/threads.html)[Next

Streaming](https://docs.convex.dev/agents/streaming.html)

* [Retrieving messages](https://docs.convex.dev/agents/messages.html#retrieving-messages)
* [Showing messages in React](https://docs.convex.dev/agents/messages.html#showing-messages-in-react)
  + [`useUIMessages` hook](https://docs.convex.dev/agents/messages.html#useuimessages-hook)
  + [UIMessage type](https://docs.convex.dev/agents/messages.html#uimessage-type)
  + [Optimistic updates for sending messages](https://docs.convex.dev/agents/messages.html#optimistic-updates-for-sending-messages)
* [Saving messages](https://docs.convex.dev/agents/messages.html#saving-messages)
  + [Without the Agent class:](https://docs.convex.dev/agents/messages.html#without-the-agent-class)
  + [Using the Agent class:](https://docs.convex.dev/agents/messages.html#using-the-agent-class)
* [Configuring the storage of messages](https://docs.convex.dev/agents/messages.html#configuring-the-storage-of-messages)
* [Message ordering](https://docs.convex.dev/agents/messages.html#message-ordering)
* [Deleting messages](https://docs.convex.dev/agents/messages.html#deleting-messages)
* [Other utilities:](https://docs.convex.dev/agents/messages.html#other-utilities)
  + [Validators and types](https://docs.convex.dev/agents/messages.html#validators-and-types)
