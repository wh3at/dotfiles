---
title: "OAuth Applications | Convex Developer Hub"
source_url: "https://docs.convex.dev/platform-apis/oauth-applications"
...
* [Platform APIs](https://docs.convex.dev/platform-apis.html)
* OAuth Applications
...
## Creating an application[​](https://docs.convex.dev/platform-apis/oauth-applications.html#creating-an-application "Direct link to Creating an application")
...
### Verification requirements[​](https://docs.convex.dev/platform-apis/oauth-applications.html#verification-requirements "Direct link to Verification requirements")
...
## Implementing OAuth[​](https://docs.convex.dev/platform-apis/oauth-applications.html#implementing-oauth "Direct link to Implementing OAuth")
...
* Convex provides two *authorization endpoint* URLs, depending on whether you
...
## Step 1: Redirect the user to Convex's authorization endpoint[​](https://docs.convex.dev/platform-apis/oauth-applications.html#step-1-redirect-the-user-to-convexs-authorization-endpoint "Direct link to Step 1: Redirect the user to Convex's authorization endpoint")
...
![OAuth authorization page](https://docs.convex.dev/assets/images/oauth-page-a895fb5b2d41e9fd16dcc4003f1ca6a1.png)
...
## Step 2: Receive the callback[​](https://docs.convex.dev/platform-apis/oauth-applications.html#step-2-receive-the-callback "Direct link to Step 2: Receive the callback")
...
## Step 3: Exchange the authorization code for a project token[​](https://docs.convex.dev/platform-apis/oauth-applications.html#step-3-exchange-the-authorization-code-for-a-project-token "Direct link to Step 3: Exchange the authorization code for a project token")
...
Platform APIs](https://docs.convex.dev/platform-apis.html)[Next

Embedding the dashboard](https://docs.convex.dev/platform-apis/embedded-dashboard.html)

* [Creating an application](https://docs.convex.dev/platform-apis/oauth-applications.html#creating-an-application)
  + [Verification requirements](https://docs.convex.dev/platform-apis/oauth-applications.html#verification-requirements)
* [Implementing OAuth](https://docs.convex.dev/platform-apis/oauth-applications.html#implementing-oauth)
* [Step 1: Redirect the user to Convex's authorization endpoint](https://docs.convex.dev/platform-apis/oauth-applications.html#step-1-redirect-the-user-to-convexs-authorization-endpoint)
* [Step 2: Receive the callback](https://docs.convex.dev/platform-apis/oauth-applications.html#step-2-receive-the-callback)
* [Step 3: Exchange the authorization code for a project token](https://docs.convex.dev/platform-apis/oauth-applications.html#step-3-exchange-the-authorization-code-for-a-project-token)
