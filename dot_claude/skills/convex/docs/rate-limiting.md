---
title: "Rate Limiting | Convex Developer Hub"
source_url: "https://docs.convex.dev/agents/rate-limiting"
...
For general usage tracking, see [Usage Tracking](https://docs.convex.dev/agents/usage-tracking.html).

## Overview[​](https://docs.convex.dev/agents/rate-limiting.html#overview "Direct link to Overview")
...
## Running the Example[​](https://docs.convex.dev/agents/rate-limiting.html#running-the-example "Direct link to Running the Example")
...
## Rate Limiting Strategy[​](https://docs.convex.dev/agents/rate-limiting.html#rate-limiting-strategy "Direct link to Rate Limiting Strategy")
...
### 1. Fixed Window Rate Limiting for Messages[​](https://docs.convex.dev/agents/rate-limiting.html#1-fixed-window-rate-limiting-for-messages "Direct link to 1. Fixed Window Rate Limiting for Messages")
...
### 2. Token Bucket Rate Limiting for Token Usage[​](https://docs.convex.dev/agents/rate-limiting.html#2-token-bucket-rate-limiting-for-token-usage "Direct link to 2. Token Bucket Rate Limiting for Token Usage")
...
## How It Works[​](https://docs.convex.dev/agents/rate-limiting.html#how-it-works "Direct link to How It Works")

### Step 1: Pre-flight Rate Limit Checks[​](https://docs.convex.dev/agents/rate-limiting.html#step-1-pre-flight-rate-limit-checks "Direct link to Step 1: Pre-flight Rate Limit Checks")
...
### Step 2: Post-generation Usage Tracking[​](https://docs.convex.dev/agents/rate-limiting.html#step-2-post-generation-usage-tracking "Direct link to Step 2: Post-generation Usage Tracking")
...
## Client-side Handling[​](https://docs.convex.dev/agents/rate-limiting.html#client-side-handling "Direct link to Client-side Handling")
...
## Token Estimation[​](https://docs.convex.dev/agents/rate-limiting.html#token-estimation "Direct link to Token Estimation")
...
Debugging](https://docs.convex.dev/agents/debugging.html)[Next

Usage Tracking](https://docs.convex.dev/agents/usage-tracking.html)

* [Overview](https://docs.convex.dev/agents/rate-limiting.html#overview)
* [Running the Example](https://docs.convex.dev/agents/rate-limiting.html#running-the-example)
* [Rate Limiting Strategy](https://docs.convex.dev/agents/rate-limiting.html#rate-limiting-strategy)
  + [1. Fixed Window Rate Limiting for Messages](https://docs.convex.dev/agents/rate-limiting.html#1-fixed-window-rate-limiting-for-messages)
  + [2. Token Bucket Rate Limiting for Token Usage](https://docs.convex.dev/agents/rate-limiting.html#2-token-bucket-rate-limiting-for-token-usage)
* [How It Works](https://docs.convex.dev/agents/rate-limiting.html#how-it-works)
  + [Step 1: Pre-flight Rate Limit Checks](https://docs.convex.dev/agents/rate-limiting.html#step-1-pre-flight-rate-limit-checks)
  + [Step 2: Post-generation Usage Tracking](https://docs.convex.dev/agents/rate-limiting.html#step-2-post-generation-usage-tracking)
* [Client-side Handling](https://docs.convex.dev/agents/rate-limiting.html#client-side-handling)
* [Token Estimation](https://docs.convex.dev/agents/rate-limiting.html#token-estimation)
