---
title: "LLM Context | Convex Developer Hub"
source_url: "https://docs.convex.dev/agents/context"
...
[messages.mdx](https://docs.convex.dev/agents/messages.html#message-ordering), but in practice this means that
...
You can also use [RAG](https://docs.convex.dev/agents/rag.html) to add extra context to your prompt.

## Customizing the context[​](https://docs.convex.dev/agents/context.html#customizing-the-context "Direct link to Customizing the context")
...
## Full context control[​](https://docs.convex.dev/agents/context.html#full-context-control "Direct link to Full context control")
...
### Providing a contextHandler[​](https://docs.convex.dev/agents/context.html#providing-a-contexthandler "Direct link to Providing a contextHandler")
...
### Fetch context manually[​](https://docs.convex.dev/agents/context.html#fetch-context-manually "Direct link to Fetch context manually")
...
## Search for messages[​](https://docs.convex.dev/agents/context.html#search-for-messages "Direct link to Search for messages")
...
## Searching other threads[​](https://docs.convex.dev/agents/context.html#searching-other-threads "Direct link to Searching other threads")
...
## Passing in messages as context[​](https://docs.convex.dev/agents/context.html#passing-in-messages-as-context "Direct link to Passing in messages as context")

You can pass in messages as context to the Agent's LLM, for instance to
implement [Retrieval-Augmented Generation](https://docs.convex.dev/agents/rag.html). The final messages sent
to the LLM will be:
...
## Manage embeddings manually[​](https://docs.convex.dev/agents/context.html#manage-embeddings-manually "Direct link to Manage embeddings manually")
...
Tools](https://docs.convex.dev/agents/tools.html)[Next

RAG](https://docs.convex.dev/agents/rag.html)

* [Customizing the context](https://docs.convex.dev/agents/context.html#customizing-the-context)
* [Full context control](https://docs.convex.dev/agents/context.html#full-context-control)
  + [Providing a contextHandler](https://docs.convex.dev/agents/context.html#providing-a-contexthandler)
  + [Fetch context manually](https://docs.convex.dev/agents/context.html#fetch-context-manually)
* [Search for messages](https://docs.convex.dev/agents/context.html#search-for-messages)
* [Searching other threads](https://docs.convex.dev/agents/context.html#searching-other-threads)
* [Passing in messages as context](https://docs.convex.dev/agents/context.html#passing-in-messages-as-context)
* [Manage embeddings manually](https://docs.convex.dev/agents/context.html#manage-embeddings-manually)
