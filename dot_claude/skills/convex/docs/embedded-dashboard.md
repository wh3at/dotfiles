---
title: "Embedding the dashboard | Convex Developer Hub"
source_url: "https://docs.convex.dev/platform-apis/embedded-dashboard"
...
Application](https://docs.convex.dev/platform-apis/oauth-applications.html).

Required information for `postMessage`:

* `deploymentUrl`: The deployment cloud URL. Returned when creating the project
  with the [Create project API](https://docs.convex.dev/management-api/create-project.html)
* `deploymentName`: The readable identifier for the deployment. Returned when
  creating the project with the
  [Create project API](https://docs.convex.dev/management-api/create-project.html).
* `adminKey`: A deploy key scoped to the specified `deploymentName`. Can be
  retrieved with the [Create deploy key API](https://docs.convex.dev/management-api/create-deploy-key.html).
...
OAuth Applications](https://docs.convex.dev/platform-apis/oauth-applications.html)[Next
