---
title: "Tools | Convex Developer Hub"
source_url: "https://docs.convex.dev/agents/tools"
...
## Defining tools[​](https://docs.convex.dev/agents/tools.html#defining-tools "Direct link to Defining tools")
...
## Using tools[​](https://docs.convex.dev/agents/tools.html#using-tools "Direct link to Using tools")
...
with the source message. See [Messages](https://docs.convex.dev/agents/messages.html) for more details.

## Creating a tool with a Convex context[​](https://docs.convex.dev/agents/tools.html#creating-a-tool-with-a-convex-context "Direct link to Creating a tool with a Convex context")
...
### Adding custom context to tools[​](https://docs.convex.dev/agents/tools.html#adding-custom-context-to-tools "Direct link to Adding custom context to tools")
...
## Using an LLM or Agent as a tool[​](https://docs.convex.dev/agents/tools.html#using-an-llm-or-agent-as-a-tool "Direct link to Using an LLM or Agent as a tool")
...
### Direct LLM generation without a thread:[​](https://docs.convex.dev/agents/tools.html#direct-llm-generation-without-a-thread "Direct link to Direct LLM generation without a thread:")
...
### Using an Agent as a tool[​](https://docs.convex.dev/agents/tools.html#using-an-agent-as-a-tool "Direct link to Using an Agent as a tool")
...
Playground](https://docs.convex.dev/agents/playground.html)[Next

LLM Context](https://docs.convex.dev/agents/context.html)

* [Defining tools](https://docs.convex.dev/agents/tools.html#defining-tools)
* [Using tools](https://docs.convex.dev/agents/tools.html#using-tools)
* [Creating a tool with a Convex context](https://docs.convex.dev/agents/tools.html#creating-a-tool-with-a-convex-context)
  + [Adding custom context to tools](https://docs.convex.dev/agents/tools.html#adding-custom-context-to-tools)
* [Using an LLM or Agent as a tool](https://docs.convex.dev/agents/tools.html#using-an-llm-or-agent-as-a-tool)
  + [Direct LLM generation without a thread:](https://docs.convex.dev/agents/tools.html#direct-llm-generation-without-a-thread)
  + [Using an Agent as a tool](https://docs.convex.dev/agents/tools.html#using-an-agent-as-a-tool)
