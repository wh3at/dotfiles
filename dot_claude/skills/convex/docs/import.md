---
title: "Data Import | Convex Developer Hub"
source_url: "https://docs.convex.dev/database/import-export/import"
...
* [Data Import & Export](https://docs.convex.dev/database/import-export/index.html)
* Data Import
...
Data import is currently a [beta
...
## Single table import[​](https://docs.convex.dev/database/import-export/import.html#single-table-import "Direct link to Single table import")
...
## Restore data from a backup ZIP file[​](https://docs.convex.dev/database/import-export/import.html#restore-data-from-a-backup-zip-file "Direct link to Restore data from a backup ZIP file")

```
npx convex import <path>.zip
```

Import from a [Backup](https://docs.convex.dev/database/backup-restore.html) into a Convex deployment, where
...
## Use cases[​](https://docs.convex.dev/database/import-export/import.html#use-cases "Direct link to Use cases")
...
2. Restore a deployment from a [backup](https://docs.convex.dev/database/backup-restore.html)
...
## Features[​](https://docs.convex.dev/database/import-export/import.html#features "Direct link to Features")
...
* Data import of ZIP files that include [file storage](https://docs.convex.dev/file-storage.html) import the
  files and preserve [`_storage`](https://docs.convex.dev/database/advanced/system-tables.html)
  documents, including their `_id`, `_creationTime`, and `contentType` fields.

## Warnings[​](https://docs.convex.dev/database/import-export/import.html#warnings "Direct link to Warnings")

* [Streaming Export](https://docs.convex.dev/production/integrations/streaming-import-export.html)
...
[limits docs](https://docs.convex.dev/production/state/limits.html#database).

[Previous

Data Export](https://docs.convex.dev/database/import-export/export.html)[Next

System Tables](https://docs.convex.dev/database/advanced/system-tables.html)

* [Single table import](https://docs.convex.dev/database/import-export/import.html#single-table-import)
* [Restore data from a backup ZIP file](https://docs.convex.dev/database/import-export/import.html#restore-data-from-a-backup-zip-file)
* [Use cases](https://docs.convex.dev/database/import-export/import.html#use-cases)
* [Features](https://docs.convex.dev/database/import-export/import.html#features)
* [Warnings](https://docs.convex.dev/database/import-export/import.html#warnings)
