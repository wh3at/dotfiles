...
source_url: "https://docs.convex.dev/agents/agent-usage"
...
## Basic Agent definition[​](https://docs.convex.dev/agents/agent-usage.html#basic-agent-definition "Direct link to Basic Agent definition")
...
See [below](https://docs.convex.dev/agents/agent-usage.html#customizing-the-agent) for more configuration options.
...
## Dynamic Agent definition[​](https://docs.convex.dev/agents/agent-usage.html#dynamic-agent-definition "Direct link to Dynamic Agent definition")
...
## Generating text with an Agent[​](https://docs.convex.dev/agents/agent-usage.html#generating-text-with-an-agent "Direct link to Generating text with an Agent")
...
[thread](https://docs.convex.dev/agents/threads.html). See [LLM Context](https://docs.convex.dev/agents/context.html) for details on how to
...
### Streaming text[​](https://docs.convex.dev/agents/agent-usage.html#streaming-text "Direct link to Streaming text")
...
[streaming](https://docs.convex.dev/agents/streaming.html) for more details.

### Basic approach (synchronous)[​](https://docs.convex.dev/agents/agent-usage.html#basic-approach-synchronous "Direct link to Basic approach (synchronous)")
...
### Saving the prompt then generating response(s) asynchronously[​](https://docs.convex.dev/agents/agent-usage.html#saving-the-prompt-then-generating-responses-asynchronously "Direct link to Saving the prompt then generating response(s) asynchronously")
...
* You can save the message in the same mutation (transaction) as other writes to
  ...
  left off. See [workflows](https://docs.convex.dev/agents/workflows.html) for more details.
...
### Generating an object[​](https://docs.convex.dev/agents/agent-usage.html#generating-an-object "Direct link to Generating an object")
...
## Customizing the agent[​](https://docs.convex.dev/agents/agent-usage.html#customizing-the-agent "Direct link to Customizing the agent")
...
Getting Started](https://docs.convex.dev/agents/getting-started.html)[Next

Threads](https://docs.convex.dev/agents/threads.html)

* [Basic Agent definition](https://docs.convex.dev/agents/agent-usage.html#basic-agent-definition)
* [Dynamic Agent definition](https://docs.convex.dev/agents/agent-usage.html#dynamic-agent-definition)
* [Generating text with an Agent](https://docs.convex.dev/agents/agent-usage.html#generating-text-with-an-agent)
  + [Streaming text](https://docs.convex.dev/agents/agent-usage.html#streaming-text)
  + [Basic approach (synchronous)](https://docs.convex.dev/agents/agent-usage.html#basic-approach-synchronous)
  + [Saving the prompt then generating response(s) asynchronously](https://docs.convex.dev/agents/agent-usage.html#saving-the-prompt-then-generating-responses-asynchronously)
  + [Generating an object](https://docs.convex.dev/agents/agent-usage.html#generating-an-object)
* [Customizing the agent](https://docs.convex.dev/agents/agent-usage.html#customizing-the-agent)
