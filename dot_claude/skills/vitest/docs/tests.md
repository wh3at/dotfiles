---
title: "Running Tests advanced | Vitest"
source_url: "https://vitest.dev/guide/advanced/tests"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/advanced/tests.md for this page in Markdown format

# Running Tests advanced [​](https://vitest.dev/guide/advanced/tests.html#running-tests)

WARNING

This guide explains how to use the advanced API to run tests via a Node.js script. If you just want to [run tests](https://vitest.dev/guide/index.html), you probably don't need this. It is primarily used by library authors.
...
## `startVitest` [​](https://vitest.dev/guide/advanced/tests.html#startvitest)
...
## `createVitest` [​](https://vitest.dev/guide/advanced/tests.html#createvitest)
