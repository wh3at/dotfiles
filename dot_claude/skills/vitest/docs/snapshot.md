...
source_url: "https://vitest.dev/guide/snapshot"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/snapshot.md for this page in Markdown format

# Snapshot [​](https://vitest.dev/guide/snapshot.html#snapshot)
...
## Use Snapshots [​](https://vitest.dev/guide/snapshot.html#use-snapshots)
...
When using Snapshots with async concurrent tests, `expect` from the local [Test Context](https://vitest.dev/guide/test-context.html) must be used to ensure the right test is detected.

## Inline Snapshots [​](https://vitest.dev/guide/snapshot.html#inline-snapshots)
...
## Updating Snapshots [​](https://vitest.dev/guide/snapshot.html#updating-snapshots)
...
## File Snapshots [​](https://vitest.dev/guide/snapshot.html#file-snapshots)
...
## Visual Snapshots [​](https://vitest.dev/guide/snapshot.html#visual-snapshots)

For visual regression testing of UI components and pages, Vitest provides built-in support through [browser mode](https://vitest.dev/guide/browser.html) with the [`toMatchScreenshot()`](https://vitest.dev/api/browser/assertions#tomatchscreenshot-experimental) assertion:
...
This captures screenshots and compares them against reference images to detect unintended visual changes. Learn more in the [Visual Regression Testing guide](https://vitest.dev/guide/browser/visual-regression-testing.html).

## Custom Serializer [​](https://vitest.dev/guide/snapshot.html#custom-serializer)
...
## Difference from Jest [​](https://vitest.dev/guide/snapshot.html#difference-from-jest)
...
#### 1. Comment header in the snapshot file is different [​](https://vitest.dev/guide/snapshot.html#_1-comment-header-in-the-snapshot-file-is-different)
...
#### 2. `printBasicPrototype` is default to `false` [​](https://vitest.dev/guide/snapshot.html#_2-printbasicprototype-is-default-to-false)
...
#### 3. Chevron `>` is used as a separator instead of colon `:` for custom messages [​](https://vitest.dev/guide/snapshot.html#_3-chevron-is-used-as-a-separator-instead-of-colon-for-custom-messages)
...
#### 4. default `Error` snapshot is different for `toThrowErrorMatchingSnapshot` and `toThrowErrorMatchingInlineSnapshot` [​](https://vitest.dev/guide/snapshot.html#_4-default-error-snapshot-is-different-for-tothrowerrormatchingsnapshot-and-tothrowerrormatchinginlinesnapshot)
