---
title: "Manage metafield definitions"
source_url: "https://shopify.dev/docs/apps/build/custom-data/metafields/definitions"
...
* [Requirements](https://shopify.dev/docs/apps/build/metafields/definitions#requirements)
* [Creating definitions](https://shopify.dev/docs/apps/build/metafields/definitions#creating-definitions)
* [Reading definitions](https://shopify.dev/docs/apps/build/metafields/definitions#reading-definitions)
* [Updating definitions](https://shopify.dev/docs/apps/build/metafields/definitions#updating-definitions)
* [Deleting definitions](https://shopify.dev/docs/apps/build/metafields/definitions#deleting-definitions)
* [Access control](https://shopify.dev/docs/apps/build/metafields/definitions#access-control)
* [Standard definitions](https://shopify.dev/docs/apps/build/metafields/definitions#standard-definitions)
* [Error handling](https://shopify.dev/docs/apps/build/metafields/definitions#error-handling)
* [Best practices](https://shopify.dev/docs/apps/build/metafields/definitions#best-practices)
* [TOML reference](https://shopify.dev/docs/apps/build/metafields/definitions#toml-reference)
* [TOML limitations](https://shopify.dev/docs/apps/build/metafields/definitions#toml-limitations)
* [Next steps](https://shopify.dev/docs/apps/build/metafields/definitions#next-steps)
...
## [Anchor to Requirements](https://shopify.dev/docs/apps/build/metafields/definitions#requirements)Requirements
...
## [Anchor to Creating definitions](https://shopify.dev/docs/apps/build/metafields/definitions#creating-definitions)Creating definitions
...
### [Anchor to TOML (app-owned) example](https://shopify.dev/docs/apps/build/metafields/definitions#toml-app-owned-example)TOML (app-owned) example
...
### [Anchor to GraphQL Admin API example](https://shopify.dev/docs/apps/build/metafields/definitions#graphql-admin-api-example)GraphQL Admin API example
...
### [Anchor to When to use GraphQL vs TOML](https://shopify.dev/docs/apps/build/metafields/definitions#when-to-use-graphql-vs-toml)When to use GraphQL vs TOML
...
### [Anchor to Dynamic definition creation example](https://shopify.dev/docs/apps/build/metafields/definitions#dynamic-definition-creation-example)Dynamic definition creation example
...
## [Anchor to Reading definitions](https://shopify.dev/docs/apps/build/metafields/definitions#reading-definitions)Reading definitions
...
Query the [`metafieldDefinitionTypes`](https://shopify.dev/docs/api/admin-graphql/latest/queries/metafieldDefinitionTypes) field to see which validations each type supports, or check the [`supportedValidations`](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetafieldDefinition#field-supportedvalidations) field when querying existing definitions.

---

## [Anchor to Updating definitions](https://shopify.dev/docs/apps/build/metafields/definitions#updating-definitions)Updating definitions
...
## [Anchor to Deleting definitions](https://shopify.dev/docs/apps/build/metafields/definitions#deleting-definitions)Deleting definitions
...
## [Anchor to Access control](https://shopify.dev/docs/apps/build/metafields/definitions#access-control)Access control
...
## [Anchor to Standard definitions](https://shopify.dev/docs/apps/build/metafields/definitions#standard-definitions)Standard definitions
...
Standard definitions auto-enable when your app [creates metafield values](https://shopify.dev/docs/apps/build/metafields/manage-metafields#using-standard-definitions) for them. Manually enable them to make the definition available in the Shopify admin for populating values.
...
## [Anchor to Error handling](https://shopify.dev/docs/apps/build/metafields/definitions#error-handling)Error handling
...
| "Type <invalid\_type> is not a valid type" | Invalid type name | Check [available types](https://shopify.dev/docs/apps/build/metafields/list-of-data-types) |
| "Validation <validation\_name> is not supported for type <type\_name>" | Wrong validation for type | Query [`supportedValidations`](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetafieldDefinition#field-supportedvalidations) or check [validations guide](https://shopify.dev/docs/apps/build/metafields/list-of-validation-options) |
| "App does not have permission to modify this definition" | Not app-owned | Only app-owned definitions can be modified by apps |

---

## [Anchor to Best practices](https://shopify.dev/docs/apps/build/metafields/definitions#best-practices)Best practices
...
## [Anchor to TOML reference](https://shopify.dev/docs/apps/build/metafields/definitions#toml-reference)TOML reference
...
| --- | --- |
| `type` | Data type for the metafield. See [metafield data types](https://shopify.dev/docs/apps/build/metafields/list-of-data-types). |
...
| `validations` | Rules to validate field values (for example, min/max values, regex patterns). See [validation options](https://shopify.dev/docs/apps/build/metafields/list-of-validation-options). |

---

## [Anchor to TOML limitations](https://shopify.dev/docs/apps/build/metafields/definitions#toml-limitations)TOML limitations

When using TOML-based declarative definitions, be aware of these constraints:

### [Anchor to App-reserved namespace](https://shopify.dev/docs/apps/build/metafields/definitions#app-reserved-namespace)App-reserved namespace
...
### [Anchor to App-scoped limits](https://shopify.dev/docs/apps/build/metafields/definitions#app-scoped-limits)App-scoped limits
...
### [Anchor to Read-only through Admin API](https://shopify.dev/docs/apps/build/metafields/definitions#read-only-through-admin-api)Read-only through Admin API
...
### [Anchor to Capability support](https://shopify.dev/docs/apps/build/metafields/definitions#capability-support)Capability support

| Capability | Supported in TOML |
| --- | --- |
| [Smart collections](https://shopify.dev/docs/apps/build/metafields/use-metafield-capabilities#smart-collection) | ❌ |
| [Admin filterable](https://shopify.dev/docs/apps/build/metafields/use-metafield-capabilities#admin-filterable) | ✅ |
| [Unique values](https://shopify.dev/docs/apps/build/metafields/use-metafield-capabilities#unique-values) | ✅ |
| [Pinning](https://help.shopify.com/en/manual/custom-data/metafields/pinning-metafield-definitions) | ❌ |

---

## [Anchor to Next steps](https://shopify.dev/docs/apps/build/metafields/definitions#next-steps)Next steps
