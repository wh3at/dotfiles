...
source_url: "https://vitest.dev/guide/improving-performance"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/improving-performance.md for this page in Markdown format

# Improving Performance [​](https://vitest.dev/guide/improving-performance.html#improving-performance)
...
## Limiting directory search [​](https://vitest.dev/guide/improving-performance.html#limiting-directory-search)
...
## Sharding [​](https://vitest.dev/guide/improving-performance.html#sharding)
...
To split Vitest tests on multiple different runs, use [`--shard`](https://vitest.dev/guide/cli.html#shard) option with [`--reporter=blob`](https://vitest.dev/guide/reporters.html#blob-reporter) option:
...
Collect the results stored in `.vitest-reports` directory from each machine and merge them with [`--merge-reports`](https://vitest.dev/guide/cli.html#merge-reports) option:
