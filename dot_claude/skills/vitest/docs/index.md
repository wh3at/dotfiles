---
title: "Advanced API | Vitest"
source_url: "https://vitest.dev/guide/advanced/index"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/advanced.md for this page in Markdown format

# Getting Started advanced [​](https://vitest.dev/guide/advanced/index.html#getting-started)

WARNING

This guide lists advanced APIs to run tests via a Node.js script. If you just want to [run tests](https://vitest.dev/guide/index.html), you probably don't need this. It is primarily used by library authors.

You can import any method from the `vitest/node` entry-point.

## startVitest [​](https://vitest.dev/guide/advanced/index.html#startvitest)
...
The ["Running Tests"](https://vitest.dev/guide/advanced/tests.html#startvitest) guide has a usage example.

## createVitest [​](https://vitest.dev/guide/advanced/index.html#createvitest)
...
The ["Running Tests"](https://vitest.dev/guide/advanced/tests.html#createvitest) guide has a usage example.

## resolveConfig [​](https://vitest.dev/guide/advanced/index.html#resolveconfig)
...
## parseCLI [​](https://vitest.dev/guide/advanced/index.html#parsecli)
