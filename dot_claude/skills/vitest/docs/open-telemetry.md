---
title: "Open Telemetry Support | Vitest"
source_url: "https://vitest.dev/guide/open-telemetry"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/open-telemetry.md for this page in Markdown format

# Open Telemetry Support experimental [​](https://vitest.dev/guide/open-telemetry.html#open-telemetry-support)
...
## Quickstart [​](https://vitest.dev/guide/open-telemetry.html#quickstart)
...
## Custom Traces [​](https://vitest.dev/guide/open-telemetry.html#custom-traces)
...
## View Traces [​](https://vitest.dev/guide/open-telemetry.html#view-traces)
...
![](https://vitest.dev/otel-jaeger.png)

## `@opentelemetry/api` [​](https://vitest.dev/guide/open-telemetry.html#opentelemetry-api)
