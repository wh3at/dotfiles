...
source_url: "https://vitest.dev/guide/extending-matchers"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/extending-matchers.md for this page in Markdown format

# Extending Matchers [​](https://vitest.dev/guide/extending-matchers.html#extending-matchers)
...
### `isNot` [​](https://vitest.dev/guide/extending-matchers.html#isnot)

Returns true, if matcher was called on `not` (`expect(received).not.toBeFoo()`).

### `promise` [​](https://vitest.dev/guide/extending-matchers.html#promise)
...
### `equals` [​](https://vitest.dev/guide/extending-matchers.html#equals)
...
### `utils` [​](https://vitest.dev/guide/extending-matchers.html#utils)
...
### `currentTestName` [​](https://vitest.dev/guide/extending-matchers.html#currenttestname)

Full name of the current test (including describe block).

### `task` advanced 4.0.11+ [​](https://vitest.dev/guide/extending-matchers.html#task)
...
### `testPath` [​](https://vitest.dev/guide/extending-matchers.html#testpath)
