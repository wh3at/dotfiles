...
source_url: "https://vitest.dev/guide/ui"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/ui.md for this page in Markdown format
...
You can check your coverage report in Vitest UI: see [Vitest UI Coverage](https://vitest.dev/guide/coverage.html#vitest-ui) for more details.
...
## Module Graph [​](https://vitest.dev/guide/ui.html#module-graph)
...
![The module graph view](https://vitest.dev/ui/light-module-graph.png)![The module graph view](https://vitest.dev/ui/dark-module-graph.png)
...
### Module Info [​](https://vitest.dev/guide/ui.html#module-info)

By left-clicking on the module node, you open the Module Info view.

![The module info view for an inlined module](https://vitest.dev/ui/light-module-info.png)![The module info view for an inlined module](https://vitest.dev/ui/dark-module-info.png)
...
![The module info view for an external module](https://vitest.dev/ui/light-module-info-external.png)![The module info view for an external module](https://vitest.dev/ui/dark-module-info-external.png)
...
![The module info view for an internal module](https://vitest.dev/ui/light-module-info-traverse.png)![The module info view for an internal module](https://vitest.dev/ui/dark-module-info-traverse.png)
...
![The module info view for an internal module](https://vitest.dev/ui/light-module-info-shadow.png)![The module info view for an internal module](https://vitest.dev/ui/dark-module-info-shadow.png)
...
### Import Breakdown [​](https://vitest.dev/guide/ui.html#import-breakdown)
...
![Import breakdown with a list of top 10 modules that take the longest time to load](https://vitest.dev/ui/light-import-breakdown.png)![Import breakdown with a list of top 10 modules that take the longest time to load](https://vitest.dev/ui/dark-import-breakdown.png)
