---
title: "Custom Pool advanced | Vitest"
source_url: "https://vitest.dev/guide/advanced/pool"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/advanced/pool.md for this page in Markdown format

# Custom Pool advanced [​](https://vitest.dev/guide/advanced/pool.html#custom-pool)

WARNING

This is an advanced, experimental and very low-level API. If you just want to [run tests](https://vitest.dev/guide/index.html), you probably don't need this. It is primarily used by library authors.
...
## Usage [​](https://vitest.dev/guide/advanced/pool.html#usage)
...
If you need to run tests in different pools, use the [`projects`](https://vitest.dev/guide/projects.html) feature:
...
## API [​](https://vitest.dev/guide/advanced/pool.html#api)
