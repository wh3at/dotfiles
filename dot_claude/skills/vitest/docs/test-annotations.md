---
title: "Test Annotations | Guide | Vitest"
source_url: "https://vitest.dev/guide/test-annotations"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/test-annotations.md for this page in Markdown format

# Test Annotations [​](https://vitest.dev/guide/test-annotations.html#test-annotations)

Vitest supports annotating your tests with custom messages and files via the [`context.annotate`](https://vitest.dev/guide/test-context.html#annotate) API. These annotations will be attached to the test case and passed down to reporters in the [`onTestAnnotate`](https://vitest.dev/api/advanced/reporters#ontestannotate) hook.
...
## Built-in Reporters [​](https://vitest.dev/guide/test-annotations.html#built-in-reporters)

### default [​](https://vitest.dev/guide/test-annotations.html#default)
...
### verbose [​](https://vitest.dev/guide/test-annotations.html#verbose)
...
### html [​](https://vitest.dev/guide/test-annotations.html#html)
...
![Vitest UI](https://vitest.dev/annotations-html-light.png)![Vitest UI](https://vitest.dev/annotations-html-dark.png)

### junit [​](https://vitest.dev/guide/test-annotations.html#junit)
...
### github-actions [​](https://vitest.dev/guide/test-annotations.html#github-actions)
...
![GitHub Actions](https://vitest.dev/annotations-gha-light.png)![GitHub Actions](https://vitest.dev/annotations-gha-dark.png)

### tap [​](https://vitest.dev/guide/test-annotations.html#tap)
