---
title: "Create a local pickup charges function"
source_url: "https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function"
...
* [What you'll learn](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#what-youll-learn)
* [Requirements](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#requirements)
* [Step 1: Create the local pickup delivery option generator function](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#step-1-create-the-local-pickup-delivery-option-generator-function)
* [Step 2: Preview the function on a development store](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#step-2-preview-the-function-on-a-development-store)
* [Step 3: Test the local pickup delivery option generator](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#step-3-test-the-local-pickup-delivery-option-generator)
* [Next steps](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#next-steps)
...
## [Anchor to What you'll learn](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#what-youll-learn)What you'll learn
...
## [Anchor to Requirements](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#requirements)Requirements
...
### [Anchor to Rust-specific requirements](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#rust-specific-requirements)Rust-specific requirements
...
## [Anchor to Step 1: Create the local pickup delivery option generator function](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#step-1-create-the-local-pickup-delivery-option-generator-function)Step 1: Create the local pickup delivery option generator function
...
## [Anchor to Step 2: Preview the function on a development store](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#step-2-preview-the-function-on-a-development-store)Step 2: Preview the function on a development store
...
## [Anchor to Step 3: Test the local pickup delivery option generator](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#step-3-test-the-local-pickup-delivery-option-generator)Step 3: Test the local pickup delivery option generator
...
## [Anchor to Next steps](https://shopify.dev/docs/apps/build/checkout/delivery-shipping/delivery-methods/create-local-pickup-charges-function#next-steps)Next steps
