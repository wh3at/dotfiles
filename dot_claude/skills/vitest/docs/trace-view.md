---
title: "Trace View | Vitest"
source_url: "https://vitest.dev/guide/browser/trace-view"
fetched_at: "2025-12-11T04:49:28.191885+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/browser/trace-view.md for this page in Markdown format

# Trace View [​](https://vitest.dev/guide/browser/trace-view.html#trace-view)
...
The traces are available in reporters as [annotations](https://vitest.dev/guide/test-annotations.html). For example, in the HTML reporter, you can find the link to the trace file in the test details.

## Preview [​](https://vitest.dev/guide/browser/trace-view.html#preview)
...
## Limitations [​](https://vitest.dev/guide/browser/trace-view.html#limitations)
