---
title: "User definable values | fast-check"
source_url: "https://fast-check.dev/docs/configuration/user-definable-values/index"
fetched_at: "2025-12-29T00:49:30.561244+00:00"
---



* * [Configuration](https://fast-check.dev/docs/configuration/index.html)* User definable values

On this page

Snapshot errors previously encountered and ask for help to reduce cases.

## Run against custom values[​](https://fast-check.dev/docs/configuration/user-definable-values/index.html#run-against-custom-values "Direct link to Run against custom values")
...
## Shrink custom values[​](https://fast-check.dev/docs/configuration/user-definable-values/index.html#shrink-custom-values "Direct link to Shrink custom values")
...
Timeouts](https://fast-check.dev/docs/configuration/timeouts/index.html)[Next

Advanced](https://fast-check.dev/docs/advanced/)

* [Run against custom values](https://fast-check.dev/docs/configuration/user-definable-values/index.html#run-against-custom-values)* [Shrink custom values](https://fast-check.dev/docs/configuration/user-definable-values/index.html#shrink-custom-values)
