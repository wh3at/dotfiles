---
title: "Timeouts | fast-check"
source_url: "https://fast-check.dev/docs/configuration/timeouts/index"
fetched_at: "2025-12-29T00:49:30.561244+00:00"
---



* * [Configuration](https://fast-check.dev/docs/configuration/index.html)* Timeouts

On this page

Learn about the various timeout options available in the fast-check.

## How and where to stop?[​](https://fast-check.dev/docs/configuration/timeouts/index.html#how-and-where-to-stop "Direct link to How and where to stop?")
...
## At predicate level[​](https://fast-check.dev/docs/configuration/timeouts/index.html#at-predicate-level "Direct link to At predicate level")

### timeout[​](https://fast-check.dev/docs/configuration/timeouts/index.html#timeout "Direct link to timeout")
...
Interaction with `beforeEach` and `afterEach`
...
## At runner level[​](https://fast-check.dev/docs/configuration/timeouts/index.html#at-runner-level "Direct link to At runner level")

### interruptAfterTimeLimit[​](https://fast-check.dev/docs/configuration/timeouts/index.html#interruptaftertimelimit "Direct link to interruptAfterTimeLimit")
...
|  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Interrupted... Resulting status with `markInterruptAsFailure: false` Resulting status with `markInterruptAsFailure: true`|  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | without any success Failure Failure|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | with at least one success Success Failure|  |  |  | | --- | --- | --- | | during shrink phase Failure (shrink only happens on failures) Failure | | | | | | | | | | | |

Companion for Fuzzing
...
### skipAllAfterTimeLimit[​](https://fast-check.dev/docs/configuration/timeouts/index.html#skipallaftertimelimit "Direct link to skipAllAfterTimeLimit")
...
Interrupting is more efficient
...
## All timeout options[​](https://fast-check.dev/docs/configuration/timeouts/index.html#all-timeout-options "Direct link to All timeout options")

|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Option Level Property kind `beforeEach`/`afterEach` included in the measured time Mark run as failed|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | `timeout` predicate async no yes|  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | `interruptAfterTimeLimit` runner sync and async yes no except when first run or `markInterruptAsFailure:true`| `skipAllAfterTimeLimit` runner sync and async yes no except when timeout occured outside of the shrink phase | | | | | | | | | | | | | | | | | | | |

Always run `beforeEach` and `afterEach`
...
Larger entries by default](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html)[Next

User definable values](https://fast-check.dev/docs/configuration/user-definable-values/index.html)

* [How and where to stop?](https://fast-check.dev/docs/configuration/timeouts/index.html#how-and-where-to-stop)* [At predicate level](https://fast-check.dev/docs/configuration/timeouts/index.html#at-predicate-level)
    + [timeout](https://fast-check.dev/docs/configuration/timeouts/index.html#timeout)* [At runner level](https://fast-check.dev/docs/configuration/timeouts/index.html#at-runner-level)
      + [interruptAfterTimeLimit](https://fast-check.dev/docs/configuration/timeouts/index.html#interruptaftertimelimit)+ [skipAllAfterTimeLimit](https://fast-check.dev/docs/configuration/timeouts/index.html#skipallaftertimelimit)* [All timeout options](https://fast-check.dev/docs/configuration/timeouts/index.html#all-timeout-options)
