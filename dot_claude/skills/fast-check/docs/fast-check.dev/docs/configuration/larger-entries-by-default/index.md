---
title: "Larger entries by default | fast-check"
source_url: "https://fast-check.dev/docs/configuration/larger-entries-by-default/index"
fetched_at: "2025-12-29T00:49:30.561244+00:00"
---



* * [Configuration](https://fast-check.dev/docs/configuration/index.html)* Larger entries by default

On this page

Customize the default "good enough" size for your tests.

## What's the best length?[​](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html#whats-the-best-length "Direct link to What's the best length?")
...
## Size explained[​](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html#size-explained "Direct link to Size explained")
...
* Relative size: `"-4"`, `"-3"`, `"-2"`, `"-1"`, `"="`, `"+1"`, `"+2"`, `"+3"` or `"+4"` — *offset the global setting `baseSize` by the passed offset*
* Explicit size: `"xsmall"`, `"small"`, `"medium"`, `"large"` or `"xlarge"` — *use an explicit size*
* Exact value: `"max"` — *generate entities having up-to `maxLength` items*
* Automatic size: `undefined` — *if `maxLength` has not been specified or if the global setting `defaultSizeToMaxWhenMaxSpecified` is `false` then `"="`, otherwise `"max"`*
...
## Depth size explained[​](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html#depth-size-explained "Direct link to Depth size explained")

Since version 2.25.0, there is a tied link between [size](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html#size-explained) and depth of recursive structures.
...
## Override the default size[​](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html#override-the-default-size "Direct link to Override the default size")
...
To learn how to customize the size for a particular arbitrary, please refer to the [documentation](https://fast-check.dev/docs/core-blocks/arbitraries/) provided for that arbitrary.

[Previous

Global settings](https://fast-check.dev/docs/configuration/global-settings/index.html)[Next

Timeouts](https://fast-check.dev/docs/configuration/timeouts/index.html)

* [What's the best length?](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html#whats-the-best-length)* [Size explained](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html#size-explained)* [Depth size explained](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html#depth-size-explained)* [Override the default size](https://fast-check.dev/docs/configuration/larger-entries-by-default/index.html#override-the-default-size)
