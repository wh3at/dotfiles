---
title: "Model based testing | fast-check"
source_url: "https://fast-check.dev/docs/advanced/model-based-testing/index"
fetched_at: "2025-12-29T00:50:11.704609+00:00"
---



* * [Advanced](https://fast-check.dev/docs/advanced/index.html)* Model based testing

On this page

Turn fast-check into a crazy QA

## Overview[​](https://fast-check.dev/docs/advanced/model-based-testing/index.html#overview "Direct link to Overview")
...
## Write model-based tests[​](https://fast-check.dev/docs/advanced/model-based-testing/index.html#write-model-based-tests "Direct link to Write model-based tests")

### Define the commands[​](https://fast-check.dev/docs/advanced/model-based-testing/index.html#define-the-commands "Direct link to Define the commands")
...
### Generate the commands[​](https://fast-check.dev/docs/advanced/model-based-testing/index.html#generate-the-commands "Direct link to Generate the commands")
...
### Print the commands[​](https://fast-check.dev/docs/advanced/model-based-testing/index.html#print-the-commands "Direct link to Print the commands")
...
### Run the commands[​](https://fast-check.dev/docs/advanced/model-based-testing/index.html#run-the-commands "Direct link to Run the commands")
...
### Example[​](https://fast-check.dev/docs/advanced/model-based-testing/index.html#example "Direct link to Example")
...
## Replay model-based tests[​](https://fast-check.dev/docs/advanced/model-based-testing/index.html#replay-model-based-tests "Direct link to Replay model-based tests")
...
Fuzzing](https://fast-check.dev/docs/advanced/fuzzing/index.html)[Next

Race conditions](https://fast-check.dev/docs/advanced/race-conditions/index.html)

* [Overview](https://fast-check.dev/docs/advanced/model-based-testing/index.html#overview)* [Write model-based tests](https://fast-check.dev/docs/advanced/model-based-testing/index.html#write-model-based-tests)
    + [Define the commands](https://fast-check.dev/docs/advanced/model-based-testing/index.html#define-the-commands)+ [Generate the commands](https://fast-check.dev/docs/advanced/model-based-testing/index.html#generate-the-commands)+ [Print the commands](https://fast-check.dev/docs/advanced/model-based-testing/index.html#print-the-commands)+ [Run the commands](https://fast-check.dev/docs/advanced/model-based-testing/index.html#run-the-commands)+ [Example](https://fast-check.dev/docs/advanced/model-based-testing/index.html#example)* [Replay model-based tests](https://fast-check.dev/docs/advanced/model-based-testing/index.html#replay-model-based-tests)
