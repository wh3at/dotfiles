---
title: "Fake data | fast-check"
source_url: "https://fast-check.dev/docs/advanced/fake-data/index"
fetched_at: "2025-12-29T00:50:11.704609+00:00"
---



* * [Advanced](https://fast-check.dev/docs/advanced/index.html)* Fake data

On this page

Replace random fake data by fake data backed by property based

## From tests with random to properties[​](https://fast-check.dev/docs/advanced/fake-data/index.html#from-tests-with-random-to-properties "Direct link to From tests with random to properties")
...
## Native ones[​](https://fast-check.dev/docs/advanced/fake-data/index.html#native-ones "Direct link to Native ones")

Although fast-check is not primarily designed for generating fake data, it does come with a number of [built-in generators](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/) doing so. Each built-in generator is designed to produce any acceptable value for the requested data, taking into account any subtleties in the specification.
...
If you need to generate custom fake data, such as names and surnames, you can refer to fast-check's [combiners](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/), which are designed to allow users to create their own values according to their specific needs.

## Fake data libraries[​](https://fast-check.dev/docs/advanced/fake-data/index.html#fake-data-libraries "Direct link to Fake data libraries")
...
### Seed-based (eg.: @faker-js/faker)[​](https://fast-check.dev/docs/advanced/fake-data/index.html#seed-based-eg-faker-jsfaker "Direct link to Seed-based (eg.: @faker-js/faker)")
...
Recommended integration for Faker
...
### Random-based (eg.: lorem-ipsum)[​](https://fast-check.dev/docs/advanced/fake-data/index.html#random-based-eg-lorem-ipsum "Direct link to Random-based (eg.: lorem-ipsum)")
...
Advanced](https://fast-check.dev/docs/advanced/index.html)[Next

Fuzzing](https://fast-check.dev/docs/advanced/fuzzing/index.html)

* [From tests with random to properties](https://fast-check.dev/docs/advanced/fake-data/index.html#from-tests-with-random-to-properties)* [Native ones](https://fast-check.dev/docs/advanced/fake-data/index.html#native-ones)* [Fake data libraries](https://fast-check.dev/docs/advanced/fake-data/index.html#fake-data-libraries)
      + [Seed-based (eg.: @faker-js/faker)](https://fast-check.dev/docs/advanced/fake-data/index.html#seed-based-eg-faker-jsfaker)+ [Random-based (eg.: lorem-ipsum)](https://fast-check.dev/docs/advanced/fake-data/index.html#random-based-eg-lorem-ipsum)
