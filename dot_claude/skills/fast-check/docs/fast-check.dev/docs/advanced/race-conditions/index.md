---
title: "Race conditions | fast-check"
source_url: "https://fast-check.dev/docs/advanced/race-conditions/index"
fetched_at: "2025-12-29T00:50:11.704609+00:00"
---



* * [Advanced](https://fast-check.dev/docs/advanced/index.html)* Race conditions

On this page

Easily detect race conditions in your JavaScript code

## Overview[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#overview "Direct link to Overview")
...
Identifying and fixing race conditions can be challenging as they can occur unexpectedly. It requires a thorough understanding of potential event flows and often involves using advanced debugging and testing tools. To address this issue, fast-check includes a set of built-in tools specifically designed to help in detecting race conditions. The [`scheduler`](https://fast-check.dev/docs/core-blocks/arbitraries/others/#scheduler) arbitrary has been specifically designed for detecting and testing race conditions, making it an ideal tool for addressing these challenges in your testing process.

## The scheduler instance[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#the-scheduler-instance "Direct link to The scheduler instance")

The [`scheduler`](https://fast-check.dev/docs/core-blocks/arbitraries/others/#scheduler) arbitrary is able to generate instances of [`Scheduler`](https://fast-check.dev/api-reference/interfaces/Scheduler.html). They come with following interface:
...
## Scheduling methods[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#scheduling-methods "Direct link to Scheduling methods")

### schedule[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#schedule "Direct link to schedule")

Create a scheduled `Promise` based on an existing one — *aka. wrapped `Promise`*.
...
### scheduleFunction[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#schedulefunction "Direct link to scheduleFunction")
...
### scheduleSequence[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#schedulesequence "Direct link to scheduleSequence")
...
## Advanced recipes[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#advanced-recipes "Direct link to Advanced recipes")

### Scheduling a function call[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#scheduling-a-function-call "Direct link to Scheduling a function call")
...
### Scheduling a call to a mocked server[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#scheduling-a-call-to-a-mocked-server "Direct link to Scheduling a call to a mocked server")
...
### Wrapping calls automatically using `act`[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#wrapping-calls-automatically-using-act "Direct link to wrapping-calls-automatically-using-act")

[`scheduler`](https://fast-check.dev/docs/core-blocks/arbitraries/others/#scheduler) can be given an `act` function that will be called in order to wrap all the scheduled tasks. A code like the following one:
...
### Scheduling native timers[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#scheduling-native-timers "Direct link to Scheduling native timers")
...
## Model based testing and race conditions[​](https://fast-check.dev/docs/advanced/race-conditions/index.html#model-based-testing-and-race-conditions "Direct link to Model based testing and race conditions")
...
Model based testing](https://fast-check.dev/docs/advanced/model-based-testing/index.html)[Next

Tutorials](https://fast-check.dev/docs/tutorials/)

* [Overview](https://fast-check.dev/docs/advanced/race-conditions/index.html#overview)* [The scheduler instance](https://fast-check.dev/docs/advanced/race-conditions/index.html#the-scheduler-instance)* [Scheduling methods](https://fast-check.dev/docs/advanced/race-conditions/index.html#scheduling-methods)
      + [schedule](https://fast-check.dev/docs/advanced/race-conditions/index.html#schedule)+ [scheduleFunction](https://fast-check.dev/docs/advanced/race-conditions/index.html#schedulefunction)+ [scheduleSequence](https://fast-check.dev/docs/advanced/race-conditions/index.html#schedulesequence)* [Advanced recipes](https://fast-check.dev/docs/advanced/race-conditions/index.html#advanced-recipes)
        + [Scheduling a function call](https://fast-check.dev/docs/advanced/race-conditions/index.html#scheduling-a-function-call)+ [Scheduling a call to a mocked server](https://fast-check.dev/docs/advanced/race-conditions/index.html#scheduling-a-call-to-a-mocked-server)+ [Wrapping calls automatically using `act`](https://fast-check.dev/docs/advanced/race-conditions/index.html#wrapping-calls-automatically-using-act)+ [Scheduling native timers](https://fast-check.dev/docs/advanced/race-conditions/index.html#scheduling-native-timers)* [Model based testing and race conditions](https://fast-check.dev/docs/advanced/race-conditions/index.html#model-based-testing-and-race-conditions)
