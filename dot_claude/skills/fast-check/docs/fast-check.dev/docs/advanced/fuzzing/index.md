---
title: "Fuzzing | fast-check"
source_url: "https://fast-check.dev/docs/advanced/fuzzing/index"
fetched_at: "2025-12-29T00:50:11.704609+00:00"
---



* * [Advanced](https://fast-check.dev/docs/advanced/index.html)* Fuzzing

On this page

Turn fast-check into a fuzzer

## From Property-Based to Fuzzing[​](https://fast-check.dev/docs/advanced/fuzzing/index.html#from-property-based-to-fuzzing "Direct link to From Property-Based to Fuzzing")
...
## Basic setup[​](https://fast-check.dev/docs/advanced/fuzzing/index.html#basic-setup "Direct link to Basic setup")
...
## Advanced setup[​](https://fast-check.dev/docs/advanced/fuzzing/index.html#advanced-setup "Direct link to Advanced setup")
...
### Never failing predicates[​](https://fast-check.dev/docs/advanced/fuzzing/index.html#never-failing-predicates "Direct link to Never failing predicates")
...
### Fuzzing usage[​](https://fast-check.dev/docs/advanced/fuzzing/index.html#fuzzing-usage "Direct link to Fuzzing usage")
...
### Replay usage[​](https://fast-check.dev/docs/advanced/fuzzing/index.html#replay-usage "Direct link to Replay usage")
...
Fake data](https://fast-check.dev/docs/advanced/fake-data/index.html)[Next

Model based testing](https://fast-check.dev/docs/advanced/model-based-testing/index.html)

* [From Property-Based to Fuzzing](https://fast-check.dev/docs/advanced/fuzzing/index.html#from-property-based-to-fuzzing)* [Basic setup](https://fast-check.dev/docs/advanced/fuzzing/index.html#basic-setup)* [Advanced setup](https://fast-check.dev/docs/advanced/fuzzing/index.html#advanced-setup)
      + [Never failing predicates](https://fast-check.dev/docs/advanced/fuzzing/index.html#never-failing-predicates)+ [Fuzzing usage](https://fast-check.dev/docs/advanced/fuzzing/index.html#fuzzing-usage)+ [Replay usage](https://fast-check.dev/docs/advanced/fuzzing/index.html#replay-usage)
