---
title: "Property Based Testing with Jest | fast-check"
source_url: "https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index"
fetched_at: "2025-12-29T00:50:44.267866+00:00"
---



* * [Tutorials](https://fast-check.dev/docs/tutorials/index.html)* [Setting up your Test Environment](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/index.html)* With Jest
...
## Setup with our connector[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#setup-with-our-connector "Direct link to Setup with our connector")
...
### Basic setup[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#basic-setup "Direct link to Basic setup")
...
```
yarn add --dev fast-check @fast-check/jest
```

```
pnpm add --save-dev fast-check @fast-check/jest
```

```
bun add --dev fast-check @fast-check/jest
```

Congratulations, everything is ready to start plugging some Property-Based Tests within Jest 🚀

### Your first test[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#your-first-test "Direct link to Your first test")
...
### Your first asynchronous test[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#your-first-asynchronous-test "Direct link to Your first asynchronous test")
...
Difference with synchronous predicate
...
### Going further[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#going-further "Direct link to Going further")
...
## Manual setup[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#manual-setup "Direct link to Manual setup")
...
### Basic setup[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#basic-setup-1 "Direct link to Basic setup")
...
### Recommended setup[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#recommended-setup "Direct link to Recommended setup")
...
### Your first test[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#your-first-test-1 "Direct link to Your first test")
...
### Your first asynchronous test[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#your-first-asynchronous-test-1 "Direct link to Your first asynchronous test")
...
### Going further[​](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#going-further-1 "Direct link to Going further")

Now that you have a solid foundation, it's time to delve deeper into the world of property-based testing. Our official documentation covers a range of advanced topics, from [generating custom values](https://fast-check.dev/docs/core-blocks/arbitraries/) tailored to your specific needs to exploring [advanced patterns](https://fast-check.dev/docs/advanced/).
...
Setting up your Test Environment](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/index.html)[Next

With Bun test runner](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-bun-test-runner/index.html)

* [Setup with our connector](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#setup-with-our-connector)
  + [Basic setup](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#basic-setup)+ [Your first test](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#your-first-test)+ [Your first asynchronous test](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#your-first-asynchronous-test)+ [Going further](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#going-further)* [Manual setup](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#manual-setup)
    + [Basic setup](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#basic-setup-1)+ [Recommended setup](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#recommended-setup)+ [Your first test](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#your-first-test-1)+ [Your first asynchronous test](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#your-first-asynchronous-test-1)+ [Going further](https://fast-check.dev/docs/tutorials/setting-up-your-test-environment/property-based-testing-with-jest/index.html#going-further-1)
