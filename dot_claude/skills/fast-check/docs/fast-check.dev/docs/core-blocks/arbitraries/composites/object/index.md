---
title: "Object | fast-check"
source_url: "https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index"
fetched_at: "2025-12-29T00:47:28.315028+00:00"
---



* * [Core Blocks](https://fast-check.dev/docs/core-blocks/index.html)* [Arbitraries](https://fast-check.dev/docs/core-blocks/arbitraries/index.html)* [Composites](https://fast-check.dev/docs/core-blocks/arbitraries/composites/index.html)* Object

On this page

Generate object values.

## dictionary[​](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#dictionary "Direct link to dictionary")
...
* `maxKeys?` — default: `0x7fffffff` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#size-explained) — *maximal number of keys in the generated instances (included)*
...
## set[​](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#set "Direct link to set")
...
* `minLength?` — default: `0` — *minimal size (included)*
* `maxLength?` — default: `0x7fffffff` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#size-explained) — *maximal size (included)*
* `size?` — default: `undefined` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#size-explained) — *how large should the generated values be?*
* `depthIdentifier?` — default: `undefined` — *when specified, the set will impact the depth attached to the identifier to avoid going too deep if it already generated lots of items for current level*
...
## map[​](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#map "Direct link to map")
...
* `keyArb` — *arbitrary instance responsible to generate keys*
* `valueArb` — *arbitrary instance responsible to generate values*
* `minKeys?` — default: `0` — *minimal number of entries in the generated instances (included)*
* `maxKeys?` — default: `0x7fffffff` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#size-explained) — *maximal number of entries in the generated instances (included)*
* `size?` — default: `undefined` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#size-explained) — *how large should the generated values be?*
* `depthIdentifier?` — default: `undefined` — *share the depth between instances using the same `depthIdentifier`*
...
## record[​](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#record "Direct link to record")
...
## object[​](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#object-1 "Direct link to object")
...
* `maxKeys?` — default: `0x7fffffff` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#size-explained) — *maximal number of keys in generated objects (Map and Set included into objects)*
* `size?` — default: `undefined` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#size-explained) — *how large should the generated values be?*
...
## anything[​](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#anything "Direct link to anything")
...
Iterable](https://fast-check.dev/docs/core-blocks/arbitraries/composites/iterable/index.html)[Next

Typed Array](https://fast-check.dev/docs/core-blocks/arbitraries/composites/typed-array/index.html)

* [dictionary](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#dictionary)* [set](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#set)* [map](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#map)* [record](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#record)* [object](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#object-1)* [anything](https://fast-check.dev/docs/core-blocks/arbitraries/composites/object/index.html#anything)
