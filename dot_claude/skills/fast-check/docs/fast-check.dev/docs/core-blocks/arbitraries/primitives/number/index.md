---
title: "Number | fast-check"
source_url: "https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index"
fetched_at: "2025-12-29T00:47:28.315028+00:00"
---



* * [Core Blocks](https://fast-check.dev/docs/core-blocks/index.html)* [Arbitraries](https://fast-check.dev/docs/core-blocks/arbitraries/index.html)* [Primitives](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/index.html)* Number

On this page

Generate numeric values.

## integer[​](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#integer "Direct link to integer")
...
## nat[​](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#nat "Direct link to nat")
...
## maxSafeInteger[​](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#maxsafeinteger "Direct link to maxSafeInteger")
...
## maxSafeNat[​](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#maxsafenat "Direct link to maxSafeNat")
...
## float[​](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#float "Direct link to float")
...
## double[​](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#double "Direct link to double")
...
Date](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/date/index.html)[Next

String](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/string/index.html)

* [integer](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#integer)* [nat](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#nat)* [maxSafeInteger](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#maxsafeinteger)* [maxSafeNat](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#maxsafenat)* [float](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#float)* [double](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html#double)
