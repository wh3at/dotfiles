---
title: "Internet | fast-check"
source_url: "https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index"
fetched_at: "2025-12-29T00:47:28.315028+00:00"
---



* * [Core Blocks](https://fast-check.dev/docs/core-blocks/index.html)* [Arbitraries](https://fast-check.dev/docs/core-blocks/arbitraries/index.html)* [Fake Data](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/index.html)* Internet

On this page

Generate internet related values.

### ipV4[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#ipv4 "Direct link to ipV4")
...
### ipV4Extended[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#ipv4extended "Direct link to ipV4Extended")
...
### ipV6[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#ipv6 "Direct link to ipV6")
...
### domain[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#domain "Direct link to domain")
...
### webAuthority[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#webauthority "Direct link to webAuthority")
...
### webFragments[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#webfragments "Direct link to webFragments")
...
### webPath[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#webpath "Direct link to webPath")
...
### webQueryParameters[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#webqueryparameters "Direct link to webQueryParameters")
...
### webSegment[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#websegment "Direct link to webSegment")
...
### webUrl[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#weburl "Direct link to webUrl")
...
* `authoritySettings?` — default: `{}` — *[constraints](https://fast-check.dev/api-reference/interfaces/WebAuthorityConstraints.html) on the web authority*
...
### emailAddress[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#emailaddress "Direct link to emailAddress")
...
Identifier](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/identifier/index.html)[Next

Others](https://fast-check.dev/docs/core-blocks/arbitraries/others/index.html)

* [ipV4](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#ipv4)* [ipV4Extended](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#ipv4extended)* [ipV6](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#ipv6)* [domain](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#domain)* [webAuthority](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#webauthority)* [webFragments](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#webfragments)* [webPath](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#webpath)* [webQueryParameters](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#webqueryparameters)* [webSegment](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#websegment)* [webUrl](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#weburl)* [emailAddress](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/internet/index.html#emailaddress)
