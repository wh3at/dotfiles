---
title: "Any | fast-check"
source_url: "https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index"
fetched_at: "2025-12-29T00:47:28.315028+00:00"
---



* * [Core Blocks](https://fast-check.dev/docs/core-blocks/index.html)* [Arbitraries](https://fast-check.dev/docs/core-blocks/arbitraries/index.html)* [Combiners](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/index.html)* Any

On this page

Combine and enhance any existing arbitraries.

## option[​](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#option "Direct link to option")
...
* `depthSize?` — default: `undefined` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#depth-size-explained) — *how much we allow our recursive structures to be deep? The chance to select the nil value will increase as we go deeper in the structure*
...
## oneof[​](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#oneof "Direct link to oneof")
...
* `depthSize?` — default: `undefined` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#depth-size-explained) — *how much we allow our recursive structures to be deep? The chance to select the first specified arbitrary will increase as we go deeper in the structure*
* `depthIdentifier?` — default: `undefined` — *share the depth between instances using the same `depthIdentifier`*
...
## clone[​](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#clone "Direct link to clone")
...
## noBias[​](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#nobias "Direct link to noBias")
...
## noShrink[​](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#noshrink "Direct link to noShrink")
...
## limitShrink[​](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#limitshrink "Direct link to limitShrink")
...
## .filter[​](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#filter "Direct link to .filter")
...
## .map[​](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#map "Direct link to .map")
...
## .chain[​](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#chain "Direct link to .chain")
...
Combiners](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/index.html)[Next

Constant](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/constant/index.html)

* [option](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#option)* [oneof](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#oneof)* [clone](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#clone)* [noBias](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#nobias)* [noShrink](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#noshrink)* [limitShrink](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#limitshrink)* [.filter](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#filter)* [.map](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#map)* [.chain](https://fast-check.dev/docs/core-blocks/arbitraries/combiners/any/index.html#chain)
