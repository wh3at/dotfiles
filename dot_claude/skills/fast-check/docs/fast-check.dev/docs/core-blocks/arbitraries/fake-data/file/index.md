---
title: "File | fast-check"
source_url: "https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/file/index"
fetched_at: "2025-12-29T00:47:28.315028+00:00"
---



* * [Core Blocks](https://fast-check.dev/docs/core-blocks/index.html)* [Arbitraries](https://fast-check.dev/docs/core-blocks/arbitraries/index.html)* [Fake Data](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/index.html)* File

On this page

Generate file content values.

## base64String[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/file/index.html#base64string "Direct link to base64String")
...
* `maxLength?` — default: `0x7fffffff` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#size-explained) — *maximal number of characters (included if multiple of 4)*
...
## json[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/file/index.html#json "Direct link to json")
...
* `depthSize?` — default: `undefined` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#depth-size-explained) — *how much we allow our recursive structures to be deep?*
...
## jsonValue[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/file/index.html#jsonvalue "Direct link to jsonValue")
...
## lorem[​](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/file/index.html#lorem "Direct link to lorem")
...
* `maxCount?` — default: `0x7fffffff` [more](https://fast-check.dev/docs/configuration/larger-entries-by-default/#size-explained) — if `mode` is `"words"`: lorem ipsum sentence containing at most `maxCount` sentences, otherwise: containing at most `maxCount` words\_
...
Fake Data](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/index.html)[Next

Identifier](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/identifier/index.html)

* [base64String](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/file/index.html#base64string)* [json](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/file/index.html#json)* [jsonValue](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/file/index.html#jsonvalue)* [lorem](https://fast-check.dev/docs/core-blocks/arbitraries/fake-data/file/index.html#lorem)
