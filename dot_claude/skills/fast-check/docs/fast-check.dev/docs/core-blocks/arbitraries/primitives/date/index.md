---
title: "Date | fast-check"
source_url: "https://fast-check.dev/docs/core-blocks/arbitraries/primitives/date/index"
fetched_at: "2025-12-29T00:47:28.315028+00:00"
---



* * [Core Blocks](https://fast-check.dev/docs/core-blocks/index.html)* [Arbitraries](https://fast-check.dev/docs/core-blocks/arbitraries/index.html)* [Primitives](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/index.html)* Date

On this page

Generate date values.

## date[​](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/date/index.html#date-1 "Direct link to date")
...
Boolean](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/boolean/index.html)[Next

Number](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/number/index.html)

* [date](https://fast-check.dev/docs/core-blocks/arbitraries/primitives/date/index.html#date-1)
