---
title: "Runners | fast-check"
source_url: "https://fast-check.dev/docs/core-blocks/runners/index"
fetched_at: "2025-12-29T00:47:28.315028+00:00"
---



* * [Core Blocks](https://fast-check.dev/docs/core-blocks/index.html)* Runners

On this page

Execute your properties.

## assert[​](https://fast-check.dev/docs/core-blocks/runners/index.html#assert "Direct link to assert")
...
## check[​](https://fast-check.dev/docs/core-blocks/runners/index.html#check "Direct link to check")
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Reasons `failed` `interrupted` `counterexample`/`counterexamplePath`/`error`|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | failure of the predicate `true` `true`/`false` *not null*| too many pre-conditions failures `true` `false` `null`| execution took too long given `interruptAfterTimeLimit` `true` `true` `null`| successful run `false` `true`/`false` `null` | | | | | | | | | | | | | | | | | | | |
...
## sample[​](https://fast-check.dev/docs/core-blocks/runners/index.html#sample "Direct link to sample")
...
## statistics[​](https://fast-check.dev/docs/core-blocks/runners/index.html#statistics "Direct link to statistics")
...
Properties](https://fast-check.dev/docs/core-blocks/properties/index.html)[Next

Configuration](https://fast-check.dev/docs/configuration/)

* [assert](https://fast-check.dev/docs/core-blocks/runners/index.html#assert)* [check](https://fast-check.dev/docs/core-blocks/runners/index.html#check)* [sample](https://fast-check.dev/docs/core-blocks/runners/index.html#sample)* [statistics](https://fast-check.dev/docs/core-blocks/runners/index.html#statistics)
