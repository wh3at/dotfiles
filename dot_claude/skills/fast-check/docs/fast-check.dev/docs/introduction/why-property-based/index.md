---
title: "Why Property-Based? | fast-check"
source_url: "https://fast-check.dev/docs/introduction/why-property-based/index"
fetched_at: "2025-12-29T00:45:52.267108+00:00"
---



* * [Introduction](https://fast-check.dev/docs/introduction/index.html)* Why Property-Based?

On this page

Learn about the benefits and advantages of property-based testing

## Testing today[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#testing-today "Direct link to Testing today")
...
### Unit, Integration and E2E[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#unit-integration-and-e2e "Direct link to Unit, Integration and E2E")
...
### Limitations[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#limitations "Direct link to Limitations")
...
## Property-based[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#property-based "Direct link to Property-based")

What makes our current tests so inflexible is how strictly tied they are to specific values.

### Random[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#random "Direct link to Random")
...
### Reproducible[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#reproducible "Direct link to Reproducible")
...
### Designed for bugs[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#designed-for-bugs "Direct link to Designed for bugs")
...
### Designed for users[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#designed-for-users "Direct link to Designed for users")
...
### Document the code[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#document-the-code "Direct link to Document the code")
...
## Testing tomorrow[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#testing-tomorrow "Direct link to Testing tomorrow")
...
## Alternatives[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#alternatives "Direct link to Alternatives")

When it comes to random, several alternatives are available. But they are probably less tailored for tests.

### Fake data[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#fake-data "Direct link to Fake data")
...
### Fuzzing[​](https://fast-check.dev/docs/introduction/why-property-based/index.html#fuzzing "Direct link to Fuzzing")
...
Getting Started](https://fast-check.dev/docs/introduction/getting-started/index.html)[Next

Track Record](https://fast-check.dev/docs/introduction/track-record/index.html)

* [Testing today](https://fast-check.dev/docs/introduction/why-property-based/index.html#testing-today)
  + [Unit, Integration and E2E](https://fast-check.dev/docs/introduction/why-property-based/index.html#unit-integration-and-e2e)+ [Limitations](https://fast-check.dev/docs/introduction/why-property-based/index.html#limitations)* [Property-based](https://fast-check.dev/docs/introduction/why-property-based/index.html#property-based)
    + [Random](https://fast-check.dev/docs/introduction/why-property-based/index.html#random)+ [Reproducible](https://fast-check.dev/docs/introduction/why-property-based/index.html#reproducible)+ [Designed for bugs](https://fast-check.dev/docs/introduction/why-property-based/index.html#designed-for-bugs)+ [Designed for users](https://fast-check.dev/docs/introduction/why-property-based/index.html#designed-for-users)+ [Document the code](https://fast-check.dev/docs/introduction/why-property-based/index.html#document-the-code)* [Testing tomorrow](https://fast-check.dev/docs/introduction/why-property-based/index.html#testing-tomorrow)* [Alternatives](https://fast-check.dev/docs/introduction/why-property-based/index.html#alternatives)
        + [Fake data](https://fast-check.dev/docs/introduction/why-property-based/index.html#fake-data)+ [Fuzzing](https://fast-check.dev/docs/introduction/why-property-based/index.html#fuzzing)
