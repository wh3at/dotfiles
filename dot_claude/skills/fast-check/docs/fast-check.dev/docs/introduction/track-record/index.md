---
title: "Track Record | fast-check"
source_url: "https://fast-check.dev/docs/introduction/track-record/index"
fetched_at: "2025-12-29T00:45:52.267108+00:00"
---



* * [Introduction](https://fast-check.dev/docs/introduction/index.html)* Track Record

On this page

Some examples of key projects with bugs detected by fast-check

## Summary[​](https://fast-check.dev/docs/introduction/track-record/index.html#summary "Direct link to Summary")
...
## Detailed examples[​](https://fast-check.dev/docs/introduction/track-record/index.html#detailed-examples "Direct link to Detailed examples")

### `trekhleb/javascript-algorithms`[​](https://fast-check.dev/docs/introduction/track-record/index.html#trekhlebjavascript-algorithms "Direct link to trekhlebjavascript-algorithms")
...
### `jestjs/jest`[​](https://fast-check.dev/docs/introduction/track-record/index.html#jestjsjest "Direct link to jestjsjest")
...
### `nodeca/js-yaml`[​](https://fast-check.dev/docs/introduction/track-record/index.html#nodecajs-yaml "Direct link to nodecajs-yaml")
...
### `sindresorhus/query-string`[​](https://fast-check.dev/docs/introduction/track-record/index.html#sindresorhusquery-string "Direct link to sindresorhusquery-string")
...
### `stevemao/left-pad`[​](https://fast-check.dev/docs/introduction/track-record/index.html#stevemaoleft-pad "Direct link to stevemaoleft-pad")
...
### `eemeli/yaml`[​](https://fast-check.dev/docs/introduction/track-record/index.html#eemeliyaml "Direct link to eemeliyaml")
...
### `blakeembrey/javascript-stringify`[​](https://fast-check.dev/docs/introduction/track-record/index.html#blakeembreyjavascript-stringify "Direct link to blakeembreyjavascript-stringify")
...
### `auth0/node-jsonwebtoken`[​](https://fast-check.dev/docs/introduction/track-record/index.html#auth0node-jsonwebtoken "Direct link to auth0node-jsonwebtoken")
...
Why Property-Based?](https://fast-check.dev/docs/introduction/why-property-based/index.html)[Next

Core Blocks](https://fast-check.dev/docs/core-blocks/)

* [Summary](https://fast-check.dev/docs/introduction/track-record/index.html#summary)* [Detailed examples](https://fast-check.dev/docs/introduction/track-record/index.html#detailed-examples)
    + [`trekhleb/javascript-algorithms`](https://fast-check.dev/docs/introduction/track-record/index.html#trekhlebjavascript-algorithms)+ [`jestjs/jest`](https://fast-check.dev/docs/introduction/track-record/index.html#jestjsjest)+ [`nodeca/js-yaml`](https://fast-check.dev/docs/introduction/track-record/index.html#nodecajs-yaml)+ [`sindresorhus/query-string`](https://fast-check.dev/docs/introduction/track-record/index.html#sindresorhusquery-string)+ [`stevemao/left-pad`](https://fast-check.dev/docs/introduction/track-record/index.html#stevemaoleft-pad)+ [`eemeli/yaml`](https://fast-check.dev/docs/introduction/track-record/index.html#eemeliyaml)+ [`blakeembrey/javascript-stringify`](https://fast-check.dev/docs/introduction/track-record/index.html#blakeembreyjavascript-stringify)+ [`auth0/node-jsonwebtoken`](https://fast-check.dev/docs/introduction/track-record/index.html#auth0node-jsonwebtoken)
