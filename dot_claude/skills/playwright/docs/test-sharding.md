---
title: "Sharding | Playwright"
source_url: "https://playwright.dev/docs/test-sharding"
...
## Sharding tests between multiple machines[​](https://playwright.dev/docs/test-sharding.html#sharding-tests-between-multiple-machines "Direct link to Sharding tests between multiple machines")
...
Note that Playwright can only shard tests that can be run in parallel. By default, this means Playwright will shard test files. Learn about other options in the [parallelism guide](https://playwright.dev/docs/test-parallel.html).

## Balancing Shards[​](https://playwright.dev/docs/test-sharding.html#balancing-shards "Direct link to Balancing Shards")

Sharding can be done at two levels of granularity depending on whether you use the [testProject.fullyParallel](https://playwright.dev/docs/api/class-testproject.html#test-project-fully-parallel) option or not. This affects how the tests are balanced across the shards.
...
## Merging reports from multiple shards[​](https://playwright.dev/docs/test-sharding.html#merging-reports-from-multiple-shards "Direct link to Merging reports from multiple shards")
...
## GitHub Actions example[​](https://playwright.dev/docs/test-sharding.html#github-actions-example "Direct link to GitHub Actions example")
...
## Merging reports from multiple environments[​](https://playwright.dev/docs/test-sharding.html#merging-reports-from-multiple-environments "Direct link to Merging reports from multiple environments")
...
In this case, it is useful to specify the [testConfig.tag](https://playwright.dev/docs/api/class-testconfig.html#test-config-tag) property, to tag all tests with the environment name. This tag will be automatically picked up by the blob report and later on by the merge tool.
...
## Merge-reports CLI[​](https://playwright.dev/docs/test-sharding.html#merge-reports-cli "Direct link to Merge-reports CLI")
...
Retries](https://playwright.dev/docs/test-retries.html)[Next

Timeouts](https://playwright.dev/docs/test-timeouts.html)

* [Introduction](https://playwright.dev/docs/test-sharding.html#introduction)* [Sharding tests between multiple machines](https://playwright.dev/docs/test-sharding.html#sharding-tests-between-multiple-machines)* [Balancing Shards](https://playwright.dev/docs/test-sharding.html#balancing-shards)* [Merging reports from multiple shards](https://playwright.dev/docs/test-sharding.html#merging-reports-from-multiple-shards)* [GitHub Actions example](https://playwright.dev/docs/test-sharding.html#github-actions-example)* [Merging reports from multiple environments](https://playwright.dev/docs/test-sharding.html#merging-reports-from-multiple-environments)* [Merge-reports CLI](https://playwright.dev/docs/test-sharding.html#merge-reports-cli)
