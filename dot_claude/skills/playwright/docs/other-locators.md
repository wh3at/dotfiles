...
source_url: "https://playwright.dev/docs/other-locators"
fetched_at: "2025-12-11T07:41:52.267880+00:00"
---



* * Guides* Other locators

On this page

## Introduction[​](https://playwright.dev/docs/other-locators.html#introduction "Direct link to Introduction")

note

Check out the main [locators guide](https://playwright.dev/docs/locators.html) for most common and recommended locators.

In addition to recommended locators like [page.getByRole()](https://playwright.dev/docs/api/class-page.html#page-get-by-role) and [page.getByText()](https://playwright.dev/docs/api/class-page.html#page-get-by-text), Playwright supports a variety of other locators described in this guide.

## CSS locator[​](https://playwright.dev/docs/other-locators.html#css-locator "Direct link to CSS locator")

note

We recommend prioritizing [user-visible locators](https://playwright.dev/docs/locators.html#quick-guide) like text or accessible role instead of using CSS that is tied to the implementation and could break when the page changes.
...
### CSS: matching by text[​](https://playwright.dev/docs/other-locators.html#css-matching-by-text "Direct link to CSS: matching by text")
...
### CSS: matching only visible elements[​](https://playwright.dev/docs/other-locators.html#css-matching-only-visible-elements "Direct link to CSS: matching only visible elements")
...
### CSS: elements that contain other elements[​](https://playwright.dev/docs/other-locators.html#css-elements-that-contain-other-elements "Direct link to CSS: elements that contain other elements")
...
### CSS: elements matching one of the conditions[​](https://playwright.dev/docs/other-locators.html#css-elements-matching-one-of-the-conditions "Direct link to CSS: elements matching one of the conditions")
...
### CSS: matching elements based on layout[​](https://playwright.dev/docs/other-locators.html#css-matching-elements-based-on-layout "Direct link to CSS: matching elements based on layout")
...
We recommend prioritizing [user-visible locators](https://playwright.dev/docs/locators.html#quick-guide) instead.
...
Note that resulting matches are sorted by their distance to the anchor element, so you can use [locator.first()](https://playwright.dev/docs/api/class-locator.html#locator-first) to pick the closest one. This is only useful if you have something like a list of similar elements, where the closest is obviously the right one. However, using [locator.first()](https://playwright.dev/docs/api/class-locator.html#locator-first) in other cases most likely won't work as expected - it will not target the element you are searching for, but some other element that happens to be the closest like a random empty `<div>`, or an element that is scrolled out and is not currently visible.
...
### CSS: pick n-th match from the query result[​](https://playwright.dev/docs/other-locators.html#css-pick-n-th-match-from-the-query-result "Direct link to CSS: pick n-th match from the query result")
...
`:nth-match()` is also useful to wait until a specified number of elements appear, using [locator.waitFor()](https://playwright.dev/docs/api/class-locator.html#locator-wait-for).
...
## N-th element locator[​](https://playwright.dev/docs/other-locators.html#n-th-element-locator "Direct link to N-th element locator")
...
## Parent element locator[​](https://playwright.dev/docs/other-locators.html#parent-element-locator "Direct link to Parent element locator")

When you need to target a parent element of some other element, most of the time you should [locator.filter()](https://playwright.dev/docs/api/class-locator.html#locator-filter) by the child locator. For example, consider the following DOM structure:
...
If you'd like to target the parent `<li>` of a label with text `"Hello"`, using [locator.filter()](https://playwright.dev/docs/api/class-locator.html#locator-filter) works best:
...
Alternatively, if you cannot find a suitable locator for the parent element, use `xpath=..`. Note that this method is not as reliable, because any changes to the DOM structure will break your tests. Prefer [locator.filter()](https://playwright.dev/docs/api/class-locator.html#locator-filter) when possible.

```
const parent = page.getByText('Hello').locator('xpath=..');
```

## React locator[​](https://playwright.dev/docs/other-locators.html#react-locator "Direct link to React locator")
...
## Vue locator[​](https://playwright.dev/docs/other-locators.html#vue-locator "Direct link to Vue locator")
...
## XPath locator[​](https://playwright.dev/docs/other-locators.html#xpath-locator "Direct link to XPath locator")

warning

We recommend prioritizing [user-visible locators](https://playwright.dev/docs/locators.html#quick-guide) like text or accessible role instead of using XPath that is tied to the implementation and easily break when the page changes.
...
### XPath union[​](https://playwright.dev/docs/other-locators.html#xpath-union "Direct link to XPath union")
...
## Label to form control retargeting[​](https://playwright.dev/docs/other-locators.html#label-to-form-control-retargeting "Direct link to Label to form control retargeting")

warning

We recommend [locating by label text](https://playwright.dev/docs/locators.html#locate-by-label) instead of relying to label-to-control retargeting.
...
For example, consider the following DOM structure: `<label for="password">Password:</label><input id="password" type="password">`. You can target the label by its "Password" text using [page.getByText()](https://playwright.dev/docs/api/class-page.html#page-get-by-text). However, the following actions will be performed on the input instead of the label:

* [locator.click()](https://playwright.dev/docs/api/class-locator.html#locator-click) will click the label and automatically focus the input field;
* [locator.fill()](https://playwright.dev/docs/api/class-locator.html#locator-fill) will fill the input field;
* [locator.inputValue()](https://playwright.dev/docs/api/class-locator.html#locator-input-value) will return the value of the input field;
* [locator.selectText()](https://playwright.dev/docs/api/class-locator.html#locator-select-text) will select text in the input field;
* [locator.setInputFiles()](https://playwright.dev/docs/api/class-locator.html#locator-set-input-files) will set files for the input field with `type=file`;
* [locator.selectOption()](https://playwright.dev/docs/api/class-locator.html#locator-select-option) will select an option from the select box.
...
However, other methods will target the label itself, for example [expect(locator).toHaveText()](https://playwright.dev/docs/api/class-locatorassertions.html#locator-assertions-to-have-text) will assert the text content of the label, not the input field.
...
## Legacy text locator[​](https://playwright.dev/docs/other-locators.html#legacy-text-locator "Direct link to Legacy text locator")

warning

We recommend the modern [text locator](https://playwright.dev/docs/locators.html#get-by-text) instead.
...
## id, data-testid, data-test-id, data-test selectors[​](https://playwright.dev/docs/other-locators.html#id-data-testid-data-test-id-data-test-selectors "Direct link to id, data-testid, data-test-id, data-test selectors")

warning

We recommend [locating by test id](https://playwright.dev/docs/locators.html#locate-by-test-id) instead.
...
Attribute selectors are not CSS selectors, so anything CSS-specific like `:enabled` is not supported. For more features, use a proper [css](https://playwright.dev/docs/other-locators.html#css-locator) selector, e.g. `css=[data-test="login"]:enabled`.

## Chaining selectors[​](https://playwright.dev/docs/other-locators.html#chaining-selectors "Direct link to Chaining selectors")

warning

We recommend [chaining locators](https://playwright.dev/docs/locators.html#matching-inside-a-locator) instead.
...
### Intermediate matches[​](https://playwright.dev/docs/other-locators.html#intermediate-matches "Direct link to Intermediate matches")

warning

We recommend [filtering by another locator](https://playwright.dev/docs/locators.html#filter-by-childdescendant) to locate elements that contain other elements.
...
Network](https://playwright.dev/docs/network.html)[Next

Pages](https://playwright.dev/docs/pages.html)

* [Introduction](https://playwright.dev/docs/other-locators.html#introduction)* [CSS locator](https://playwright.dev/docs/other-locators.html#css-locator)
    + [CSS: matching by text](https://playwright.dev/docs/other-locators.html#css-matching-by-text)+ [CSS: matching only visible elements](https://playwright.dev/docs/other-locators.html#css-matching-only-visible-elements)+ [CSS: elements that contain other elements](https://playwright.dev/docs/other-locators.html#css-elements-that-contain-other-elements)+ [CSS: elements matching one of the conditions](https://playwright.dev/docs/other-locators.html#css-elements-matching-one-of-the-conditions)+ [CSS: matching elements based on layout](https://playwright.dev/docs/other-locators.html#css-matching-elements-based-on-layout)+ [CSS: pick n-th match from the query result](https://playwright.dev/docs/other-locators.html#css-pick-n-th-match-from-the-query-result)* [N-th element locator](https://playwright.dev/docs/other-locators.html#n-th-element-locator)* [Parent element locator](https://playwright.dev/docs/other-locators.html#parent-element-locator)* [React locator](https://playwright.dev/docs/other-locators.html#react-locator)* [Vue locator](https://playwright.dev/docs/other-locators.html#vue-locator)* [XPath locator](https://playwright.dev/docs/other-locators.html#xpath-locator)
              + [XPath union](https://playwright.dev/docs/other-locators.html#xpath-union)* [Label to form control retargeting](https://playwright.dev/docs/other-locators.html#label-to-form-control-retargeting)* [Legacy text locator](https://playwright.dev/docs/other-locators.html#legacy-text-locator)* [id, data-testid, data-test-id, data-test selectors](https://playwright.dev/docs/other-locators.html#id-data-testid-data-test-id-data-test-selectors)* [Chaining selectors](https://playwright.dev/docs/other-locators.html#chaining-selectors)
                      + [Intermediate matches](https://playwright.dev/docs/other-locators.html#intermediate-matches)
