...
* * Guides* Test generator

On this page

## Introduction[​](https://playwright.dev/docs/codegen.html#introduction "Direct link to Introduction")

Playwright comes with the ability to generate tests for you as you perform actions in the browser and is a great way to quickly get started with testing. Playwright will look at your page and figure out the best locator, prioritizing [role, text and test id locators](https://playwright.dev/docs/locators.html). If the generator finds multiple elements matching the locator, it will improve the locator to make it resilient that uniquely identify the target element.

## Generate tests in VS Code[​](https://playwright.dev/docs/codegen.html#generate-tests-in-vs-code "Direct link to Generate tests in VS Code")

Install the VS Code extension and generate tests directly from VS Code. The extension is available on the [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=ms-playwright.playwright). Check out our guide on [getting started with VS Code](https://playwright.dev/docs/getting-started-vscode.html).

### Record a New Test[​](https://playwright.dev/docs/codegen.html#record-a-new-test "Direct link to Record a New Test")
...
### Record at Cursor[​](https://playwright.dev/docs/codegen.html#record-at-cursor "Direct link to Record at Cursor")
...
### Generating locators[​](https://playwright.dev/docs/codegen.html#generating-locators "Direct link to Generating locators")

You can generate locators with the test generator.

* Click on the **Pick locator** button from the testing sidebar and then hover over elements in the browser window to see the [locator](https://playwright.dev/docs/locators.html) highlighted underneath each element.
...
## Generate tests with the Playwright Inspector[​](https://playwright.dev/docs/codegen.html#generate-tests-with-the-playwright-inspector "Direct link to Generate tests with the Playwright Inspector")
...
### Running Codegen[​](https://playwright.dev/docs/codegen.html#running-codegen "Direct link to Running Codegen")
...
### Recording a test[​](https://playwright.dev/docs/codegen.html#recording-a-test "Direct link to Recording a test")
...
###### [​](https://playwright.dev/docs/codegen.html#-1 "Direct link to -1")

When you have finished interacting with the page, press the **record** button to stop the recording and use the **copy** button to copy the generated code to your editor.

Use the **clear** button to clear the code to start recording again. Once finished, close the Playwright inspector window or stop the terminal command.

### Generating locators[​](https://playwright.dev/docs/codegen.html#generating-locators-1 "Direct link to Generating locators")
...
###### [​](https://playwright.dev/docs/codegen.html#-2 "Direct link to -2")

![picking a locator](https://github.com/microsoft/playwright/assets/13063165/2c8a12e2-4e98-4fdd-af92-1d73ae696d86)

## Emulation[​](https://playwright.dev/docs/codegen.html#emulation "Direct link to Emulation")
...
### Emulate viewport size[​](https://playwright.dev/docs/codegen.html#emulate-viewport-size "Direct link to Emulate viewport size")
...
###### [​](https://playwright.dev/docs/codegen.html#-3 "Direct link to -3")
...
### Emulate devices[​](https://playwright.dev/docs/codegen.html#emulate-devices "Direct link to Emulate devices")
...
###### [​](https://playwright.dev/docs/codegen.html#-4 "Direct link to -4")
...
### Emulate color scheme[​](https://playwright.dev/docs/codegen.html#emulate-color-scheme "Direct link to Emulate color scheme")
...
###### [​](https://playwright.dev/docs/codegen.html#-5 "Direct link to -5")
...
### Emulate geolocation, language and timezone[​](https://playwright.dev/docs/codegen.html#emulate-geolocation-language-and-timezone "Direct link to Emulate geolocation, language and timezone")
...
###### [​](https://playwright.dev/docs/codegen.html#-6 "Direct link to -6")
...
### Preserve authenticated state[​](https://playwright.dev/docs/codegen.html#preserve-authenticated-state "Direct link to Preserve authenticated state")
...
###### [​](https://playwright.dev/docs/codegen.html#-7 "Direct link to -7")
...
#### Login[​](https://playwright.dev/docs/codegen.html#login "Direct link to Login")
...
#### Load authenticated state[​](https://playwright.dev/docs/codegen.html#load-authenticated-state "Direct link to Load authenticated state")
...
###### [​](https://playwright.dev/docs/codegen.html#-8 "Direct link to -8")
...
#### Use existing userDataDir[​](https://playwright.dev/docs/codegen.html#use-existing-userdatadir "Direct link to Use existing userDataDir")

Run `codegen` with `--user-data-dir` to set a fixed [user data directory](https://playwright.dev/docs/api/class-browsertype.html#browser-type-launch-persistent-context-option-user-data-dir) for the browser session. If you create a custom browser user data directory, codegen will use this existing browser profile and have access to any authentication state present in that profile.
...
## Record using custom setup[​](https://playwright.dev/docs/codegen.html#record-using-custom-setup "Direct link to Record using custom setup")

If you would like to use codegen in some non-standard setup (for example, use [browserContext.route()](https://playwright.dev/docs/api/class-browsercontext.html#browser-context-route)), it is possible to call [page.pause()](https://playwright.dev/docs/api/class-page.html#page-pause) that will open a separate window with codegen controls.
...
Snapshot testing](https://playwright.dev/docs/aria-snapshots.html)[Next

Touch events (legacy)](https://playwright.dev/docs/touch-events.html)

* [Introduction](https://playwright.dev/docs/codegen.html#introduction)* [Generate tests in VS Code](https://playwright.dev/docs/codegen.html#generate-tests-in-vs-code)
    + [Record a New Test](https://playwright.dev/docs/codegen.html#record-a-new-test)+ [Record at Cursor](https://playwright.dev/docs/codegen.html#record-at-cursor)+ [Generating locators](https://playwright.dev/docs/codegen.html#generating-locators)* [Generate tests with the Playwright Inspector](https://playwright.dev/docs/codegen.html#generate-tests-with-the-playwright-inspector)
      + [Running Codegen](https://playwright.dev/docs/codegen.html#running-codegen)+ [Recording a test](https://playwright.dev/docs/codegen.html#recording-a-test)+ [Generating locators](https://playwright.dev/docs/codegen.html#generating-locators-1)* [Emulation](https://playwright.dev/docs/codegen.html#emulation)
        + [Emulate viewport size](https://playwright.dev/docs/codegen.html#emulate-viewport-size)+ [Emulate devices](https://playwright.dev/docs/codegen.html#emulate-devices)+ [Emulate color scheme](https://playwright.dev/docs/codegen.html#emulate-color-scheme)+ [Emulate geolocation, language and timezone](https://playwright.dev/docs/codegen.html#emulate-geolocation-language-and-timezone)+ [Preserve authenticated state](https://playwright.dev/docs/codegen.html#preserve-authenticated-state)* [Record using custom setup](https://playwright.dev/docs/codegen.html#record-using-custom-setup)
