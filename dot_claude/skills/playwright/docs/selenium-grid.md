---
title: "Selenium Grid (experimental) | Playwright"
source_url: "https://playwright.dev/docs/selenium-grid"
fetched_at: "2025-12-11T07:41:52.267880+00:00"
---



* * Integrations* Selenium Grid (experimental)

On this page

## Introduction[​](https://playwright.dev/docs/selenium-grid.html#introduction "Direct link to Introduction")
...
## Starting Selenium Grid[​](https://playwright.dev/docs/selenium-grid.html#starting-selenium-grid "Direct link to Starting Selenium Grid")
...
## Connecting Playwright to Selenium Grid[​](https://playwright.dev/docs/selenium-grid.html#connecting-playwright-to-selenium-grid "Direct link to Connecting Playwright to Selenium Grid")
...
You don't have to change your code, just use your testing harness or [browserType.launch()](https://playwright.dev/docs/api/class-browsertype.html#browser-type-launch) as usual.

### Passing additional capabilities[​](https://playwright.dev/docs/selenium-grid.html#passing-additional-capabilities "Direct link to Passing additional capabilities")
...
### Passing additional headers[​](https://playwright.dev/docs/selenium-grid.html#passing-additional-headers "Direct link to Passing additional headers")
...
### Detailed logs[​](https://playwright.dev/docs/selenium-grid.html#detailed-logs "Direct link to Detailed logs")
...
## Using Selenium Docker[​](https://playwright.dev/docs/selenium-grid.html#using-selenium-docker "Direct link to Using Selenium Docker")
...
### Standalone mode[​](https://playwright.dev/docs/selenium-grid.html#standalone-mode "Direct link to Standalone mode")
...
### Hub and nodes mode[​](https://playwright.dev/docs/selenium-grid.html#hub-and-nodes-mode "Direct link to Hub and nodes mode")
...
## Selenium 3[​](https://playwright.dev/docs/selenium-grid.html#selenium-3 "Direct link to Selenium 3")
...
Continuous Integration](https://playwright.dev/docs/ci.html)[Next

Supported languages](https://playwright.dev/docs/languages.html)

* [Introduction](https://playwright.dev/docs/selenium-grid.html#introduction)* [Starting Selenium Grid](https://playwright.dev/docs/selenium-grid.html#starting-selenium-grid)* [Connecting Playwright to Selenium Grid](https://playwright.dev/docs/selenium-grid.html#connecting-playwright-to-selenium-grid)
      + [Passing additional capabilities](https://playwright.dev/docs/selenium-grid.html#passing-additional-capabilities)+ [Passing additional headers](https://playwright.dev/docs/selenium-grid.html#passing-additional-headers)+ [Detailed logs](https://playwright.dev/docs/selenium-grid.html#detailed-logs)* [Using Selenium Docker](https://playwright.dev/docs/selenium-grid.html#using-selenium-docker)
        + [Standalone mode](https://playwright.dev/docs/selenium-grid.html#standalone-mode)+ [Hub and nodes mode](https://playwright.dev/docs/selenium-grid.html#hub-and-nodes-mode)* [Selenium 3](https://playwright.dev/docs/selenium-grid.html#selenium-3)
