...
## Introduction[​](https://playwright.dev/docs/trace-viewer.html#introduction "Direct link to Introduction")

Playwright Trace Viewer is a GUI tool that helps you explore recorded Playwright traces after the script has run. Traces are a great way for debugging your tests when they fail on CI. You can open traces [locally](https://playwright.dev/docs/trace-viewer.html#opening-the-trace) or in your browser on [trace.playwright.dev](https://trace.playwright.dev).

######

## Opening Trace Viewer[​](https://playwright.dev/docs/trace-viewer.html#opening-trace-viewer "Direct link to Opening Trace Viewer")
...
### Using [trace.playwright.dev](https://trace.playwright.dev)[​](https://playwright.dev/docs/trace-viewer.html#using-traceplaywrightdev "Direct link to using-traceplaywrightdev")
...
### Viewing remote traces[​](https://playwright.dev/docs/trace-viewer.html#viewing-remote-traces "Direct link to Viewing remote traces")
...
## Recording a trace[​](https://playwright.dev/docs/trace-viewer.html#recording-a-trace "Direct link to Recording a trace")

### Tracing locally[​](https://playwright.dev/docs/trace-viewer.html#tracing-locally "Direct link to Tracing locally")

To record a trace during development mode set the `--trace` flag to `on` when running your tests. You can also use [UI Mode](https://playwright.dev/docs/test-ui-mode.html) for a better developer experience, as it traces each test automatically.
...
### Tracing on CI[​](https://playwright.dev/docs/trace-viewer.html#tracing-on-ci "Direct link to Tracing on CI")
...
There are more granular options available, see [testOptions.trace](https://playwright.dev/docs/api/class-testoptions.html#test-options-trace).

If you are not using Playwright as a Test Runner, use the [browserContext.tracing](https://playwright.dev/docs/api/class-browsercontext.html#browser-context-tracing) API instead.

## Trace Viewer features[​](https://playwright.dev/docs/trace-viewer.html#trace-viewer-features "Direct link to Trace Viewer features")

### Actions[​](https://playwright.dev/docs/trace-viewer.html#actions "Direct link to Actions")
...
### Screenshots[​](https://playwright.dev/docs/trace-viewer.html#screenshots "Direct link to Screenshots")

When tracing with the [screenshots](https://playwright.dev/docs/api/class-tracing.html#tracing-start-option-screenshots) option turned on (default), each trace records a screencast and renders it as a film strip. You can hover over the film strip to see a magnified image of for each action and state which helps you easily find the action you want to inspect.
...
### Snapshots[​](https://playwright.dev/docs/trace-viewer.html#snapshots "Direct link to Snapshots")

When tracing with the [snapshots](https://playwright.dev/docs/api/class-tracing.html#tracing-start-option-snapshots) option turned on (default), Playwright captures a set of complete DOM snapshots for each action. Depending on the type of the action, it will capture:
...
### Source[​](https://playwright.dev/docs/trace-viewer.html#source "Direct link to Source")
...
### Call[​](https://playwright.dev/docs/trace-viewer.html#call "Direct link to Call")
...
### Log[​](https://playwright.dev/docs/trace-viewer.html#log "Direct link to Log")
...
### Errors[​](https://playwright.dev/docs/trace-viewer.html#errors "Direct link to Errors")
...
### Console[​](https://playwright.dev/docs/trace-viewer.html#console "Direct link to Console")
...
### Network[​](https://playwright.dev/docs/trace-viewer.html#network "Direct link to Network")
...
### Metadata[​](https://playwright.dev/docs/trace-viewer.html#metadata "Direct link to Metadata")
...
### Attachments[​](https://playwright.dev/docs/trace-viewer.html#attachments "Direct link to Attachments")

The "Attachments" tab allows you to explore attachments. If you're doing [visual regression testing](https://playwright.dev/docs/test-snapshots.html), you'll be able to compare screenshots by examining the image diff, the actual image and the expected image. When you click on the expected image you can use the slider to slide one image over the other so you can easily see the differences in your screenshots.
...
Touch events (legacy)](https://playwright.dev/docs/touch-events.html)[Next

Videos](https://playwright.dev/docs/videos.html)

* [Introduction](https://playwright.dev/docs/trace-viewer.html#introduction)* [Opening Trace Viewer](https://playwright.dev/docs/trace-viewer.html#opening-trace-viewer)
    + [Using trace.playwright.dev](https://playwright.dev/docs/trace-viewer.html#using-traceplaywrightdev)+ [Viewing remote traces](https://playwright.dev/docs/trace-viewer.html#viewing-remote-traces)* [Recording a trace](https://playwright.dev/docs/trace-viewer.html#recording-a-trace)
      + [Tracing locally](https://playwright.dev/docs/trace-viewer.html#tracing-locally)+ [Tracing on CI](https://playwright.dev/docs/trace-viewer.html#tracing-on-ci)* [Trace Viewer features](https://playwright.dev/docs/trace-viewer.html#trace-viewer-features)
        + [Actions](https://playwright.dev/docs/trace-viewer.html#actions)+ [Screenshots](https://playwright.dev/docs/trace-viewer.html#screenshots)+ [Snapshots](https://playwright.dev/docs/trace-viewer.html#snapshots)+ [Source](https://playwright.dev/docs/trace-viewer.html#source)+ [Call](https://playwright.dev/docs/trace-viewer.html#call)+ [Log](https://playwright.dev/docs/trace-viewer.html#log)+ [Errors](https://playwright.dev/docs/trace-viewer.html#errors)+ [Console](https://playwright.dev/docs/trace-viewer.html#console)+ [Network](https://playwright.dev/docs/trace-viewer.html#network)+ [Metadata](https://playwright.dev/docs/trace-viewer.html#metadata)+ [Attachments](https://playwright.dev/docs/trace-viewer.html#attachments)
