...
## Introduction[​](https://playwright.dev/docs/browsers.html#introduction "Direct link to Introduction")

Each version of Playwright needs specific versions of browser binaries to operate. You will need to use the Playwright CLI to install these browsers.

With every release, Playwright updates the versions of the browsers it supports, so that the latest Playwright would support the latest browsers at any moment. It means that every time you update Playwright, you might need to re-run the `install` CLI command.

## Install browsers[​](https://playwright.dev/docs/browsers.html#install-browsers "Direct link to Install browsers")
...
## Install system dependencies[​](https://playwright.dev/docs/browsers.html#install-system-dependencies "Direct link to Install system dependencies")
...
See [system requirements](https://playwright.dev/docs/intro.html#system-requirements) for officially supported operating systems.

## Update Playwright regularly[​](https://playwright.dev/docs/browsers.html#update-playwright-regularly "Direct link to Update Playwright regularly")
...
## Configure Browsers[​](https://playwright.dev/docs/browsers.html#configure-browsers "Direct link to Configure Browsers")
...
### Run tests on different browsers[​](https://playwright.dev/docs/browsers.html#run-tests-on-different-browsers "Direct link to Run tests on different browsers")

Playwright can run your tests in multiple browsers and configurations by setting up **projects** in the config. You can also add [different options](https://playwright.dev/docs/test-configuration.html) for each project.
...
### Chromium[​](https://playwright.dev/docs/browsers.html#chromium "Direct link to Chromium")

For Google Chrome, Microsoft Edge and other Chromium-based browsers, by default, Playwright uses open source Chromium builds. Since the Chromium project is ahead of the branded browsers, when the world is on Google Chrome N, Playwright already supports Chromium N+1 that will be released in Google Chrome and Microsoft Edge a few weeks later.

### Chromium: headless shell[​](https://playwright.dev/docs/browsers.html#chromium-headless-shell "Direct link to Chromium: headless shell")
...
### Chromium: new headless mode[​](https://playwright.dev/docs/browsers.html#chromium-new-headless-mode "Direct link to Chromium: new headless mode")
...
### Google Chrome & Microsoft Edge[​](https://playwright.dev/docs/browsers.html#google-chrome--microsoft-edge "Direct link to Google Chrome & Microsoft Edge")
...
#### Installing Google Chrome & Microsoft Edge[​](https://playwright.dev/docs/browsers.html#installing-google-chrome--microsoft-edge "Direct link to Installing Google Chrome & Microsoft Edge")
...
#### When to use Google Chrome & Microsoft Edge and when not to?[​](https://playwright.dev/docs/browsers.html#when-to-use-google-chrome--microsoft-edge-and-when-not-to "Direct link to When to use Google Chrome & Microsoft Edge and when not to?")

##### Defaults[​](https://playwright.dev/docs/browsers.html#defaults "Direct link to Defaults")
...
##### Regression testing[​](https://playwright.dev/docs/browsers.html#regression-testing "Direct link to Regression testing")
...
##### Media codecs[​](https://playwright.dev/docs/browsers.html#media-codecs "Direct link to Media codecs")
...
##### Enterprise policy[​](https://playwright.dev/docs/browsers.html#enterprise-policy "Direct link to Enterprise policy")
...
### Firefox[​](https://playwright.dev/docs/browsers.html#firefox "Direct link to Firefox")
...
### WebKit[​](https://playwright.dev/docs/browsers.html#webkit "Direct link to WebKit")
...
## Install behind a firewall or a proxy[​](https://playwright.dev/docs/browsers.html#install-behind-a-firewall-or-a-proxy "Direct link to Install behind a firewall or a proxy")
...
If you are [installing dependencies](https://playwright.dev/docs/browsers.html#install-system-dependencies) and need to use a proxy on Linux, make sure to run the command as a root user. Otherwise, Playwright will attempt to become a root and will not pass environment variables like `HTTPS_PROXY` to the linux package manager.

```
sudo HTTPS_PROXY=https://192.0.2.1 npx playwright install-deps
```

## Download from artifact repository[​](https://playwright.dev/docs/browsers.html#download-from-artifact-repository "Direct link to Download from artifact repository")
...
## Managing browser binaries[​](https://playwright.dev/docs/browsers.html#managing-browser-binaries "Direct link to Managing browser binaries")
...
### Hermetic install[​](https://playwright.dev/docs/browsers.html#hermetic-install "Direct link to Hermetic install")
...
### Stale browser removal[​](https://playwright.dev/docs/browsers.html#stale-browser-removal "Direct link to Stale browser removal")
...
### List all installed browsers:[​](https://playwright.dev/docs/browsers.html#list-all-installed-browsers "Direct link to List all installed browsers:")
...
### Uninstall browsers[​](https://playwright.dev/docs/browsers.html#uninstall-browsers "Direct link to Uninstall browsers")
...
Best Practices](https://playwright.dev/docs/best-practices.html)[Next

Chrome extensions](https://playwright.dev/docs/chrome-extensions.html)

* [Introduction](https://playwright.dev/docs/browsers.html#introduction)* [Install browsers](https://playwright.dev/docs/browsers.html#install-browsers)* [Install system dependencies](https://playwright.dev/docs/browsers.html#install-system-dependencies)* [Update Playwright regularly](https://playwright.dev/docs/browsers.html#update-playwright-regularly)* [Configure Browsers](https://playwright.dev/docs/browsers.html#configure-browsers)
          + [Run tests on different browsers](https://playwright.dev/docs/browsers.html#run-tests-on-different-browsers)+ [Chromium](https://playwright.dev/docs/browsers.html#chromium)+ [Chromium: headless shell](https://playwright.dev/docs/browsers.html#chromium-headless-shell)+ [Chromium: new headless mode](https://playwright.dev/docs/browsers.html#chromium-new-headless-mode)+ [Google Chrome & Microsoft Edge](https://playwright.dev/docs/browsers.html#google-chrome--microsoft-edge)+ [Firefox](https://playwright.dev/docs/browsers.html#firefox)+ [WebKit](https://playwright.dev/docs/browsers.html#webkit)* [Install behind a firewall or a proxy](https://playwright.dev/docs/browsers.html#install-behind-a-firewall-or-a-proxy)* [Download from artifact repository](https://playwright.dev/docs/browsers.html#download-from-artifact-repository)* [Managing browser binaries](https://playwright.dev/docs/browsers.html#managing-browser-binaries)
                + [Hermetic install](https://playwright.dev/docs/browsers.html#hermetic-install)+ [Stale browser removal](https://playwright.dev/docs/browsers.html#stale-browser-removal)+ [List all installed browsers:](https://playwright.dev/docs/browsers.html#list-all-installed-browsers)+ [Uninstall browsers](https://playwright.dev/docs/browsers.html#uninstall-browsers)
