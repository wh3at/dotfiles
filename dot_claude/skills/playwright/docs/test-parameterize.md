---
title: "Parameterize tests | Playwright"
...
* * Playwright Test* Parameterize tests

On this page

## Introduction[​](https://playwright.dev/docs/test-parameterize.html#introduction "Direct link to Introduction")

You can either parameterize tests on a test level or on a project level.

## Parameterized Tests[​](https://playwright.dev/docs/test-parameterize.html#parameterized-tests "Direct link to Parameterized Tests")
...
### Before and after hooks[​](https://playwright.dev/docs/test-parameterize.html#before-and-after-hooks "Direct link to Before and after hooks")
...
## Parameterized Projects[​](https://playwright.dev/docs/test-parameterize.html#parameterized-projects "Direct link to Parameterized Projects")
...
We can use this option in the test, similarly to [fixtures](https://playwright.dev/docs/test-fixtures.html).
...
We can also use the option in a fixture. Learn more about [fixtures](https://playwright.dev/docs/test-fixtures.html).
...
Parameterized projects behavior has changed in version 1.18. [Learn more](https://playwright.dev/docs/release-notes.html#breaking-change-custom-config-options).

## Passing Environment Variables[​](https://playwright.dev/docs/test-parameterize.html#passing-environment-variables "Direct link to Passing Environment Variables")
...
### .env files[​](https://playwright.dev/docs/test-parameterize.html#env-files "Direct link to .env files")
...
## Create tests via a CSV file[​](https://playwright.dev/docs/test-parameterize.html#create-tests-via-a-csv-file "Direct link to Create tests via a CSV file")
...
Parallelism](https://playwright.dev/docs/test-parallel.html)[Next

Projects](https://playwright.dev/docs/test-projects.html)

* [Introduction](https://playwright.dev/docs/test-parameterize.html#introduction)* [Parameterized Tests](https://playwright.dev/docs/test-parameterize.html#parameterized-tests)
    + [Before and after hooks](https://playwright.dev/docs/test-parameterize.html#before-and-after-hooks)* [Parameterized Projects](https://playwright.dev/docs/test-parameterize.html#parameterized-projects)* [Passing Environment Variables](https://playwright.dev/docs/test-parameterize.html#passing-environment-variables)
        + [.env files](https://playwright.dev/docs/test-parameterize.html#env-files)* [Create tests via a CSV file](https://playwright.dev/docs/test-parameterize.html#create-tests-via-a-csv-file)
