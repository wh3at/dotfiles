...
source_url: "https://playwright.dev/docs/test-agents"
...
## Introduction[​](https://playwright.dev/docs/test-agents.html#introduction "Direct link to Introduction")
...
### Getting Started[​](https://playwright.dev/docs/test-agents.html#getting-started "Direct link to Getting Started")
...
## 🎭 Planner[​](https://playwright.dev/docs/test-agents.html#-planner "Direct link to 🎭 Planner")
...
## 🎭 Generator[​](https://playwright.dev/docs/test-agents.html#-generator "Direct link to 🎭 Generator")
...
## 🎭 Healer[​](https://playwright.dev/docs/test-agents.html#-healer "Direct link to 🎭 Healer")
...
## Artifacts and Conventions[​](https://playwright.dev/docs/test-agents.html#artifacts-and-conventions "Direct link to Artifacts and Conventions")
...
### Agent Definitions[​](https://playwright.dev/docs/test-agents.html#agent-definitions "Direct link to Agent Definitions")
...
### Specs in `specs/`[​](https://playwright.dev/docs/test-agents.html#specs-in-specs "Direct link to specs-in-specs")
...
### Tests in `tests/`[​](https://playwright.dev/docs/test-agents.html#tests-in-tests "Direct link to tests-in-tests")

Generated Playwright tests, aligned one-to-one with specs wherever feasible.

### Seed tests `seed.spec.ts`[​](https://playwright.dev/docs/test-agents.html#seed-tests-seedspects "Direct link to seed-tests-seedspects")

Seed tests provide a ready-to-use `page` context to bootstrap execution.

[Previous

Canary releases](https://playwright.dev/docs/canary-releases.html)[Next

Annotations](https://playwright.dev/docs/test-annotations.html)

* [Introduction](https://playwright.dev/docs/test-agents.html#introduction)
  + [Getting Started](https://playwright.dev/docs/test-agents.html#getting-started)* [🎭 Planner](https://playwright.dev/docs/test-agents.html#-planner)* [🎭 Generator](https://playwright.dev/docs/test-agents.html#-generator)* [🎭 Healer](https://playwright.dev/docs/test-agents.html#-healer)* [Artifacts and Conventions](https://playwright.dev/docs/test-agents.html#artifacts-and-conventions)
          + [Agent Definitions](https://playwright.dev/docs/test-agents.html#agent-definitions)+ [Specs in `specs/`](https://playwright.dev/docs/test-agents.html#specs-in-specs)+ [Tests in `tests/`](https://playwright.dev/docs/test-agents.html#tests-in-tests)+ [Seed tests `seed.spec.ts`](https://playwright.dev/docs/test-agents.html#seed-tests-seedspects)
