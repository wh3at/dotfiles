...
## Introduction[​](https://playwright.dev/docs/mock.html#introduction "Direct link to Introduction")
...
## Mock API requests[​](https://playwright.dev/docs/mock.html#mock-api-requests "Direct link to Mock API requests")
...
Read more about [advanced networking](https://playwright.dev/docs/network.html).

## Modify API responses[​](https://playwright.dev/docs/mock.html#modify-api-responses "Direct link to Modify API responses")
...
## Mocking with HAR files[​](https://playwright.dev/docs/mock.html#mocking-with-har-files "Direct link to Mocking with HAR files")
...
Alternatively, you can also record HAR files by using the [recordHar](https://playwright.dev/docs/api/class-browser.html#browser-new-context-option-record-har) option in [browser.newContext()](https://playwright.dev/docs/api/class-browser.html#browser-new-context) when creating a browser context. This allows you to capture all network traffic for the entire context until the context is closed.

### Modifying a HAR file[​](https://playwright.dev/docs/mock.html#modifying-a-har-file "Direct link to Modifying a HAR file")
...
### Replaying from HAR[​](https://playwright.dev/docs/mock.html#replaying-from-har "Direct link to Replaying from HAR")
...
#### Recording HAR with CLI[​](https://playwright.dev/docs/mock.html#recording-har-with-cli "Direct link to Recording HAR with CLI")
...
## Mock WebSockets[​](https://playwright.dev/docs/mock.html#mock-websockets "Direct link to Mock WebSockets")
...
For more details, see [WebSocketRoute](https://playwright.dev/docs/api/class-websocketroute.html "WebSocketRoute").

[Previous

Locators](https://playwright.dev/docs/locators.html)[Next

Mock browser APIs](https://playwright.dev/docs/mock-browser-apis.html)

* [Introduction](https://playwright.dev/docs/mock.html#introduction)* [Mock API requests](https://playwright.dev/docs/mock.html#mock-api-requests)* [Modify API responses](https://playwright.dev/docs/mock.html#modify-api-responses)* [Mocking with HAR files](https://playwright.dev/docs/mock.html#mocking-with-har-files)
        + [Recording a HAR file](https://playwright.dev/docs/mock.html#recording-a-har-file)+ [Modifying a HAR file](https://playwright.dev/docs/mock.html#modifying-a-har-file)+ [Replaying from HAR](https://playwright.dev/docs/mock.html#replaying-from-har)* [Mock WebSockets](https://playwright.dev/docs/mock.html#mock-websockets)
