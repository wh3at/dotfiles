---
title: "Navigations | Playwright"
source_url: "https://playwright.dev/docs/navigations"
...
## Introduction[​](https://playwright.dev/docs/navigations.html#introduction "Direct link to Introduction")

Playwright can navigate to URLs and handle navigations caused by the page interactions.

## Basic navigation[​](https://playwright.dev/docs/navigations.html#basic-navigation "Direct link to Basic navigation")
...
If the page does a client-side redirect before `load`, [page.goto()](https://playwright.dev/docs/api/class-page.html#page-goto) will wait for the redirected page to fire the `load` event.

## When is the page loaded?[​](https://playwright.dev/docs/navigations.html#when-is-the-page-loaded "Direct link to When is the page loaded?")
...
In Playwright you can interact with the page at any moment. It will automatically wait for the target elements to become [actionable](https://playwright.dev/docs/actionability.html).
...
## Hydration[​](https://playwright.dev/docs/navigations.html#hydration "Direct link to Hydration")
...
## Waiting for navigation[​](https://playwright.dev/docs/navigations.html#waiting-for-navigation "Direct link to Waiting for navigation")

Clicking an element could trigger multiple navigations. In these cases, it is recommended to explicitly [page.waitForURL()](https://playwright.dev/docs/api/class-page.html#page-wait-for-url) to a specific url.
...
## Navigation events[​](https://playwright.dev/docs/navigations.html#navigation-events "Direct link to Navigation events")
...
* [page.url()](https://playwright.dev/docs/api/class-page.html#page-url) is set to the new url
* document content is loaded over network and parsed
* [page.on('domcontentloaded')](https://playwright.dev/docs/api/class-page.html#page-event-dom-content-loaded) event is fired
* page executes some scripts and loads resources like stylesheets and images
* [page.on('load')](https://playwright.dev/docs/api/class-page.html#page-event-load) event is fired
* page executes dynamically loaded scripts

[Previous

Mock browser APIs](https://playwright.dev/docs/mock-browser-apis.html)[Next

Network](https://playwright.dev/docs/network.html)

* [Introduction](https://playwright.dev/docs/navigations.html#introduction)* [Basic navigation](https://playwright.dev/docs/navigations.html#basic-navigation)* [When is the page loaded?](https://playwright.dev/docs/navigations.html#when-is-the-page-loaded)* [Hydration](https://playwright.dev/docs/navigations.html#hydration)* [Waiting for navigation](https://playwright.dev/docs/navigations.html#waiting-for-navigation)* [Navigation events](https://playwright.dev/docs/navigations.html#navigation-events)
