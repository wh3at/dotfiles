---
title: "UI Mode | Playwright"
source_url: "https://playwright.dev/docs/test-ui-mode"
...
## Introduction[​](https://playwright.dev/docs/test-ui-mode.html#introduction "Direct link to Introduction")

UI Mode lets you explore, run, and debug tests with a time travel experience complete with a watch mode. All test files are displayed in the testing sidebar, allowing you to expand each file and describe block to individually run, view, watch, and debug each test. Filter tests by **name**, [**projects**](https://playwright.dev/docs/test-projects.html) (set in your `playwright.config` file), **@tag**, or by the execution status of **passed**, **failed**, and **skipped**. See a full trace of your tests and hover back and forward over each action to see what was happening during each step. You can also pop out the DOM snapshot of a given moment into a separate window for a better debugging experience.

## Opening UI Mode[​](https://playwright.dev/docs/test-ui-mode.html#opening-ui-mode "Direct link to Opening UI Mode")
...
## Running your tests[​](https://playwright.dev/docs/test-ui-mode.html#running-your-tests "Direct link to Running your tests")
...
## Filtering tests[​](https://playwright.dev/docs/test-ui-mode.html#filtering-tests "Direct link to Filtering tests")

Filter tests by text or `@tag` or by passed, failed or skipped tests. You can also filter by [projects](https://playwright.dev/docs/test-projects.html) as set in your `playwright.config` file. If you are using project dependencies make sure to run your setup tests first before running the tests that depend on them. The UI mode will not take into consideration the setup tests and therefore you will have to manually run them first.

![filtering tests in ui mode](https://github.com/microsoft/playwright/assets/13063165/6f05e589-036d-45d5-9078-38134e1261e4)

## Timeline view[​](https://playwright.dev/docs/test-ui-mode.html#timeline-view "Direct link to Timeline view")
...
## Actions[​](https://playwright.dev/docs/test-ui-mode.html#actions "Direct link to Actions")
...
## Pop out and inspect the DOM[​](https://playwright.dev/docs/test-ui-mode.html#pop-out-and-inspect-the-dom "Direct link to Pop out and inspect the DOM")
...
## Pick locator[​](https://playwright.dev/docs/test-ui-mode.html#pick-locator "Direct link to Pick locator")
...
## Source[​](https://playwright.dev/docs/test-ui-mode.html#source "Direct link to Source")
...
## Call[​](https://playwright.dev/docs/test-ui-mode.html#call "Direct link to Call")
...
## Log[​](https://playwright.dev/docs/test-ui-mode.html#log "Direct link to Log")
...
## Errors[​](https://playwright.dev/docs/test-ui-mode.html#errors "Direct link to Errors")
...
## Console[​](https://playwright.dev/docs/test-ui-mode.html#console "Direct link to Console")
...
## Network[​](https://playwright.dev/docs/test-ui-mode.html#network "Direct link to Network")
...
## Attachments[​](https://playwright.dev/docs/test-ui-mode.html#attachments "Direct link to Attachments")
...
## Metadata[​](https://playwright.dev/docs/test-ui-mode.html#metadata "Direct link to Metadata")
...
## Watch mode[​](https://playwright.dev/docs/test-ui-mode.html#watch-mode "Direct link to Watch mode")
...
## Docker & GitHub Codespaces[​](https://playwright.dev/docs/test-ui-mode.html#docker--github-codespaces "Direct link to Docker & GitHub Codespaces")
...
TypeScript](https://playwright.dev/docs/test-typescript.html)[Next

Web server](https://playwright.dev/docs/test-webserver.html)

* [Introduction](https://playwright.dev/docs/test-ui-mode.html#introduction)* [Opening UI Mode](https://playwright.dev/docs/test-ui-mode.html#opening-ui-mode)* [Running your tests](https://playwright.dev/docs/test-ui-mode.html#running-your-tests)* [Filtering tests](https://playwright.dev/docs/test-ui-mode.html#filtering-tests)* [Timeline view](https://playwright.dev/docs/test-ui-mode.html#timeline-view)* [Actions](https://playwright.dev/docs/test-ui-mode.html#actions)* [Pop out and inspect the DOM](https://playwright.dev/docs/test-ui-mode.html#pop-out-and-inspect-the-dom)* [Pick locator](https://playwright.dev/docs/test-ui-mode.html#pick-locator)* [Source](https://playwright.dev/docs/test-ui-mode.html#source)* [Call](https://playwright.dev/docs/test-ui-mode.html#call)* [Log](https://playwright.dev/docs/test-ui-mode.html#log)* [Errors](https://playwright.dev/docs/test-ui-mode.html#errors)* [Console](https://playwright.dev/docs/test-ui-mode.html#console)* [Network](https://playwright.dev/docs/test-ui-mode.html#network)* [Attachments](https://playwright.dev/docs/test-ui-mode.html#attachments)* [Metadata](https://playwright.dev/docs/test-ui-mode.html#metadata)* [Watch mode](https://playwright.dev/docs/test-ui-mode.html#watch-mode)* [Docker & GitHub Codespaces](https://playwright.dev/docs/test-ui-mode.html#docker--github-codespaces)
