...
## Writing and running tests[​](https://playwright.dev/docs/webview2.html#writing-and-running-tests "Direct link to Writing and running tests")
...
Using the following, Playwright will run your WebView2 application as a sub-process, assign a unique user data directory to it and provide the [Page](https://playwright.dev/docs/api/class-page.html "Page") instance to your test:
...
## Debugging[​](https://playwright.dev/docs/webview2.html#debugging "Direct link to Debugging")
...
For debugging tests, see the Playwright [Debugging guide](https://playwright.dev/docs/debug.html).

[Previous

Visual comparisons](https://playwright.dev/docs/test-snapshots.html)[Next

Migrating from Protractor](https://playwright.dev/docs/protractor.html)

* [Introduction](https://playwright.dev/docs/webview2.html#introduction)* [Overview](https://playwright.dev/docs/webview2.html#overview)* [Writing and running tests](https://playwright.dev/docs/webview2.html#writing-and-running-tests)* [Debugging](https://playwright.dev/docs/webview2.html#debugging)
