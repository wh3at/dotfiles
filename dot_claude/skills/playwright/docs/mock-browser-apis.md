---
title: "Mock browser APIs | Playwright"
...
* * Guides* Mock browser APIs

On this page

## Introduction[​](https://playwright.dev/docs/mock-browser-apis.html#introduction "Direct link to Introduction")
...
## Creating mocks[​](https://playwright.dev/docs/mock-browser-apis.html#creating-mocks "Direct link to Creating mocks")

Since the page may be calling the API very early while loading it's important to setup all the mocks before the page started loading. The easiest way to achieve that is to call [page.addInitScript()](https://playwright.dev/docs/api/class-page.html#page-add-init-script):
...
## Mocking read-only APIs[​](https://playwright.dev/docs/mock-browser-apis.html#mocking-read-only-apis "Direct link to Mocking read-only APIs")
...
## Verifying API calls[​](https://playwright.dev/docs/mock-browser-apis.html#verifying-api-calls "Direct link to Verifying API calls")

Sometimes it is useful to check if the page made all expected APIs calls. You can record all API method invocations and then compare them with golden result. [page.exposeFunction()](https://playwright.dev/docs/api/class-page.html#page-expose-function) may come in handy for passing message from the page back to the test code:
...
## Updating mock[​](https://playwright.dev/docs/mock-browser-apis.html#updating-mock "Direct link to Updating mock")
...
Mock APIs](https://playwright.dev/docs/mock.html)[Next

Navigations](https://playwright.dev/docs/navigations.html)

* [Introduction](https://playwright.dev/docs/mock-browser-apis.html#introduction)* [Creating mocks](https://playwright.dev/docs/mock-browser-apis.html#creating-mocks)* [Mocking read-only APIs](https://playwright.dev/docs/mock-browser-apis.html#mocking-read-only-apis)* [Verifying API calls](https://playwright.dev/docs/mock-browser-apis.html#verifying-api-calls)* [Updating mock](https://playwright.dev/docs/mock-browser-apis.html#updating-mock)
