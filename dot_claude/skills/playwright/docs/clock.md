...
## Introduction[​](https://playwright.dev/docs/clock.html#introduction "Direct link to Introduction")

Accurately simulating time-dependent behavior is essential for verifying the correctness of applications. Utilizing [Clock](https://playwright.dev/docs/api/class-clock.html "Clock") functionality allows developers to manipulate and control time within tests, enabling the precise validation of features such as rendering time, timeouts, scheduled tasks without the delays and variability of real-time execution.

The [Clock](https://playwright.dev/docs/api/class-clock.html "Clock") API provides the following methods to control time:
...
[page.clock](https://playwright.dev/docs/api/class-page.html#page-clock) overrides native global classes and functions related to time allowing them to be manually controlled:
...
## Test with predefined time[​](https://playwright.dev/docs/clock.html#test-with-predefined-time "Direct link to Test with predefined time")
...
## Consistent time and timers[​](https://playwright.dev/docs/clock.html#consistent-time-and-timers "Direct link to Consistent time and timers")
...
## Test inactivity monitoring[​](https://playwright.dev/docs/clock.html#test-inactivity-monitoring "Direct link to Test inactivity monitoring")
...
## Tick through time manually, firing all the timers consistently[​](https://playwright.dev/docs/clock.html#tick-through-time-manually-firing-all-the-timers-consistently "Direct link to Tick through time manually, firing all the timers consistently")
...
## Related Videos[​](https://playwright.dev/docs/clock.html#related-videos "Direct link to Related Videos")

[Previous

Chrome extensions](https://playwright.dev/docs/chrome-extensions.html)[Next

Components (experimental)](https://playwright.dev/docs/test-components.html)

* [Introduction](https://playwright.dev/docs/clock.html#introduction)* [Test with predefined time](https://playwright.dev/docs/clock.html#test-with-predefined-time)* [Consistent time and timers](https://playwright.dev/docs/clock.html#consistent-time-and-timers)* [Test inactivity monitoring](https://playwright.dev/docs/clock.html#test-inactivity-monitoring)* [Tick through time manually, firing all the timers consistently](https://playwright.dev/docs/clock.html#tick-through-time-manually-firing-all-the-timers-consistently)* [Related Videos](https://playwright.dev/docs/clock.html#related-videos)
