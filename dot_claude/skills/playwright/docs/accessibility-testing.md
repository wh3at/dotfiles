...
## Introduction[​](https://playwright.dev/docs/accessibility-testing.html#introduction "Direct link to Introduction")
...
## Example accessibility tests[​](https://playwright.dev/docs/accessibility-testing.html#example-accessibility-tests "Direct link to Example accessibility tests")
...
### Scanning an entire page[​](https://playwright.dev/docs/accessibility-testing.html#scanning-an-entire-page "Direct link to Scanning an entire page")
...
5. Uses normal Playwright Test [assertions](https://playwright.dev/docs/test-assertions.html) to verify that there are no violations in the returned scan results
...
### Configuring axe to scan a specific part of a page[​](https://playwright.dev/docs/accessibility-testing.html#configuring-axe-to-scan-a-specific-part-of-a-page "Direct link to Configuring axe to scan a specific part of a page")
...
`AxeBuilder.analyze()` will scan the page *in its current state* when you call it. To scan parts of a page that are revealed based on UI interactions, use [Locators](https://playwright.dev/docs/locators.html) to interact with the page before invoking `analyze()`:
...
### Scanning for WCAG violations[​](https://playwright.dev/docs/accessibility-testing.html#scanning-for-wcag-violations "Direct link to Scanning for WCAG violations")
...
## Handling known issues[​](https://playwright.dev/docs/accessibility-testing.html#handling-known-issues "Direct link to Handling known issues")
...
### Excluding individual elements from a scan[​](https://playwright.dev/docs/accessibility-testing.html#excluding-individual-elements-from-a-scan "Direct link to Excluding individual elements from a scan")
...
If the element in question is used repeatedly in many pages, consider [using a test fixture](https://playwright.dev/docs/accessibility-testing.html#using-a-test-fixture-for-common-axe-configuration) to reuse the same `AxeBuilder` configuration across multiple tests.

### Disabling individual scan rules[​](https://playwright.dev/docs/accessibility-testing.html#disabling-individual-scan-rules "Direct link to Disabling individual scan rules")
...
### Using snapshots to allow specific known issues[​](https://playwright.dev/docs/accessibility-testing.html#using-snapshots-to-allow-specific-known-issues "Direct link to Using snapshots to allow specific known issues")

If you would like to allow for a more granular set of known issues, you can use [Snapshots](https://playwright.dev/docs/test-snapshots.html) to verify that a set of preexisting violations has not changed. This approach avoids the downsides of using `AxeBuilder.exclude()` at the cost of slightly more complexity and fragility.
...
## Exporting scan results as a test attachment[​](https://playwright.dev/docs/accessibility-testing.html#exporting-scan-results-as-a-test-attachment "Direct link to Exporting scan results as a test attachment")
...
To include *all* of the scan results as part of your test results for debugging purposes, you can add the scan results as a test attachment with [`testInfo.attach()`](https://playwright.dev/docs/api/class-testinfo.html#test-info-attach). [Reporters](https://playwright.dev/docs/test-reporters.html) can then embed or link the full results as part of your test output.
...
## Using a test fixture for common axe configuration[​](https://playwright.dev/docs/accessibility-testing.html#using-a-test-fixture-for-common-axe-configuration "Direct link to Using a test fixture for common axe configuration")

[Test fixtures](https://playwright.dev/docs/test-fixtures.html) are a good way to share common `AxeBuilder` configuration across many tests. Some scenarios where this might be useful include:
...
### Creating a fixture[​](https://playwright.dev/docs/accessibility-testing.html#creating-a-fixture "Direct link to Creating a fixture")
...
### Using a fixture[​](https://playwright.dev/docs/accessibility-testing.html#using-a-fixture "Direct link to Using a fixture")
...
Library](https://playwright.dev/docs/library.html)[Next

Actions](https://playwright.dev/docs/input.html)

* [Introduction](https://playwright.dev/docs/accessibility-testing.html#introduction)* [Example accessibility tests](https://playwright.dev/docs/accessibility-testing.html#example-accessibility-tests)
    + [Scanning an entire page](https://playwright.dev/docs/accessibility-testing.html#scanning-an-entire-page)+ [Configuring axe to scan a specific part of a page](https://playwright.dev/docs/accessibility-testing.html#configuring-axe-to-scan-a-specific-part-of-a-page)+ [Scanning for WCAG violations](https://playwright.dev/docs/accessibility-testing.html#scanning-for-wcag-violations)* [Handling known issues](https://playwright.dev/docs/accessibility-testing.html#handling-known-issues)
      + [Excluding individual elements from a scan](https://playwright.dev/docs/accessibility-testing.html#excluding-individual-elements-from-a-scan)+ [Disabling individual scan rules](https://playwright.dev/docs/accessibility-testing.html#disabling-individual-scan-rules)+ [Using snapshots to allow specific known issues](https://playwright.dev/docs/accessibility-testing.html#using-snapshots-to-allow-specific-known-issues)* [Exporting scan results as a test attachment](https://playwright.dev/docs/accessibility-testing.html#exporting-scan-results-as-a-test-attachment)* [Using a test fixture for common axe configuration](https://playwright.dev/docs/accessibility-testing.html#using-a-test-fixture-for-common-axe-configuration)
          + [Creating a fixture](https://playwright.dev/docs/accessibility-testing.html#creating-a-fixture)+ [Using a fixture](https://playwright.dev/docs/accessibility-testing.html#using-a-fixture)
