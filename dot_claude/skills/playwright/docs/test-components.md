---
title: "Components (experimental) | Playwright"
source_url: "https://playwright.dev/docs/test-components"
fetched_at: "2025-12-11T07:41:52.267880+00:00"
---



* * Guides* Components (experimental)

On this page

## Introduction[​](https://playwright.dev/docs/test-components.html#introduction "Direct link to Introduction")

Playwright Test can now test your components.

## Example[​](https://playwright.dev/docs/test-components.html#example "Direct link to Example")
...
## How to get started[​](https://playwright.dev/docs/test-components.html#how-to-get-started "Direct link to How to get started")
...
### Step 1: Install Playwright Test for components for your respective framework[​](https://playwright.dev/docs/test-components.html#step-1-install-playwright-test-for-components-for-your-respective-framework "Direct link to Step 1: Install Playwright Test for components for your respective framework")
...
### Step 2. Create a test file `src/App.spec.{ts,tsx}`[​](https://playwright.dev/docs/test-components.html#step-2-create-a-test-file-srcappspectstsx "Direct link to step-2-create-a-test-file-srcappspectstsx")
...
### Step 3. Run the tests[​](https://playwright.dev/docs/test-components.html#step-3-run-the-tests "Direct link to Step 3. Run the tests")

You can run tests using the [VS Code extension](https://playwright.dev/docs/getting-started-vscode.html) or the command line.

```
npm run test-ct
```

### Further reading: configure reporting, browsers, tracing[​](https://playwright.dev/docs/test-components.html#further-reading-configure-reporting-browsers-tracing "Direct link to Further reading: configure reporting, browsers, tracing")

Refer to [Playwright config](https://playwright.dev/docs/test-configuration.html) for configuring your project.

## Test stories[​](https://playwright.dev/docs/test-components.html#test-stories "Direct link to Test stories")
...
## Under the hood[​](https://playwright.dev/docs/test-components.html#under-the-hood "Direct link to Under the hood")
...
## API reference[​](https://playwright.dev/docs/test-components.html#api-reference "Direct link to API reference")

### props[​](https://playwright.dev/docs/test-components.html#props "Direct link to props")
...
### callbacks / events[​](https://playwright.dev/docs/test-components.html#callbacks--events "Direct link to callbacks / events")
...
### children / slots[​](https://playwright.dev/docs/test-components.html#children--slots "Direct link to children / slots")
...
### hooks[​](https://playwright.dev/docs/test-components.html#hooks "Direct link to hooks")
...
### unmount[​](https://playwright.dev/docs/test-components.html#unmount "Direct link to unmount")
...
### update[​](https://playwright.dev/docs/test-components.html#update "Direct link to update")
...
### Handling network requests[​](https://playwright.dev/docs/test-components.html#handling-network-requests "Direct link to Handling network requests")
...
* Call `router.route(url, handler)` that behaves similarly to [page.route()](https://playwright.dev/docs/api/class-page.html#page-route). See the [network mocking guide](https://playwright.dev/docs/mock.html) for more details.
...
## Frequently asked questions[​](https://playwright.dev/docs/test-components.html#frequently-asked-questions "Direct link to Frequently asked questions")

### What's the difference between `@playwright/test` and `@playwright/experimental-ct-{react,svelte,vue}`?[​](https://playwright.dev/docs/test-components.html#whats-the-difference-between-playwrighttest-and-playwrightexperimental-ct-reactsveltevue "Direct link to whats-the-difference-between-playwrighttest-and-playwrightexperimental-ct-reactsveltevue")
...
### I have a project that already uses Vite. Can I reuse the config?[​](https://playwright.dev/docs/test-components.html#i-have-a-project-that-already-uses-vite-can-i-reuse-the-config "Direct link to I have a project that already uses Vite. Can I reuse the config?")
...
### How do I use CSS imports?[​](https://playwright.dev/docs/test-components.html#how-do-i-use-css-imports "Direct link to How do I use CSS imports?")
...
### How can I test components that uses Pinia?[​](https://playwright.dev/docs/test-components.html#how-can-i-test-components-that-uses-pinia "Direct link to How can I test components that uses Pinia?")
...
### How do I access the component's methods or its instance?[​](https://playwright.dev/docs/test-components.html#how-do-i-access-the-components-methods-or-its-instance "Direct link to How do I access the component's methods or its instance?")
...
Clock](https://playwright.dev/docs/clock.html)[Next

Debugging Tests](https://playwright.dev/docs/debug.html)

* [Introduction](https://playwright.dev/docs/test-components.html#introduction)* [Example](https://playwright.dev/docs/test-components.html#example)* [How to get started](https://playwright.dev/docs/test-components.html#how-to-get-started)
      + [Step 1: Install Playwright Test for components for your respective framework](https://playwright.dev/docs/test-components.html#step-1-install-playwright-test-for-components-for-your-respective-framework)+ [Step 2. Create a test file `src/App.spec.{ts,tsx}`](https://playwright.dev/docs/test-components.html#step-2-create-a-test-file-srcappspectstsx)+ [Step 3. Run the tests](https://playwright.dev/docs/test-components.html#step-3-run-the-tests)+ [Further reading: configure reporting, browsers, tracing](https://playwright.dev/docs/test-components.html#further-reading-configure-reporting-browsers-tracing)* [Test stories](https://playwright.dev/docs/test-components.html#test-stories)* [Under the hood](https://playwright.dev/docs/test-components.html#under-the-hood)* [API reference](https://playwright.dev/docs/test-components.html#api-reference)
            + [props](https://playwright.dev/docs/test-components.html#props)+ [callbacks / events](https://playwright.dev/docs/test-components.html#callbacks--events)+ [children / slots](https://playwright.dev/docs/test-components.html#children--slots)+ [hooks](https://playwright.dev/docs/test-components.html#hooks)+ [unmount](https://playwright.dev/docs/test-components.html#unmount)+ [update](https://playwright.dev/docs/test-components.html#update)+ [Handling network requests](https://playwright.dev/docs/test-components.html#handling-network-requests)* [Frequently asked questions](https://playwright.dev/docs/test-components.html#frequently-asked-questions)
              + [What's the difference between `@playwright/test` and `@playwright/experimental-ct-{react,svelte,vue}`?](https://playwright.dev/docs/test-components.html#whats-the-difference-between-playwrighttest-and-playwrightexperimental-ct-reactsveltevue)+ [I have a project that already uses Vite. Can I reuse the config?](https://playwright.dev/docs/test-components.html#i-have-a-project-that-already-uses-vite-can-i-reuse-the-config)+ [How do I use CSS imports?](https://playwright.dev/docs/test-components.html#how-do-i-use-css-imports)+ [How can I test components that uses Pinia?](https://playwright.dev/docs/test-components.html#how-can-i-test-components-that-uses-pinia)+ [How do I access the component's methods or its instance?](https://playwright.dev/docs/test-components.html#how-do-i-access-the-components-methods-or-its-instance)
